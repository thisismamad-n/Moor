...
thinking phase.  Moor's default cloud-stream stale detector
(``MOOR_STREAM_STALE_TIMEOUT`` = 180s) and non-stream detector
(``MOOR_API_CALL_STALE_TIMEOUT`` = 90s) both fire before the
