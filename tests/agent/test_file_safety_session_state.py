...
def fake_homes(tmp_path, monkeypatch):
    """Point MOOR_HOME at a temp profile dir.

    Uses the real env-var resolution chain (get_moor_home /
    get_default_moor_root) instead of monkeypatching private helpers —
    ...
    MOOR_HOME=<root>/profiles/<name> makes get_default_moor_root()
