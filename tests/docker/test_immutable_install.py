...
Build the real image and verify at runtime:
  ...
  2. A stale "docker" stamp in $MOOR_HOME is healed (removed) on boot

The hosted write-policy env (PYTHONDONTWRITEBYTECODE,
MOOR_WRITE_SAFE_ROOT, ...) is covered by
