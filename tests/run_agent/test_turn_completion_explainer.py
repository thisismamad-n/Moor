...
def test_classify_persistence_error_reuses_disk_full_markers():
    """The disk bucket delegates to moor_state.is_disk_full_error, so
...
def test_classify_persistence_error_turn_lease_lost_is_distinct():
    from moor_state import SessionTurnLeaseLostError, classify_persistence_error
...
def test_persistence_error_causes_tuple_matches_classifier():
    ...
    from moor_state import PERSISTENCE_ERROR_CAUSES, classify_persistence_error
