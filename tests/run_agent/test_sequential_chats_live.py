...
AlexKucera reported on Discord (2026-04-16) that after ``moor update`` pulled
...
Opt-in — not part of default CI:
    MOOR_LIVE_TESTS=1 pytest tests/run_agent/test_sequential_chats_live.py -v
