...
# Resolve the skill's scripts dir across layouts: standalone dev repo (tests/) and moor-agent
...
_CANDIDATES = [
    ...
    _HERE.parent.parent.parent.joinpath(*_REL),          # moor-agent (tests/skills/)
]
