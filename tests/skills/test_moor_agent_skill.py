"""The `moor-agent` skill is what a running Moor knows about itself.

`website/` is never packaged, so an installed Moor has no local copy of the
user guide; skills ARE synced into `$MOOR_HOME/skills/`. The skill therefore
...
shipped feature is invisible and the agent answers "Moor can't do that."
"""
...
SKILL_DIR = REPO / "skills" / "autonomous-ai-agents" / "moor-agent"
