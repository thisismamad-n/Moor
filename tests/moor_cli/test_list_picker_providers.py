...
import moor_cli.model_switch_providers as moor_cli_model_switch_providers
...
def test_passthrough_kwargs_to_base(monkeypatch):
    ...
    monkeypatch.setattr(moor_cli_model_switch_providers, "list_authenticated_providers", _capture)
    monkeypatch.setattr("moor_cli.models.fetch_openrouter_models",
                        lambda *a, **kw: [])
...
def _stub_kimi_discovery(monkeypatch, *, canonical):
    ...
    import moor_cli.models as hm
    import moor_cli.models_catalog_static as moor_cli_models_catalog_static
    from moor_cli import models_catalog_static
    ...
    monkeypatch.setattr(moor_cli_models_catalog_static, "CANONICAL_PROVIDERS", canonical)
