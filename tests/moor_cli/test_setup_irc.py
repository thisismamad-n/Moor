"""Tests for IRC gateway configuration via `moor setup gateway` UI.
...
class TestIRCFreshInstallDiscovery:
    ...
    def test_irc_status_configured_when_env_set(self, monkeypatch):
        ...
        try:
            ...
            monkeypatch.setenv("IRC_CHANNEL", "#moor")
            monkeypatch.setenv("IRC_NICKNAME", "moor-bot")
...
class TestIRCGatewaySetupFreshInstall:
    """Simulate the full `moor setup gateway` experience with IRC present."""
