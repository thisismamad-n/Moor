"""Tests for `moor curator run` CLI behavior."""
...
def test_dry_run_default_reports_synchromoor_wording(monkeypatch, capsys):
    import agent.curator as curator_state
    import moor_cli.curator as curator_cli
    ...
    assert "Read the report with `moor curator status`" in out
