"""Tests for `_can_open_graphical_browser()` in moor_cli.auth.

Guards the fix for the May 2026 report where `moor auth add xai-oauth`
...
from moor_cli.auth import _can_open_graphical_browser
