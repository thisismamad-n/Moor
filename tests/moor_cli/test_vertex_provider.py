...
def test_vertex_registered_in_provider_registry():
    """PROVIDER_REGISTRY (moor_cli.auth) is what agent/auxiliary_client.py's
...
def test_vertex_registered_in_moor_overlays():
    """moor_cli.providers.get_provider("vertex") backs
