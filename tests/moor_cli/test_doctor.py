...
from moor_cli.doctor import _has_provider_env_config
...
class TestDoctorMemoryProviderSection:
    ...
    def _make_moor_home(self, tmp_path, provider=""):
    ...
    def _run_doctor_and_capture(self, monkeypatch, tmp_path, provider=""):
        ...
        home = self._make_moor_home(tmp_path, provider)
...
class TestDoctorDeprecatedConfigAndEnv:
    ...
    def test_moor_tool_progress_warning_says_unsupported_since_floor(self):
        ...
        findings = dict(
            doctor_mod.collect_deprecated_env_vars({"MOOR_TOOL_PROGRESS": "true"})
        )
        ...
        mode = dict(
            doctor_mod.collect_deprecated_env_vars({"MOOR_TOOL_PROGRESS_MODE": "all"})
        )
