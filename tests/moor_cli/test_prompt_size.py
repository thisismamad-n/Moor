"""Tests for the ``moor prompt-size`` diagnostic (issue #34667)."""
...
from moor_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_memory(moor_home, memory_text="", user_text=""):
...
def _seed_skill(moor_home, name, description):
    skill_dir = moor_home / "skills" / "demo" / name
