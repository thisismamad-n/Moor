"""Tests for the shared byte formatter (moor_cli.sizefmt).
...
def test_migrated_sites_render_through_the_shared_helper():
    ...
    from moor_cli.backup import _format_size as backup
    from moor_cli.checkpoints import _fmt_bytes as checkpoints
    from moor_cli.sizefmt import format_bytes as doctor
