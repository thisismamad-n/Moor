"""Tests for the interactive session browser (`moor sessions browse`).
...
from moor_cli.sessions_cmd_browse import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """moor sessions browse should be parseable."""
