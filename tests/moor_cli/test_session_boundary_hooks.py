...
from moor_cli.plugins import VALID_HOOKS, PluginManager
...
# tests/moor_cli/test_lifecycle.py::test_finalize_session_closes_core_before_plugin_export.
@patch("moor_cli.lifecycle.invoke_hook")
@patch("moor_cli.lifecycle.finalize_session")
