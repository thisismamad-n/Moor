...
def test_offer_first_run_setup_routes_into_shared_picker(monkeypatch):
    ...
    monkeypatch.setattr("moor_cli.main.select_provider_and_model", _fake_picker)
    ...
    assert shell.requested_provider == "moor"
...
def test_offer_first_run_setup_declined(monkeypatch):
    ...
    monkeypatch.setattr("moor_cli.main.select_provider_and_model", _fail_picker)
...
def test_offer_first_run_setup_picker_cancel_is_graceful(monkeypatch):
    ...
    monkeypatch.setattr("moor_cli.main.select_provider_and_model", _cancel_picker)
