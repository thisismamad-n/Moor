"""Tests for ``moor approvals suggest`` (moor_cli/approvals_suggest.py).

Approval history in Moor is implied, not ledgered: the session DB
...
from moor_cli.approvals_suggest import (
    Proposal,
    apply_proposals,
    build_proposals,
    derive_glob,
