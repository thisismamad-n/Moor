...
def test_canonical_source_never_persists_http_credentials():
    from moor_cli.plugins_cmd import _canonical_source
...
def test_cloned_origin_never_persists_http_credentials(tmp_path):
    from moor_cli.plugins_cmd import _scrub_cloned_origin
...
def test_git_errors_never_echo_source_credentials():
    from moor_cli.plugins_cmd import _safe_git_error
...
def test_metadata_is_profile_local_and_read_from_disk_each_time(monkeypatch, tmp_path):
    from moor_cli.plugins_cmd import _install_plugin_core, _read_install_metadata
...
def test_pinned_plugin_update_refuses_to_drift(monkeypatch, tmp_path, capsys):
    from moor_cli.plugins_cmd import _install_plugin_core, cmd_update
...
def test_metadata_write_failure_rolls_back_removal(monkeypatch, tmp_path):
    from moor_cli.plugins_cmd import _install_plugin_core, _remove_plugin_core
    ...
    before = _metadata(home)
    monkeypatch.setattr(
        "moor_cli.plugins_cmd._write_install_metadata",
