...
The main() function in moor_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `moor -c model`
...
def _build_parser():
    """Build a minimal replica of the moor top-level parser."""
