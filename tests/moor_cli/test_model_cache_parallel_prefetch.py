...
# ---------------------------------------------------------------------------
# Thread-safe cache entry update (moor_cli/models.py)
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# Parallel prefetch (moor_cli/model_switch.py)
# ---------------------------------------------------------------------------
...
class TestPrefetchProviderModelsParallel:
    ...
    def test_skips_all_fresh_entries(self, monkeypatch):
        ...
        from moor_cli.model_switch import _prefetch_provider_models_parallel
        ...
        with patch("moor_cli.models._load_provider_models_cache", return_value=fresh_cache), \
    ...
    def test_fetches_only_stale_entries(self, monkeypatch):
        ...
        with patch("moor_cli.models._load_provider_models_cache", return_value=cache), \
             patch("moor_cli.models._credential_fingerprint", return_value="fp_f"), \
    ...
    def test_fetches_in_parallel(self, monkeypatch):
        ...
        with patch("moor_cli.models._load_provider_models_cache", return_value={}), \
             patch("moor_cli.models._credential_fingerprint", return_value="fp"), \
             patch("moor_cli.models.cached_provider_model_ids", side_effect=mock_fetch), \
             patch("moor_cli.models.update_provider_cache_entry"):
    ...
    def test_empty_list_is_noop(self):
        ...
        with patch("moor_cli.models.cached_provider_model_ids") as fetch:
