"""Tests for Blank Slate setup mode (moor_cli/setup.py).
...
from moor_cli.setup_quick import _blank_slate_minimal_toolsets, _blank_slate_minimize_config
