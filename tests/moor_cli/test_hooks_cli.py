"""Tests for the ``moor hooks`` CLI subcommand."""
...
from moor_cli import hooks as hooks_cli
...
class TestHooksDoctor:
    ...
    def test_unallowlisted_script_is_not_executed(self, tmp_path):
        """Regression for M4: `moor hooks doctor` used to run every
