...
Run before any catalog commit:
    ...
    MOOR_TEST_NETWORK=1 scripts/run_tests.sh tests/moor_cli/test_catalog_reachability.py
"""
...
pytestmark = pytest.mark.skipif(
    not os.environ.get("MOOR_TEST_NETWORK"),
    reason="network test; set MOOR_TEST_NETWORK=1 to run",
)
