"""Tests for the shared tar.gz writer (``moor_cli.archive_safe.make_targz``).

``make_targz`` backs both ``moor profile export`` and ``moor kanban
...
from moor_cli.archive_safe import make_targz
