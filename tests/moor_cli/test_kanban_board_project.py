...
A kanban board can be scoped to a first-class Moor project so every task on
...
def fresh_home(tmp_path, monkeypatch):
    ...
    for var in ("MOOR_KANBAN_DB", "MOOR_KANBAN_WORKSPACES_ROOT", "MOOR_KANBAN_HOME", "MOOR_KANBAN_BOARD"):
