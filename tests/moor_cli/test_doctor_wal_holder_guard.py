"""Regression: ``moor doctor --fix`` must not checkpoint the live WAL under a running gateway.
...
# that depend on Moor *choosing* WAL mode (declined on vulnerable SQLite
