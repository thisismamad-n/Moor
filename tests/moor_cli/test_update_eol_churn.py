"""Regression: ``moor update`` should take a managed checkout off autocrlf=true.
...
``moor update`` has to repair them.
...
from moor_cli.update_cmd import _normalize_managed_eol
