...
class TestGetCopilotModelContext:
    ...
    @patch("moor_cli.models.fetch_github_model_catalog", return_value=_SAMPLE_CATALOG)
    ...
    @patch("moor_cli.models._urlopen_model_catalog_request")
    ...
    @patch("moor_cli.models.fetch_github_model_catalog", return_value=[])
