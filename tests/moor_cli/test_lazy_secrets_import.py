"""Regression test: moor update must not load cryptography eagerly."""
...
assert 'moor_cli.secrets_cli' not in sys.modules, \\
...
"""
    ...
    def test_update_check_no_cryptography(self) -> None:
        """Running moor update --check should NOT load cryptography._rust."""
        # Write a small script in the repo root so moor_cli is importable,
