...
class _StubCLI:
    def _stage_and_swap_model(self, result, old_model):
        ...
        return _cli_mod.MoorCLI._stage_and_swap_model(self, result, old_model)
    ...
    def _confirm_and_apply_cli_model_switch(
        ...
        return cli_mod.MoorCLI._confirm_and_apply_cli_model_switch(
...
def test_cli_model_once_records_restore_and_does_not_persist(monkeypatch):
    ...
    stub._snapshot_model_runtime = cli_mod.MoorCLI._snapshot_model_runtime.__get__(stub)
    printed = []
    ...
    monkeypatch.setattr("moor_cli.model_switch.resolve_display_context_length", lambda *a, **k: None)

    cli_mod.MoorCLI._handle_model_switch(
        stub,
...
def test_cli_restore_model_runtime_snapshot_restores_agent():
    ...
    cli_mod.MoorCLI._restore_model_runtime_snapshot(stub, snapshot)
