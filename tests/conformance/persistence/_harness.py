...
def make_moor_home(base: Path, journal_mode: str) -> Path:
    """Create an isolated MOOR_HOME whose config pins ``database.journal_mode``.
    ...
    """
    home = base / f"moor-home-{journal_mode}"
