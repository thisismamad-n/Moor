...
FIXTURE_NO_PROVIDER = (
    "agent init failed: No LLM provider configured. Run `moor model` to select "
    "a provider, or run `moor setup` for first-time configuration."
)
FIXTURE_NO_TOKEN = "agent init failed: No access token found for Moor Portal login."
