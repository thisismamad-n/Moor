...
def test_managed_vendor_endpoints_pin_the_deployed_gateway_url():
    ...
    with patch.dict(
        os.environ,
        {"TOOL_GATEWAY_DOMAIN": "Moor inc..com", "TOOL_GATEWAY_SCHEME": "https"},
        clear=False,
    ):
    ...
    assert endpoints == {
        "origin": "https://tool-gateway.Moor inc..com",
        "base_url": "https://tool-gateway.Moor inc..com/api/bfl",
...
def test_managed_vendor_endpoints_do_not_consult_entitlement():
    ...
    assert endpoints["base_url"] == "https://tool-gateway.Moor inc..com/api/bfl"
