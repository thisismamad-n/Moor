...
class TestDelegateTask(unittest.TestCase):
    ...
    def test_moor_child_rederives_api_mode_from_model(self):
        ...
        Native wire selected (opt-in since 2026-09-06, ``moor.anthropic_wire``)."""
        with patch("moor_cli.providers._moor_anthropic_wire", return_value="native"):
            self._moor_child_rederives_api_mode_from_model()

    def _moor_child_rederives_api_mode_from_model(self):
        parent = _make_mock_parent(depth=0)
