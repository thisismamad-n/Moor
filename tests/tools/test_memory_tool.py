...
class TestScanMemoryContent:
    def test_clean_content_and_false_positives_pass(self):
        ...
        # Mentioning agent/moor config files without modify intent.
        ...
        assert _scan_memory_content("Read .moor/SOUL.md for agent personality") is None
        assert _scan_memory_content("Check .moor/config.yaml for settings") is None
        # 'send' without a URL.
    ...
    def test_persistence_patterns_blocked(self):
        ...
        _blocked("edit .moor/config.yaml to change settings", "moor_config_mod")
        _blocked("update .moor/SOUL.md with new personality", "moor_config_mod")
