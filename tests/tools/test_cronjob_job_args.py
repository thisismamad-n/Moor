...
hardcoded "~/.moor/scripts/" in its messages even though resolution goes
through get_moor_home(), which is per-profile.
"""
...
class TestValidateCronScriptPath:
    ...
    def test_missing_file_error_names_the_resolved_scripts_dir(self):
        ...
        # under profiles, where get_moor_home() is not the global ~/.moor.
        scripts_dir = get_moor_home() / "scripts"
