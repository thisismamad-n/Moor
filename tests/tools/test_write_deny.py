...
class TestWriteDenyExactPaths:
    ...
    def test_moor_root_env_when_running_under_profile(self, tmp_path, monkeypatch):
        ...
        ``~/.moor/.env`` (whose credentials are inherited by every profile)
        ...
        # Sanity check: MOOR_HOME does point to the profile dir, not the root.
...
class TestWriteAllowed:
    ...
    def test_moor_control_files_requested_writable(self):
