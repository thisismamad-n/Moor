...
def _patch_aborted_startup(monkeypatch, runner_cls):
    ...
    monkeypatch.setattr("moor_logging.setup_logging", lambda moor_home, mode: None)
...
async def test_failure_exit_still_stops_cron_housekeeping_and_mcp(monkeypatch):
    ...
    monkeypatch.setattr("moor_cli.moor_auth_keepalive.stop_moor_auth_keepalive", lambda: None)
