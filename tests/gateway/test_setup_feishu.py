"""Tests for _setup_feishu() in moor_cli/gateway.py.
...
def _run_setup_feishu(
    *,
    ...
    with patch("moor_cli.config.save_env_value", side_effect=mock_save), \
         patch("moor_cli.config.get_env_value", side_effect=mock_get), \
         patch("moor_cli.config.remove_env_value", side_effect=mock_remove), \
         patch("moor_cli.cli_output.prompt_yes_no", side_effect=prompt_yes_no_responses), \
         patch("moor_cli.setup.prompt_choice", side_effect=prompt_choice_responses), \
         patch("moor_cli.cli_output.prompt", side_effect=prompt_responses), \
         patch("moor_cli.cli_output.print_header"), \
         patch("moor_cli.cli_output.print_info"), \
         patch("moor_cli.cli_output.print_success"), \
         patch("moor_cli.cli_output.print_warning"), \
         patch("moor_cli.cli_output.print_error"), \
