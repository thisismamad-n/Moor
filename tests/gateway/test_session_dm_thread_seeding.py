...
def store(tmp_path, monkeypatch):
    ...
    ~/.moor/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at moor_state import time, before pytest's MOOR_HOME monkeypatch
    fires — the autouse fixture's MOOR_HOME override doesn't help here.)
    """
    import moor_state
