...
class TestDMTopicFallbackReplyToMode:
    ...
    Regression tests for https://github.com/Moor inc./hermes-agent/issues/23994:
...
class TestDMTopicSyntheticSendRouting:
    ...
    Regression tests for https://github.com/Moor inc./hermes-agent/issues/87051:
    ...
    response in a different chat lane than the Moor topic the session runs
    in. The no-anchor branch must prefer the Moor topic's
