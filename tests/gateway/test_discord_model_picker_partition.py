...
provider whose list exceeds 25 entries (e.g. Moor curated + Portal free
...
def test_moor_free_models_render_across_partitioned_selects():
    ...
    view._selected_provider = "moor"
    view._build_model_select("moor")
