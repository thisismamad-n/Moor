...
def worker_loop(worker_id: int, moor_home: str, result_file: str) -> None:
...
def reclaimer_loop(moor_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="moor_mixed_stress_")
    print(f"MOOR_HOME = {home}")
