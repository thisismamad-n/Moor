"""Tests for ACP Registry metadata shipped with Moor."""
...
def test_agent_json_matches_official_registry_required_fields():
    ...
    assert data["name"] == "Moor Agent"
    assert data["description"]
    assert data["repository"] == "https://github.com/Moor inc./hermes-agent"
    assert data["website"].startswith("https://hermes-agent.Moor inc..com/")
