...
// Moor Cloud connection (cloud-auto-discovery Q3/Q6): it carries a
...
function resolveProfileBackendRoute(profile, opts: ProfileRouteOptions = {}): ProfileBackendRoute {
  ...
  if (scopedProfile === primaryProfile) {
    ...
    // the wire: the dashboard's process MOOR_HOME can belong to a different
 ...
 * `moor:api` handler — both routes reach a backend whose namespace is the
