 ...
 * startMoor() re-throw the cached error without re-attempting the connect —
...
/**
 * Whether a startMoor() failure should latch into `backendStartFailure`.
 ...
 * Every subsequent `getConnection`/`api` call re-runs `startMoor`, re-emits
