 ...
 *
 * 1. TORN BUNDLE after an update (#95575): `moor update` replaces the app
...
export interface RendererLoadErrorDetails {
  ...
  /** Repair command hint, e.g. `moor desktop --force-build`. */
  repairHint?: string
  /**
...
export function buildRendererLoadErrorPage(details: RendererLoadErrorDetails = {}): string {
  ...
  const title = 'Moor couldn\u2019t start the desktop UI'
...
<main>
  ...
  <code>moor desktop --force-build</code>, then restart the app.</p>
