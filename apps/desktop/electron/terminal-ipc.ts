...
// registry, and the moor:terminal:* IPC surface. Extracted from main.ts; the
...
export function registerTerminalIpc({
  ...
  function terminalShellCommand() {
    ...
    const override = (process.env.MOOR_DESKTOP_SHELL || (isWindows ? '' : process.env.SHELL) || '').trim()
  ...
  ipcMain.handle('moor:terminal:attach', (event, id) => {
