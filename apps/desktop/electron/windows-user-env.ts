...
// even though a fresh shell — and the Moor CLI — sees it immediately. The
// desktop's MOOR_HOME resolution relies on process.env, so that stale-snapshot
// gap silently sends the backend to the default %LOCALAPPDATA%\moor. Reading
