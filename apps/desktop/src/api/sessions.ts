...
import { capabilityScoped, getApiRequestConnection, moorApi, type ProfileScope, profileScoped } from './client'
...
export async function listSessions(
  ...
  const result = await moorApi<PaginatedSessions>({
    ...profileScoped(),
    path:
...
export async function listSidebarSessions(req: SidebarSessionsRequest): Promise<SidebarSessionsResponse> {
  ...
  try {
    result = await moorApi<SidebarSessionsResponse>({
      ...profileScoped(),
...
export function searchSessions(query: string): Promise<SessionSearchResponse> {
  return moorApi<SessionSearchResponse>({
...
export function getSessionMessages(
  ...
  return moorApi<SessionMessagesResponse>({
    ...sessionScope,
