...
import { getLocalModelsStatus } from '@/moor'
...
import type { LocalModelLoadProgress, ModelOptionProvider, ModelPricing } from '@/types/moor'
...
export function ModelPickerDialog({
  ...
  // the `moor model` CLI picker, which shows the curated list verbatim.
...
function ProviderHeading({ provider }: { provider: ModelOptionProvider }) {
  ...
  // free_tier is only set for Moor. true → "Free tier", false → "Pro".
  const tierBadge =
