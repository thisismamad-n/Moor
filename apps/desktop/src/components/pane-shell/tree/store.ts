...
const STORAGE_KEY = 'moor.desktop.layoutTree.v2'
 ...
 */
export const $activePresetId = atom<string>(readKey('moor.desktop.layoutPreset.active') ?? 'default')

export function markActivePreset(id: string) {
  $activePresetId.set(id)
  writeKey('moor.desktop.layoutPreset.active', id)
}
 ...
 */
const DISMISSED_KEY = 'moor.desktop.dismissedPanes.v1'
...
const PANE_SHARE_KEY = 'moor.desktop.paneShare.v1'
...
const HIDDEN_STRIP_TAB_KEY = 'moor.desktop.hiddenStripTabs.v1'
...
writeKey('moor.desktop.paneDockHeals.v1', null)
...
if ((import.meta.env.DEV || import.meta.env.VITE_PERF_PROBE === '1') && typeof window !== 'undefined') {
  ;(window as unknown as Record<string, unknown>).__MOOR_LAYOUT_TREE__ = {
    close: closeTreePane,
