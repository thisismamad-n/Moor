...
const SCRIPT: Record<string, { id: string; src: string }> = {
  instagram: { id: 'moor-ig-embed', src: 'https://www.instagram.com/embed.js' },
  tiktok: { id: 'moor-tt-embed', src: 'https://www.tiktok.com/embed.js' },
  twitter: { id: 'moor-tw-embed', src: 'https://platform.twitter.com/widgets.js' }
}
