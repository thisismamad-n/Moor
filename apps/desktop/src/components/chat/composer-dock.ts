 ...
 *  smallest type, soft moor shadow. Uses an explicit fill (not `--composer-fill`)
...
export const composerPanelCard = cn(
  'rounded-2xl border border-border/65 shadow-moor text-[length:var(--conversation-tool-font-size)]',
