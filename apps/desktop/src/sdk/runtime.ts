 ...
 * plugins resolve `@moor/plugin-sdk` through the vite alias; RUNTIME-loaded
...
export function sdkImportMap(): Record<string, string> {
  cached ??= {
    '@moor/plugin-sdk': shimUrl('__MOOR_PLUGIN_SDK__'),
    'react/jsx-dev-runtime': shimUrl('__MOOR_REACT_JSX_DEV__'),
    'react/jsx-runtime': shimUrl('__MOOR_REACT_JSX__'),
    react: shimUrl('__MOOR_REACT__')
  }
