 ...
 *    the primary profile surfaced as @default instead of @moor;
 ...
 *    kanban/tool workers count too (moor-agent#90268): a profile grinding
...
describe('previewKind classifies a roster preview', () => {
  ...
  it('surfaces the primary profile as @moor, never @default (#89484)', () => {
    expect(fromBot("Message from agent 'default': deploy is green")).toBe('moor')
