...
import type { PluginContext } from '@moor/plugin-sdk'
...
export interface ScriptedGateway {
  ...
  disposals: () => number
  /** The mock `host` the `@moor/plugin-sdk` mock should expose. */
...
/** The `@moor/plugin-sdk` surface the group modules actually reach for.
