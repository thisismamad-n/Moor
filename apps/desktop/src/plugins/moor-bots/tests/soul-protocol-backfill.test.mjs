...
test('generated protocol uses moor profile list, not the invalid profiles plural', () => {
  assert.match(source, /run `moor profile list` for the LIVE/)
  assert.doesNotMatch(source, /run `moor profiles list` for the LIVE/)
})
