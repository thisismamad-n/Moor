...
import type { MoorPlugin, PaletteContribution } from '@moor/plugin-sdk'
import { $accentOverride, PALETTE_AREA, setAccentOverride, STATUSBAR_AREAS } from '@moor/plugin-sdk'

import { AccentPickerTrigger } from './picker'

const plugin: MoorPlugin = {
  id: 'accent',
  name: 'Accent Picker',
  description:
