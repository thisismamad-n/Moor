...
import { atom, type PluginRestOptions, type PluginStorage, queryClient } from '@moor/plugin-sdk'
...
/** First-class Moor projects, for scoping a board's default workspace. */
