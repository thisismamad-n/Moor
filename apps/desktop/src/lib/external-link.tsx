...
const SKIP_PROTO_RE = /^(?:file|data|mailto|javascript|blob|chrome|about|moor):/i
...
export function fetchLinkTitle(url: string): Promise<string> {
  ...
  const bridge = typeof window === 'undefined' ? undefined : window.moorDesktop?.fetchLinkTitle
...
export function openExternalLink(href: string): void {
  if (href) {
    void window.moorDesktop?.openExternal?.(href)
  }
}
 ...
 * doesn't cost a context switch out of Moor, and it is the surface the agent
