...
describe('displayPath', () => {
  it('collapses a macOS home prefix to ~', () => {
    expect(displayPath('/Users/brooklyn/www/moor-agent')).toBe('~/www/moor-agent')
...
describe('pathLeaf', () => {
  it('returns the last segment', () => {
    expect(pathLeaf('/Users/me/www/moor-agent')).toBe('moor-agent')
    expect(pathLeaf('~/www/moor-agent')).toBe('moor-agent')
