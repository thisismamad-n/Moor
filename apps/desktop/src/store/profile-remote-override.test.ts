...
describe('remoteHostLabel', () => {
  it('keeps a non-default port and drops default ones', () => {
    expect(remoteHostLabel('https://moor.example.com:8443/x')).toBe('moor.example.com:8443')
    expect(remoteHostLabel('https://moor.example.com:443')).toBe('moor.example.com')
    expect(remoteHostLabel('http://moor.example.com:80')).toBe('moor.example.com')
  })
