...
function rehydrateFromDiskOnce(): void {
  ...
  try {
    const rawSeen = readKey('moor.desktop.sessionSeenCounts')
    ...
    const rawMarkers = readKey('moor.desktop.unreadFinishedSessions')
