...
function composerScopeForConnection(connection: MoorConnection | null): string | null {
  if (!connection) {
    return null
  }
...
const SESSION_OWNER_HINTS_KEY = 'moor.desktop.sessionOwnerHints.v1'
 ...
 * MoorConnection lookup is unavailable. */
