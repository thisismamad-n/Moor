...
// v1 (`moor.desktop.statusbarHidden`) was seeded with the approval pill
...
const STATUSBAR_HIDDEN_STORAGE_KEY = 'moor.desktop.statusbarHidden.v2'
const LEGACY_HIDDEN_STORAGE_KEY = 'moor.desktop.statusbarHidden'
// v1 (`moor.desktop.statusbarVisible`) shipped a stretch where the bar was
...
const STATUSBAR_VISIBLE_STORAGE_KEY = 'moor.desktop.statusbarVisible.v2'
