 ...
 * `<moor home>/desktop-plugins/*` disk door — incl. agent-written ones),
...
const DECISIONS_KEY = 'moor.desktop.pluginDecisions.v2'
const LEGACY_DISABLED_KEY = 'moor.desktop.disabledPlugins.v1'
