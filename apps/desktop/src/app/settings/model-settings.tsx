...
import { invalidateMoorConfig, setMoorConfigCache, useMoorConfigRecord } from '../hooks/use-config-record'
...
export function ModelSettings({ onMainModelChanged }: ModelSettingsProps) {
  ...
  const { data: config } = useMoorConfigRecord()
  const setConfig = setMoorConfigCache
