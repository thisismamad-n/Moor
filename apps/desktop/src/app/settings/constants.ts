...
// lib/personalities (mirrors moor_cli/personality.py BUILTIN_PERSONALITIES).
...
export const EMPTY_SELECT_VALUE = '__moor_empty__'
...
export const PROVIDER_GROUPS: ProviderPrefix[] = [
  ...
  },
  {
    ...
    // Slot #2 — mirrors CANONICAL_PROVIDERS (after Moor, ahead of OpenRouter).
  ...
  { prefix: 'MOOR_QWEN_', name: 'DashScope (Qwen)', priority: 6 },
  {
    prefix: 'GLM_',
    name: 'GLM / Z.AI',
