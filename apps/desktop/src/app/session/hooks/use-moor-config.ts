...
import { getMoorConfig, getMoorConfigDefaults } from '@/moor'
...
interface MoorConfigOptions {
  activeSessionIdRef: MutableRefObject<string | null>
}

export function useMoorConfig({ activeSessionIdRef }: MoorConfigOptions) {
  ...
  return { refreshMoorConfig, sttEnabled, voiceMaxRecordingSeconds }
}
