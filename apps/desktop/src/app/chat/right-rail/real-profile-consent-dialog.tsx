...
import { saveMoorConfigRecord } from '@/moor'
...
export function RealProfileConsentDialog({ tabId }: RealProfileConsentDialogProps) {
  ...
  const { data: config, writeScope } = useMoorConfigRecord()
  const setConfig = moorConfigCacheWriter()
  ...
  const enable = useCallback(async () => {
    ...
    try {
      ...
      await saveMoorConfigRecord({ browser: { use_real_profile: true } }, writeScope)
