...
import type { ProjectInfo, SessionInfo } from '@/moor'
 ...
 * repo shows its branches/worktrees even when they have no Moor sessions yet.
...
export function mergeRepoWorktreeGroups(
  ...
  discoveredWorktrees?: MoorGitWorktree[]
): SidebarSessionGroup[] {
