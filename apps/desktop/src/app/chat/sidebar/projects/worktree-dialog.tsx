...
import type { MoorGitBranch } from '@/global'
...
const branchActionLabel = (branch: MoorGitBranch, copy: BranchActionCopy) => {
...
export function WorktreeDialog() {
  ...
  const [branches, setBranches] = useState<MoorGitBranch[]>([])
  ...
  const convert = async (branch: MoorGitBranch) => {
    if (pending || !repoPath || !branch) {
      return
    }
