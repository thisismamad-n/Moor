...
// hairline `--stroke-moor` paired with the soft `--shadow-moor` float.
...
export const HUD_SURFACE =
  'rounded-xl border border-(--stroke-moor) bg-(--ui-chat-bubble-background) shadow-moor [-webkit-app-region:no-drag]'
