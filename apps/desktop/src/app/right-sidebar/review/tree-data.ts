import type { MoorReviewFile } from '@/global'
...
export function buildReviewFlatList(files: MoorReviewFile[]): ReviewTreeNode[] {
  return [...files]
...
export function buildReviewTree(files: MoorReviewFile[], compact = true): ReviewTreeNode[] {
  const root = makeDir('', '')
