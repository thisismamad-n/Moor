...
// (#73044). Exercises the REAL moor + store/gateway + store/profile chain:
...
const { pluginSocket, setApiRequestConnection, setApiRequestProfile } = await import('@/moor')
...
const conn = (over: Partial<MoorConnection> = {}): MoorConnection =>
  ({
    authMode: 'oauth',
