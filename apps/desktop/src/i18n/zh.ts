...
export const zh: Translations = {
  ...
  messaging: {
    ...
    platformIntro: {
      ...
      bluebubbles: '在装有 iMessage 的 Mac 上运行 BlueBubbles Server，暴露其 API，然后用服务器密码把 Moor 指向该 URL。',
      ...
      weixin: '登录微信公众平台，复制 AppID 和 Token，并把消息回调 URL 指向 Moor。',
  ...
  updates: {
    ...
    applyingBody: 'Moor 更新器会在自己的窗口中接管，并在完成后重新打开 Moor。',
    applyingBodyBackend: '远程后端正在应用更新并将重启。恢复后 Moor 会自动重新连接。',
    applyingClose: 'Moor 将关闭以应用更新。',
    errorTitle: '更新未完成',
