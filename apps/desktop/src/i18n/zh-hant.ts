...
export const zhHant = defineLocale({
  ...
  cron: {
    ...
    newCron: '新排程工作',
    emptyDescNew:
      '按 cron 表達式排程一個提示詞。Moor 會執行它，並將結果傳送至您選擇的目的地。',
  ...
  updates: {
    ...
    applyingBody: 'Moor 更新程式會在自己的視窗中接管，並在完成後重新開啟 Moor。',
    applyingBodyBackend: '遠端後端正在套用更新並將重新啟動。恢復後 Moor 會自動重新連線。',
    applyingClose: 'Moor 將關閉以套用更新。',
    errorTitle: '更新未完成',
  ...
  install: {
    ...
    activeDesc:
      '這是一次性設定。Moor 安裝程式正在下載相依套件並設定您的電腦。之後啟動會略過此步驟。',
  ...
  onboarding: {
    ...
    autoBrowser: provider =>
      `已在瀏覽器中開啟 ${provider}。請在那裡授權 Moor，連線會自動完成，無需複製或貼上。`,
  ...
  preview: {
    ...
    web: {
      ...
      finishedRestarting: message =>
        `Moor 已完成預覽伺服器重新啟動${message ? `：${message}` : ''}`,
      ...
      stillWorking:
        'Moor 仍在執行，但尚未收到重新啟動結果。伺服器指令可能正在前台執行。',
