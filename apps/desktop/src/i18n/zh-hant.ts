...
export const zhHant = defineLocale({
  ...
  boot: {
    ...
    steps: {
      ...
      startingMoorDesktop: '正在啟動 Moor Desktop…'
    },
    errors: {
      backgroundExited: 'Moor 背景程序已結束。',
      backgroundExitedDuringStartup: 'Moor 背景程序在啟動期間結束。',
    ...
    failure: {
      ...
      cloudDownTitle: 'Moor Cloud 代理已停機',
      cloudDownDescription:
        '此閘道連線的 Moor 託管雲端代理正在回傳伺服器錯誤。無法在此處重新啟動——請檢查其狀態、切換至本機閘道，或取得支援。',
      cloudDownHint: '使用下方按鈕開啟 Moor Portal（檢視執行個體狀態與操作）或加入 Discord 取得支援。',
  ...
  notifications: {
    ...
    backendOutOfDateMessage: '您的 Moor 後端早於目前的桌面版本，可能無法正常運作。請更新以保持一致。',
  ...
  sendDiagnostics: {
    title: '向 Moor 傳送診斷資訊',
    privacyNotice:
      '這會將偵錯套件上傳到 Moor 內部儲存空間（並非公開貼上板）。內容包括系統資訊（作業系統、版本、服務商、已設定的 API 金鑰種類 — 絕不包含金鑰本身）以及完整的 agent、gateway 與桌面端日誌（每個最多 512 KB，很可能包含對話內容、工具輸出與檔案路徑）。上傳前會先遮罩機密資訊。僅 Moor 員工與獲准的 Discord 版主可檢視，14 天後自動刪除。',
    upload: '上傳',
    uploading: '上傳中…',
    cancel: '取消',
    close: '關閉',
    ...
    failedTitle: '上傳失敗',
    failedHint:
      '您也可以在終端機執行 `moor debug share --moor`，或執行 `moor debug share --local` 在不上傳的情況下檢視報告。',
    handoffLead: '在以下位置繼續討論:',
    links: {
      github: 'GitHub Issues',
      portal: 'Moor Portal 支援',
      discord: 'Discord'
    }
  },
  ...
  settings: {
    ...
    resetConfirm: '要將所有設定恢復為 Moor 預設值嗎？',
    exportFailed: '匯出失敗',
    resetFailed: '重設失敗',
    nav: {
      providers: '提供方',
    ...
    notifications: {
      ...
      kinds: {
        ...
        input: {
          label: '需要輸入',
          description: 'Moor 提出了問題，或需要密碼或密鑰。'
        },
        turnDone: {
          label: '回覆就緒',
          description: 'Moor 在背景時完成了一輪對話。'
        },
        turnError: {
          label: '本輪失敗',
          description: '背景回合錯誤。'
    ...
    appearance: {
      ...
      colorMode: '色彩模式',
      colorModeDesc: '選擇固定模式，或讓 Moor 跟隨系統設定。',
      ...
      tipsTitle: '應用程式內提示',
      tipsDesc: '指向應用程式某處的小氣泡：閒置時偶爾出現，需要時 Moor 也會給你一則。關掉一則就不再出現。',
      tipsReset: (count: number) => `復原 ${count} 則已關閉的提示`,
      toursTitle: '導覽',
      toursDesc: '讓 Moor 帶你認識應用程式：調暗畫面並逐步標示每個位置。',
      ...
      pet: {
        title: '寵物',
        intro:
          '領養一隻懸浮在應用上的 petdex 動畫寵物，它會根據 Moor 的狀態做出反應——工具執行時奔跑、成功時歡呼、出錯時沮喪。',
        restartHint: '寵物功能需要重新啟動——目前執行的應用在此功能加入前啟動。請結束並重新開啟 Moor，然後回到此處。',
        scaleTitle: '大小',
    ...
    fieldDescriptions: defineFieldCopy({
      ...
      agent: {
        ...
        maxTurns: 'Moor 停止一次執行前的工具呼叫輪次上限。'
      },
      terminal: {
      ...
      fileReadMaxChars: 'Moor 單次檔案讀取可讀取的最大字元數。',
      approvals: {
        mode: 'Moor 如何處理需要明確批准的指令。',
      ...
      updates: {
        nonInteractiveLocalChanges:
          'Moor 從應用程式內更新自身時，保留本機原始碼變更（stash）或丟棄（discard）。終端機更新一律會詢問。'
      }
    }),
    about: {
      ...
      automaticUpdatesDesc: 'Moor 會在背景自動檢查更新，並在有可用更新時通知你。',
    ...
    gateway: {
      ...
      envOverride: '環境變數覆寫',
      intro:
        'Moor Desktop 預設會啟動自己的本機閘道。如果您希望此應用程式控制另一台機器或可信代理後面已執行的 Moor 後端，請使用遠端閘道。閘道連線屬於本機層級設定；設定檔是從已連線的閘道中探索出來的。',
      envOverrideTitle: '環境變數正在控制此桌面工作階段。',
      envOverrideDesc: '取消設定 MOOR_DESKTOP_REMOTE_URL 和 MOOR_DESKTOP_REMOTE_TOKEN 後才會使用下方儲存的設定。',
      localTitle: '本機閘道',
      localDesc: '在 localhost 啟動私有 Moor 後端。這是預設方式，可離線使用。',
      remoteTitle: '遠端閘道',
      remoteDesc:
        '將此桌面殼層連線至遠端 Moor 後端。託管閘道使用 OAuth 或帳號密碼；自託管閘道也可使用工作階段 Token。',
      remoteUrlTitle: '遠端 URL',
      remoteUrlDesc: '遠端儀表板後端的基礎 URL。支援路徑前綴，例如 /moor。',
      ...
      savedTitle: '閘道設定已儲存',
      restartingMessage: 'Moor Desktop 將使用已儲存的設定重新連線。',
      savedMessage: '已儲存，下次重新啟動後生效。',
      connectedTo: (baseUrl, version) => `已連線至 ${baseUrl}${version ? ` · Moor ${version}` : ''}`,
      ...
      sshMoorPathTitle: 'Moor 路徑（選用）',
      sshMoorPathDesc: '遠端 moor 執行檔的完整路徑。留空 = 自動偵測。',
      sshMoorPathPlaceholder: '自動偵測',
      ...
      sshErrNotInstalled:
        '遠端主機上未安裝 Moor。請在遠端安裝（curl -fsSL https://hermes-agent.nousresearch.com/install.sh | sh）或設定 Moor 路徑。',
    ...
    localModels: {
      ...
      runtimeInstalledDetail: (tag, backend) => `組建 ${tag}，${backend} 後端。Moor 會為您啟動並管理伺服器。`,
      ...
      upToDateDetail: (tag, backend) => `正在執行 llama.cpp ${tag}（${backend}）——Moor 提供的最新組建。`,
    ...
    providers: {
      ...
      intro: '使用訂閱登入，無需複製 API 金鑰。Moor 會在應用程式中為您完成瀏覽器登入。',
      connected: '已連線',
      collapse: '收合',
      ...
      localEndpoint: {
        title: '本地 / 自訂端點',
        description: '將 Moor 指向任意 OpenAI 相容端點（Zyphra、vLLM、llama.cpp、Ollama 等）。'
      },
      loading: '正在載入提供方...'
    },
    sessions: {
    ...
    toolsets: {
      ...
      useBackend: '使用此後端',
      nousIncluded: '包含在 Moor 訂閱中；登入 Moor Portal 即可啟用。',
      nousAuthNeededTitle: '登入 Moor Portal',
      nousAuthNeededMessage: provider => `已儲存 ${provider}，但在登入 Moor Portal 之前不會啟用。`,
      nousAuthSignIn: '登入',
      nousAuthDoneTitle: '已連接 Moor Portal',
      nousAuthDoneMessage: '訂閱後端現已啟用。',
      nousAuthFailed: 'Moor Portal 登入未完成',
      ...
      browserRealProfile: {
        ...
        prompt: {
          title: '讓網站保持登入狀態',
          body: '讓 Moor 使用預設瀏覽器設定檔的快照進行瀏覽，網站開啟時即已登入。',
  ...
  skills: {
    ...
    skillArchivedMessage: '可透過 moor curator restore 還原。',
    officialCatalog: '可安裝',
    officialPill: '官方'
  },
  ...
  starmap: {
    ...
    loading: '載入中…',
    emptyTitle: '尚無學習內容',
    emptyDesc: '當 Moor 為你的工作建立技能與記憶時，會顯示在這裡。'
  },
  agents: {
    close: '關閉代理',
    title: '派生樹',
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: '請重新啟動 Moor 以使用寵物功能。',
      empty: '沒有符合的寵物。',
      turnOff: '關閉',
      turnOn: '開啟',
      installed: '已安裝',
    ...
    generatePet: {
      ...
      staleBackend: '請更新 Moor 以生成寵物。',
      backgroundHint: '你可以關閉此視窗——完成後 Moor 會通知你。',
    ...
    moorActiveSessions: (version, count) => `Moor ${version} · 活躍工作階段 ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot 使用者 ID', placeholder: '@moor:example.org' },
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description: '此設定檔中的工作階段將在你指定的遠端 Moor 上執行，而不是這台電腦。',
      urlLabel: '遠端位址',
    ...
    deleting: '刪除中…',
    createDesc: '設定檔是獨立的 Moor 環境：各自擁有獨立的設定、技能和 SOUL.md。',
    nameLabel: '名稱',
    cloneFrom: '複製來源',
    cloneFromNone: '無（空白）',
  ...
  cron: {
    ...
    newCron: '新排程工作',
    emptyDescNew: '按 cron 表達式排程一個提示詞。Moor 會執行它，並將結果傳送至您選擇的目的地。',
  ...
  sidebar: {
    ...
    projects: {
      ...
      createFailed: '無法建立專案',
      staleBackend: '請更新 Moor 後端以建立專案——目前後端比桌面應用舊（設定 → 更新 → 後端）。',
      deleteConfirm: '這會從 Moor 中移除已儲存的專案。檔案、git 儲存庫和工作樹維持不變。',
      startWork: '新增工作樹',
  ...
  composer: {
    ...
    placeholderStarting: '正在啟動 Moor...',
    placeholderReconnecting: '正在重新連線至 Moor…',
    ...
    attachUrlDesc: 'Moor 將擷取該頁面並作為此回合的脈絡。',
  ...
  updates: {
    ...
    availableBody: '新版 Moor 已可安裝。',
    availableTitleBackend: '後端有可用更新',
    availableBodyBackend: '已連接的 Moor 後端有新版本可安裝。',
    availableBodyNoChangelog: '已有新版本可用。此安裝方式無法顯示更新日誌。',
    updateNow: '立即更新',
    maybeLater: '稍後再說',
    moreChanges: count => `另有 ${count} 項變更。`,
    manualTitle: '從終端機更新',
    manualBody: '您是從命令列安裝的 Moor，因此更新也需要在那裡執行。請將此指令貼到終端機：',
    manualPickedUp: '下次啟動 Moor 時會使用新版本。',
    guiSkewTitle: '請更新桌面應用程式',
    guiSkewBody:
      '後端已更新，但此桌面應用程式套件未變更。請更新或重新安裝 Moor 桌面應用程式（你的 AppImage / .deb / .rpm）以保持一致。',
    copy: '複製',
    copied: '已複製',
    done: '完成',
    applyingBody:
      'Moor 更新程式會在自己的視窗中接管，並在完成後自動重新開啟 Moor。更新期間請勿自行重新開啟 Moor。',
    applyingBodyBackend: '遠端後端正在套用更新並將重新啟動。恢復後 Moor 會自動重新連線。',
  ...
  install: {
    ...
    backToSetup: '返回',
    failedTitle: '安裝失敗',
    settingUpTitle: '正在設定 Moor Agent',
    finishingTitle: '正在收尾',
    failedDesc:
      '某個安裝步驟失敗。在 Windows 上，如果另一個 Moor CLI 或桌面執行個體正在執行，可能會出現這種情況。請停止正在執行的 Moor 執行個體後重試。可查看下方的詳細資訊或 desktop 記錄中的完整記錄。',
    activeDesc: '這是一次性設定。Moor 安裝程式正在下載相依套件並設定您的電腦。之後啟動會略過此步驟。',
  ...
  onboarding: {
    headerTitle: '開始設定 Moor Agent',
    headerDesc: '連線模型提供方即可開始聊天。大多數選項只需一次點擊。',
    preparingInstall: 'Moor 正在完成安裝。首次執行通常不到一分鐘。',
    starting: '正在啟動 Moor…',
    ...
    recommended: '建議',
    connected: '已連線',
    featuredPitch: '一個訂閱，300+ 前沿模型 — 執行 Moor 的建議方式',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: '自託管',
        description: '將 Moor 指向本機或自託管的 OpenAI 相容端點（vLLM、llama.cpp、Ollama 等）。'
      }
    },
    backToSignIn: '返回登入',
    getKey: '取得金鑰',
    ...
    flowSubtitles: {
      ...
      device_code: '在瀏覽器中開啟驗證頁面 — Moor 會自動連線',
    ...
    authorizeThere: '請在那裡授權 Moor。',
    copyAuthCode: '複製授權碼並貼到下方。',
    pasteAuthCode: '貼上授權碼',
    reopenAuthPage: '重新開啟授權頁面',
    autoBrowser: provider => `已在瀏覽器中開啟 ${provider}。請在那裡授權 Moor，連線會自動完成，無需複製或貼上。`,
  ...
  modelPicker: {
    ...
    pro: 'Pro',
    proNeedsSubscription: 'Pro 模型需要付費 Moor 訂閱。',
    free: '免費',
    freeTier: '免費層',
  ...
  preview: {
    ...
    largeTitle: '此檔案較大',
    largeBody: (label, size) => `${label} 大小為 ${size}。Moor 只會顯示前 512 KB。`,
    previewAnyway: '仍然預覽',
    ...
    web: {
      ...
      failedToLoad: '預覽載入失敗',
      tryAgain: '重試',
      restarting: 'Moor 正在重新啟動...',
      askRestart: '請 Moor 重新啟動伺服器',
      lookingRestart: taskId => `Moor 正在尋找要重新啟動的預覽伺服器 (${taskId})`,
      restartingTitle: '正在重新啟動預覽伺服器',
      restartingMessage: 'Moor 正在背景執行。可在預覽主控台查看進度。',
      ...
      blankPageBody: '在上方輸入網址開始瀏覽，或請 Moor 開啟頁面。',
      finishedRestarting: message => `Moor 已完成預覽伺服器重新啟動${message ? `：${message}` : ''}`,
      failedRestarting: message => `伺服器重新啟動失敗：${message}`,
      unknownError: '未知錯誤',
      restartedTitle: '預覽伺服器已重新啟動',
      reloadingNow: '正在重新載入預覽。',
      restartFailedTitle: '預覽重新啟動失敗',
      restartFailedMessage: 'Moor 無法重新啟動伺服器。',
      stillWorking: 'Moor 仍在執行，但尚未收到重新啟動結果。伺服器指令可能正在前台執行。',
  ...
  assistant: {
    ...
    approval: {
      gatewayDisconnected: 'Moor 閘道未連線',
      sendFailed: '無法傳送核准回應',
      run: '執行',
      command: '指令',
      moreOptions: '更多核准選項',
      ...
      alwaysDescription: pattern =>
        `這會將「${pattern}」模式加入永久允許清單（~/.moor/config.yaml）。Moor 對類似指令將不再詢問，包括目前工作階段和未來工作階段。`,
      alwaysAllow: '一律允許'
    },
    clarify: {
      notReady: '澄清請求尚未就緒',
  ...
  prompts: {
    ...
    sudoTitle: '管理員密碼',
    sudoDesc: 'Moor 需要您的 sudo 密碼來執行特權指令。它只會傳送給您的本機代理。',
  ...
  desktop: {
    ...
    restartToUseSaveImage: '重新啟動 Moor Desktop 後可使用儲存圖片。',
    restartToSaveImages: '重新啟動 Moor Desktop 以儲存圖片',
    ...
    handoff: {
      ...
      timedOut: '等待閘道逾時。`moor gateway` 是否正在執行？'
    }
  },
  ...
  tips: {
    ...
    items: {
      ...
      profiles: {
        title: '設定檔彼此獨立',
        text: '每個都是獨立的 Moor — 自己的金鑰、記憶與工作階段。'
      },
      'composer-mentions': {
        title: '附件與指令',
