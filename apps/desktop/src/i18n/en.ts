...
export const en: Translations = {
  ...
  boot: {
    ...
    errors: {
      backgroundExited: 'Moor background process exited.',
      backgroundExitedDuringStartup: 'Moor background process exited during startup.',
  ...
  notifications: {
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Moor Desktop.',
  ...
  settings: {
    ...
    plugins: {
      ...
      agent: {
        title: 'Agent plugins',
        blurb:
          'Plugins you installed into the Moor backend — tools, skills, MCP servers, hooks, and slash commands. Portable ones are Agent Plugins packages (skills + MCP bundles that work in other agents too). Toggles apply to new sessions.',
      ...
      installModal: {
        ...
        agentTargetLocal: profile => `Installs into the ${profile} backend (~/.moor/plugins/)`,
    ...
    appearance: {
      ...
      tipsDesc:
        'A small bubble pointing at one part of the app, shown occasionally while idle and by Moor when it helps. Closing one retires it for good.',
      tipsReset: (count: number) => `Bring back ${count} closed ${count === 1 ? 'tip' : 'tips'}`,
      toursTitle: 'Guided Tours',
      toursDesc: 'Let Moor walk you through the app, dimming the screen and spotlighting each step.',
    ...
    about: {
      ...
      bundleOutOfSyncDesc:
        'The Moor runtime was updated, but the desktop app itself is still an older build — new interface features (like Bot Mode) will be missing until it updates. Run the update below to rebuild the app. If that doesn\u2019t clear this warning, reinstall from the latest desktop installer.',
      ...
      automaticUpdatesDesc:
        'Moor checks for updates automatically in the background and lets you know when one is ready.',
    ...
    gateway: {
      ...
      envOverrideDesc:
        'Unset MOOR_DESKTOP_REMOTE_URL and MOOR_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      ...
      sshErrNotInstalled:
        'Moor is not installed on the remote host. Install it there (curl -fsSL https://hermes-agent.nousresearch.com/install.sh | sh) or set the Moor path.',
      sshErrPlatform:
    ...
    localModels: {
      ...
      upToDateDetail: (tag, backend) => `Running llama.cpp ${tag} (${backend}) — the latest build Moor ships.`,
    ...
    toolsets: {
      ...
      nousIncluded: 'Included with a Moor subscription — sign in to Moor Portal to activate.',
      nousAuthNeededTitle: 'Sign in to Moor Portal',
      nousAuthNeededMessage: provider => `${provider} is saved but won't activate until you sign in to Moor Portal.`,
      nousAuthSignIn: 'Sign in',
      nousAuthDoneTitle: 'Moor Portal connected',
      nousAuthDoneMessage: 'Your subscription backends are now active.',
      nousAuthFailed: 'Moor Portal sign-in did not complete',
  ...
  install: {
    ...
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Moor CLI or desktop instance is running. Stop any running Moor instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
  ...
  assistant: {
    ...
    mcpSetup: {
      ...
      catalogSource: 'From the Moor-approved catalog',
  ...
  prompts: {
    ...
    sudoDesc: 'Moor needs your sudo password to run a privileged command. It is sent only to your local agent.',
  ...
  desktop: {
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `moor gateway` running?'
    }
  },
