...
export const en: Translations = {
  ...
  connectorsPage: {
    ...
    page: {
      ...
      noMatchBody: 'Nothing here matches. Point Moor at your own MCP server to add it.',
      ...
      signInLine: 'Sign in to Moor to use managed apps.',
      signIn: 'Sign in',
      ...
      disconnectNoAccount: 'Moor has no account to disconnect here. Refresh the page and try again.',
      disconnectRefused:
        'Moor could not remove this sign-in right now. Turn the app off with the switch instead, or try again later.'
    },
    ...
    dialog: {
      ...
      disconnectBody: 'Moor stops acting as this account. You can connect again at any time.',
      ...
      nousLine: 'Moor apps follow your account, not the profile.',
      rulesReadOnly: 'Rules cannot be changed right now.',
      rulesAppOff: (name: string) => `Turn ${name} on to change its tools.`,
      rulesSignIn: 'Sign in to change what Moor may do here.',
    ...
    tools: {
      ...
      summaryTitle: (name: string) => `What Moor may do with ${name}`,
      summaryPreviewTitle: (name: string) => `What Moor could do with ${name} once you connect`,
      ...
      goneBody: 'Moor cannot call it any more. The row stays until you remove it, so nothing vanishes.',
      remove: 'Remove',
      offTitle: (name: string) => `${name} is off.`,
      offBody: 'Turn it on with the switch above to read the tools it brings.',
      signedOutTitle: 'Sign in to Moor to read the tool list.',
  ...
  sessionImport: {
    ...
    subtitle: 'Bring a conversation into Moor and pick up where you left off.',
    ...
    chooseHelp: 'Choose a session to read its history before bringing it into Moor.',
    ...
    you: 'You',
    snapshot: 'This conversation is already in Moor. Open your existing copy to continue.',
    copyNotice:
      'Copies conversation text. Source files stay unchanged. Tool output and reasoning are not carried over.',
    importing: 'Importing…',
    open: 'Open in Moor',
    continue: 'Continue in Moor',
  ...
  boot: {
    ...
    steps: {
      ...
      startingMoorDesktop: 'Starting Moor Desktop…'
    },
    errors: {
      backgroundExited:
    ...
    failure: {
      ...
      cloudDownTitle: 'Moor Cloud agent is down',
      cloudDownDescription:
        'The Moor-managed cloud agent this gateway connects to is returning a server error. It cannot be restarted from here — check its status, switch to the local gateway, or get support.',
      cloudDownHint:
        'The buttons below open the Moor Portal (instance status and controls) and our Discord for support.',
  ...
  notifications: {
    sharedProfileWarning:
      'Another Moor installation is using this profile. Both installations share its settings and data, so changes can conflict. You can continue, or close the other installation before making changes.',
    ...
    backendOutOfDateMessage:
      'Your Moor backend is older than this desktop build and may not work correctly. Update to align them.',
    ...
    updateReadyMessageAppInstaller: 'A new version of Moor is ready. Update now and Windows will finish it for you.',
    ...
    errors: {
      ...
      methodNotAllowed:
        "Moor' background service is out of step with the app, probably after an update. Restart it to fix this.",
      ...
      codeSkewRestartRequired:
        'Moor was updated but is still running the old version. Restart it to finish the update.',
  ...
  sendDiagnostics: {
    title: 'Send diagnostics to Moor',
    privacyNotice:
      'This uploads a debug bundle to Moor-internal storage (not a public paste). It includes system info (OS, versions, provider, which API keys are configured — never the keys themselves) and full agent, gateway, and desktop logs (up to 512 KB each), which likely contain conversation content, tool outputs, and file paths. Secrets are redacted before upload. The bundle is viewable only by Moor staff and allowlisted Discord moderators, and auto-deletes after 14 days.',
    upload: 'Upload',
    uploading: 'Uploading…',
    cancel: 'Cancel',
    close: 'Close',
    ...
    failedHint:
      'You can also run `moor debug share --moor` from a terminal, or `moor debug share --local` to print the report without uploading.',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Moor defaults?',
    ...
    plugins: {
      ...
      installModal: {
        ...
        installUncertain:
          'Moor stopped waiting for the install result, but the plugin may still be installing. Close this dialog and use Rescan in Plugins before trying Install again.',
    ...
    notifications: {
      ...
      kinds: {
        ...
        input: {
          label: 'Input needed',
          description: 'Moor asked a question or needs a password or secret.'
        },
        turnDone: {
          label: 'Response ready',
          description: 'A turn finished while Moor was in the background.'
        },
        turnError: {
          label: 'Turn failed',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Moor follow your system setting.',
      ...
      pet: {
        title: 'Pet',
        intro:
          'Adopt an animated petdex mascot that floats over the app and reacts to what Moor is doing — running while tools execute, celebrating on success, sulking on errors.',
        restartHint:
          'Pets need a quick restart — the running app started before this feature was added. Quit and reopen Moor, then come back here.',
        scaleTitle: 'Size',
    ...
    uninstallSection: {
      ...
      options: {
        ...
        lite: {
          ...
          description:
            'Remove the app and the Moor agent, but keep config, chats, and secrets for a future reinstall.',
    ...
    config: {
      ...
      minimizeToTrayDesc:
        'Minimize windows or close the main window to hide them in the system tray (menu bar on macOS) and keep Moor running. Use Quit Moor from the tray menu or Cmd+Q to exit. Off by default; applies only to this device.',
    ...
    hudModifier: {
      ...
      permission:
        'Allow Moor in System Settings → Privacy & Security → Input Monitoring, then retry. This gesture does not record keystrokes or capture your screen.',
      unavailable:
        'The HUD gesture helper could not start or stopped unexpectedly. Retry, or restart Moor. The existing HUD shortcut still works inside Moor.',
      missingHelper:
        'This Moor installation is missing the HUD gesture helper. Update or reinstall Moor, then retry.',
      unsupportedSession:
    ...
    screenshot: {
      ...
      enabledDesc:
        'Press both Command keys together from any app to capture its frontmost window and attach it to your current Moor draft. Never sends automatically. Off by default; applies only to this Mac. Window contents may be sensitive — review the attachment before sending.',
      ...
      inputPermission:
        'Input Monitoring permission lets Moor detect both Command keys while another app is active. Allow Moor in System Settings → Privacy & Security → Input Monitoring, then return here and retry.',
      screenPermission:
        'Screen Recording permission lets Moor capture the frontmost app window when you use this shortcut. Allow Moor in System Settings → Privacy & Security → Screen Recording, then return here and retry. Restart Moor if macOS asks.',
    ...
    connections: {
      ...
      intro: 'Manage this device and every Moor gateway it can reach through remote, SSH, or Cloud connections.',
      stagedNote:
      ...
      cloudAddHint:
        'Tip: signing in under Moor Cloud above discovers your agents automatically — use this form only to register a known instance URL by hand.',
    ...
    gateway: {
      ...
      unavailableDesc:
        'Connection settings can only be changed from the Moor Desktop app on the computer running it.',
      ...
      remoteDesc: 'Connect this desktop shell to a remote Moor backend.',
      ...
      cloudDesc: 'Sign in once to Moor Cloud and pick from the agents on your account — no URL to paste.',
      cloudSignInTitle: 'Moor Cloud',
      cloudSignIn: 'Sign in to Moor Cloud',
      cloudSignedIn: 'Signed in to Moor Cloud',
      cloudNeedsSignIn: 'Sign in to Moor Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Moor Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Moor Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Moor Cloud',
      cloudSignedOutMessage: 'Cleared the Moor Cloud session.',
      ...
      probeError:
        "Moor can't reach that address. Check the URL and that the other computer is running Moor — sign-in options appear once it answers.",
      signedIn: 'Signed in',
      signIn: 'Sign in',
      signOut: 'Sign out',
      ...
      restartingMessage: 'Moor Desktop will reconnect using the saved settings — the shell stays open.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Moor ${version}` : ''}`,
      ...
      sshMoorPathTitle: 'Moor path (optional)',
      sshMoorPathDesc: 'Full path to the remote moor binary. Blank = auto-detect.',
      sshMoorPathPlaceholder: 'auto-detect',
      ...
      sshErrNotInstalled:
        'Moor is not installed on the remote host. Install it there (curl -fsSL https://raw.githubusercontent.com/thisismamad-n/Moor/master/scripts/install.sh | bash) or set the Moor path.',
      sshErrPlatform:
    ...
    localModels: {
      ...
      runtimeInstalledDetail: (tag, backend) =>
        `Build ${tag}, ${backend} backend. Moor starts and manages the server for you.`,
      ...
      state: {
        notice: {
          loggedOut: {
            ...
            message: 'Sign in with your Moor account to see your balance, plan and usage here.',
            action: 'Sign in'
          },
          openPortal: 'Open portal ↗',
          noCard: {
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Moor runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
      ...
      localEndpoint: {
        ...
        description: 'Point Moor at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
    ...
    toolsets: {
      ...
      nousAuthNeededMessage: provider =>
        `${provider} is saved but will only work once you sign in with your Moor account.`,
      ...
      browserRealProfile: {
        ...
        prompt: {
          ...
          body: 'Let Moor browse with a snapshot of your default browser profile, so sites open already signed in.',
  ...
  skills: {
    ...
    plugins: {
      ...
      deepLinkCatalogUnknown: (name: string) =>
        `\u201C${name}\u201D is not in the Moor plugin catalog. Nothing was installed.`,
      deepLinkCatalogUnavailable:
        'Could not load the Moor plugin catalog. Check your connection and open the link again.',
  ...
  starmap: {
    ...
    emptyDesc: 'As Moor builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Restart Moor to use pets — the backend predates this feature.',
    ...
    generatePet: {
      ...
      staleBackend: 'Update Moor to generate pets.',
      backgroundHint: 'You can close this — Moor will notify you when it’s done.',
    ...
    moorActiveSessions: (version, count) => `Moor ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@moor:example.org' },
  ...
  profiles: {
    ...
    remoteOverride: {
      ...
      description: 'Sessions in this profile will run on the remote Moor you point it at, instead of this computer.',
    ...
    defaultDescription: 'Used when Moor opens and for new chats. Existing sessions stay in their profiles.',
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Moor environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Moor will run it and deliver results to the destination you pick.',
  ...
  sidebar: {
    ...
    storageCorrupt: {
      ...
      body: (profiles: string) =>
        `Moor can't read all of the session history for ${profiles}. Chats missing from this list were not deleted; the file they are stored in is damaged.`,
      action: 'Quit Moor on this profile, then inspect the file without changing it, or restore a snapshot:',
    ...
    projects: {
      ...
      staleBackend:
        'Update the Moor backend to create projects — your backend is older than this desktop app (Settings → Updates → Backend).',
      deleteConfirm: 'This removes the saved project from Moor. Files, git repos, and worktrees stay untouched.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Moor...',
    placeholderReconnecting: 'Reconnecting to Moor…',
    ...
    commandDescs: {
      ...
      '/goal': 'Set a standing goal Moor works on across turns until achieved',
      ...
      '/plan': 'Write a markdown implementation plan to .moor/plans/ without executing anything',
      ...
      '/subscription': 'View your Moor plan and change it in the browser',
    ...
    attachUrlDesc: 'Moor will fetch the page and include it as context for this turn.',
  ...
  updates: {
    discontinuedTitle: 'This build of Moor is no longer supported',
    discontinuedBody:
      'This build of Moor is no longer supported and may break — uninstall it. Your data stays on disk.',
    channels: { stable: 'Stable', canary: 'Canary' },
    bundleSwapPending: 'Restart to finish the update',
    bundleSwapPendingDesc:
      'The updated app is already installed — Moor only needs to restart to load it. Chats and settings are untouched.',
    bundleSwapPendingAction: 'Restart Moor',
    stages: {
      idle: 'Getting ready…',
      ...
      pull: 'Almost there…',
      pydeps: 'Finishing up…',
      update: 'Updating Moor…',
      rebuild: 'Rebuilding the desktop app…',
      restart: 'Restarting Moor…',
    ...
    gitUnusable: 'Moor could not run Git on this computer, so it could not check for updates.',
    connectionSettings: 'Connection settings',
    ...
    manualBody: 'You installed Moor from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Moor will pick up the new version next time you launch it.',
    guiSkewTitle: 'Update the desktop app',
    guiSkewBody:
      'The backend was updated, but this desktop app package wasn’t changed. Update or reinstall the Moor desktop app (your AppImage / .deb / .rpm) to match.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody:
      'The Moor updater takes over in its own window and reopens Moor automatically when it’s done. Please don’t reopen Moor yourself while it’s updating.',
    applyingBodyBackend:
      'The remote backend is applying the update and will restart. Moor reconnects automatically when it’s back.',
    applyingClose: 'This window will close while the update runs, then Moor reopens on its own.',
    applyingBodyAppInstaller:
      'Moor will close and Windows will finish the update. Moor will reopen when it’s done — you don’t need to do anything.',
    applyingCloseAppInstaller: 'This window will close, Windows finishes the update, and Moor reopens on its own.',
    checkUnknownTitleAppInstaller: 'Couldn’t check for updates',
    checkUnknownBodyAppInstaller:
      'Windows couldn’t check for updates right now. Updates also install automatically when you restart Moor.',
    ...
    bundleOutOfSyncDesc:
      'The Moor runtime was updated, but the desktop app itself is still an older build. Update it to pick up the latest fixes.',
    ...
    versionDetailsDistributionSourceInstallerDesktop: 'Source (install script) + moor desktop',
    versionDetailsDistributionSource: 'Source',
    versionDetailsDistributionSourceDesktop: 'Source + moor desktop',
  ...
  install: {
    ...
    oneTimeTitle: 'Moor needs a one-time install',
    ...
    setupChoiceDescLocal: 'Install Moor on this computer, or connect to a Moor gateway you already run.',
    ...
    useLocalTitle: 'Use Moor on this computer',
    useLocalDesc: 'A Moor runtime is already installed here — start it with one click. Nothing downloads.',
    bundledLocalDesc: 'Use the Moor runtime included with this app — the bundled backend is the local install.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Moor Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Moor is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Moor…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Moor',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Moor at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Moor connects automatically',
    ...
    authorizeThere: 'Authorize Moor there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Moor there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  freeTier: {
    ...
    setupFailed: {
      ...
      generic:
        "Moor couldn't set up free access without signing in. Signing in is free, or connect another provider.",
  ...
  modelPicker: {
    ...
    pro: 'Pro',
    proNeedsSubscription: 'Pro models need a paid Moor subscription.',
    free: 'Free',
    freeTier: 'Free tier',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Moor will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Moor is restarting...',
      askRestart: 'Ask Moor to restart the server',
      lookingRestart: taskId => `Moor is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Moor is working in the background. Watch the preview console for progress.',
      ...
      blankPageBody: 'Type an address above to browse, or ask Moor to open a page.',
      finishedRestarting: message => `Moor finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Moor could not restart the server.',
      stillWorking:
        'Moor is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  interfaceMode: {
    ...
    hint: 'Changes what is shown, not what Moor can do.',
    sessionNote: 'Set by Simple mode. A change here lasts for this session; switch to Advanced to make it yours.',
    simple: {
      label: 'Simple',
      description: 'For talking to Moor. Sidebar and chat; no terminal, file or diff panes.'
    },
    advanced: {
      label: 'Advanced',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Moor is loading a response',
      ...
      errorLayerBodies: {
        ...
        endpoint:
          "Moor can't reach your custom model server. Check that it is running, then send your message again.",
        gateway:
          'Moor hit an internal problem starting this reply. Send your message again; if it keeps happening, send diagnostics.',
    ...
    approval: {
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.moor/config.yaml). Moor won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoInstallDesc:
      'Moor needs your sudo password to install the Bot Screen packages (TigerVNC + Xfce) on the gateway host. It is sent only to that host.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Moor Desktop to use Save Image.',
    restartToSaveImages: 'Restart Moor Desktop to save images',
    ...
    handoff: {
      ...
      timedOut:
        "Moor couldn't reach your messaging connection. Start it from Settings → Messaging, then try the handoff again.",
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        title: 'Teach it once',
        text: 'Skills are folders of instructions Moor loads when the work calls for them.'
      },
      messaging: {
        title: 'Moor away from your desk',
        text: 'Connect Telegram, Discord, Slack and more — same agent, same memory.'
      },
      artifacts: {
        title: 'Everything Moor made',
      ...
      profiles: {
        ...
        text: 'Each one is its own Moor — own keys, own memory, own sessions.'
      },
      'composer-mentions': {
