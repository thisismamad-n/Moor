...
export const frOverrides = {
  ...
  connectors: {
    ...
    disclaimer: "La connexion est facultative. N'autorisez que les applications que vous voulez confier à Moor.",
  ...
  connectorsPage: {
    ...
    card: {
      ...
      inCatalog: 'Dans le catalogue Moor',
    ...
    page: {
      ...
      noMatchBody: 'Aucun résultat. Indiquez à Moor votre propre serveur MCP pour l’ajouter.',
      ...
      signInLine: 'Connectez-vous à Moor pour utiliser les applications gérées.',
      signIn: 'Se connecter',
      ...
      disconnectNoAccount: 'Moor n’a aucun compte à déconnecter ici. Actualisez la page et réessayez.',
      disconnectRefused:
        'Moor ne peut pas supprimer cette connexion pour le moment. Désactivez plutôt l’application avec l’interrupteur, ou réessayez plus tard.'
    },
    add: {
    ...
    dialog: {
      ...
      disconnectBody: "Moor cesse d'agir avec ce compte. Vous pouvez vous reconnecter à tout moment.",
      ...
      appSwitch: (name: string) => `Moor peut utiliser ${name}`,
      ...
      wayHosted: 'Géré',
      bothOn: (name: string) => `Les deux sont activés : Moor voit donc chaque outil ${name} en double.`,
      ...
      nousLine: 'Les applications Moor suivent votre compte, pas le profil.',
      ...
      rulesSignIn: 'Connectez-vous pour modifier ce que Moor peut faire ici.',
    ...
    tools: {
      ...
      summaryTitle: (name: string) => `Ce que Moor peut faire avec ${name}`,
      summaryPreviewTitle: (name: string) => `Ce que Moor pourra faire avec ${name} une fois connecté`,
      ...
      goneBody: "Moor ne peut plus l'appeler. La ligne reste jusqu'à ce que vous la supprimiez : rien ne disparaît.",
      remove: 'Supprimer',
      ...
      signedOutTitle: 'Connectez-vous à Moor pour lire la liste des outils.',
  ...
  sessionImport: {
    ...
    subtitle: 'Importez une conversation dans Moor et reprenez là où vous en étiez.',
    ...
    chooseHelp: "Choisissez une session pour lire son historique avant de l'importer dans Moor.",
    ...
    you: 'Vous',
    snapshot: 'Cette conversation est déjà dans Moor. Ouvrez votre copie existante pour continuer.',
    copyNotice:
    ...
    open: 'Ouvrir dans Moor',
    continue: 'Continuer dans Moor',
  ...
  boot: {
    ready: 'Moor Desktop est prêt',
    desktopBootFailedWithMessage: message => `Échec du démarrage : ${message}`,
    steps: {
      connectingGateway: 'Connexion au gateway desktop',
      loadingSettings: 'Chargement des paramètres Moor',
      loadingSessions: 'Chargement des sessions récentes',
      retryingRemoteBackend: 'Reconnexion au backend Moor distant…',
      startingDesktopConnection: 'Démarrage de la connexion desktop',
      startingMoorDesktop: 'Démarrage de Moor Desktop…'
    },
    errors: {
      backgroundExited: "Le processus en arrière-plan de Moor s'est arrêté.",
      backgroundExitedDuringStartup: "Le processus en arrière-plan de Moor s'est arrêté pendant le démarrage.",
      backendStopped: 'Backend arrêté',
      restartMoor: 'Redémarrer Moor',
      openLogs: 'Ouvrir les journaux',
    ...
    causes: {
      exitedEarly: "Le service en arrière-plan de Moor s'est arrêté juste après son démarrage.",
      timedOut: "Le service en arrière-plan de Moor n'a pas répondu à temps.",
      permission: "Moor n'a pas pu écrire dans son dossier de données (problème d'autorisation).",
      diskFull: "Le disque est plein ; Moor n'a donc pas pu démarrer.",
      portInUse: 'Un autre programme utilise le port réseau nécessaire à Moor.',
      installMissing:
        "Une partie de l'installation de Moor est manquante. Choisissez Réparer l'installation pour la restaurer."
    },
    failure: {
      title: "Moor n'a pas pu démarrer",
      description:
      ...
      cloudDownTitle: "L'agent Moor Cloud est indisponible",
      cloudDownDescription:
        "L'agent cloud géré par Moor auquel ce gateway se connecte renvoie une erreur serveur. Il ne peut pas être redémarré depuis ici — vérifiez son état, passez au gateway local ou contactez l'assistance.",
      cloudDownHint:
        "Les boutons ci-dessous ouvrent le portail Moor, pour consulter et contrôler l'instance, ainsi que notre Discord pour obtenir de l'aide.",
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Votre backend Moor est plus ancien que cette version du desktop et peut ne pas fonctionner correctement. Mettez-le à jour pour les aligner.',
    installMethodUnsupportedTitle: "Méthode d'installation non prise en charge",
    updateMoor: 'Mettre à jour Moor',
    ...
    errors: {
      ...
      storageFailure:
        "Moor n'a pas pu enregistrer dans son dossier de données. Ouvrez Maintenance pour le vérifier et le réparer.",
      gatewayAuthFailed: "Échec de l'authentification du gateway — vérifiez API_SERVER_KEY.",
      methodNotAllowed:
        'Le backend du desktop a rejeté cette requête (405 Method Not Allowed). Essayez de redémarrer Moor Desktop.',
      ...
      restartMoorFailed: 'Impossible de redémarrer Moor'
    },
    actions: {
      restartMoor: 'Redémarrer Moor',
    ...
    voice: {
      ...
      liveDelegationFailed: 'Impossible de transmettre la demande à Moor',
    ...
    native: {
      ...
      inputBody: 'Moor attend votre réponse.',
      turnDoneTitle: 'Moor a terminé',
      turnDoneBody: '',
  ...
  billingBlock: {
    titleMoor: 'Plus de crédits Moor',
  ...
  sendDiagnostics: {
    title: 'Envoyer les diagnostics à Moor',
    privacyNotice:
      "Cela téléverse un paquet de débogage vers un stockage interne de Moor, et non vers un service de partage public. Il contient des informations système (système d'exploitation, versions, fournisseur et clés API configurées — jamais les clés elles-mêmes) ainsi que les journaux complets de l'agent, du gateway et du Desktop (jusqu'à 512 Ko chacun), susceptibles de contenir des conversations, des résultats d'outils et des chemins de fichiers. Les secrets sont expurgés avant l'envoi. Seuls le personnel de Moor et les modérateurs Discord autorisés peuvent consulter le paquet, qui est automatiquement supprimé après 14 jours.",
    upload: 'Envoyer',
    ...
    failedHint:
      'Vous pouvez également exécuter `moor debug share --moor` dans un terminal, ou `moor debug share --local` pour afficher le rapport sans le téléverser.',
    handoffLead: 'Poursuivez la discussion sur :',
    links: {
      github: 'Issues GitHub',
      portal: 'Assistance du portail Moor',
      discord: 'Discord'
    }
  },
  titlebar: {
  ...
  settings: {
    ...
    resetConfirm: 'Réinitialiser tous les paramètres aux valeurs par défaut de Moor ?',
    ...
    plugins: {
      ...
      installModal: {
        ...
        catalogPinned: (name, sha) =>
          `Entrée « ${name} » du catalogue Moor — le composant agent sera installé depuis le commit vérifié${sha ? ` ${sha}` : ''}, et non depuis la tête de branche.`,
        ...
        installUncertain:
          "Moor n'attend plus le résultat de l'installation, mais le plugin est peut-être encore en cours d'installation. Fermez cette fenêtre et actualisez la liste des plugins avant de relancer l'installation.",
    ...
    vault: {
      ...
      otpHint:
        "La « clé d'installation » que le site affiche lorsque vous activez 2FA. Avec elle enregistrée, Moor génère lui-même les codes.",
      ...
      sources: {
        ...
        notInstalled: name =>
          `Non détecté. Installez l’outil en ligne de commande ${name} et connectez-vous ; Moor le repère automatiquement.`,
        disabledDesc: 'Détecté mais désactivé pour Moor.',
        lockedDesc:
          "Détecté. L'agent vous demandera de le déverrouiller lorsqu'il en a besoin, ou déverrouillez maintenant.",
        unlockedDesc:
          "Déverrouillé pour cette session. Se verrouille automatiquement après 30 minutes d'inactivité ou lorsque Moor se ferme.",
    ...
    notifications: {
      ...
      focusedHint: 'Les alertes de fin ne se déclenchent que quand Moor est en arrière-plan.',
      kinds: {
        approval: {
        ...
        input: {
          ...
          description: "Moor a posé une question ou a besoin d'un mot de passe ou d'un secret."
        },
        turnDone: {
          label: 'Réponse prête',
          description: "Un tour s'est terminé pendant que Moor était en arrière-plan."
        },
        turnError: {
          label: 'Échec du tour',
        ...
        plugin: {
          ...
          description: 'Un plugin desktop a envoyé une notification pendant que Moor était en arrière-plan.'
        }
      },
    ...
    searchPlaceholder: {
      about: 'À propos de Moor Desktop',
    ...
    appearance: {
      ...
      colorModeDesc: 'Choisissez un mode fixe ou laissez Moor suivre le paramètre système.',
      ...
      reactionsDesc: 'Réactions emoji façon iMessage — réagissez aux messages, et Moor peut réagir aux vôtres.',
      tipsTitle: "Astuces dans l'application",
      tipsDesc:
        "Une petite bulle désigne occasionnellement une partie de l'application lorsque vous êtes inactif ou lorsque Moor peut vous aider. Fermer une astuce la masque définitivement.",
      tipsReset: (count: number) =>
        `Réafficher ${count} astuce${count === 1 ? '' : 's'} fermée${count === 1 ? '' : 's'}`,
      toursTitle: 'Visites guidées',
      toursDesc:
        "Laissez Moor vous guider dans l'application en assombrissant l'écran et en mettant chaque étape en évidence.",
      ...
      pet: {
        ...
        intro:
          "Adoptez une mascotte petdex animée qui flotte au-dessus de l'application et réagit aux actions de Moor — court pendant l'exécution des outils, fête les réussites, boude les erreurs.",
        restartHint:
          "Les animaux de compagnie nécessitent un redémarrage rapide — l'application en cours a démarré avant l'ajout de cette fonctionnalité. Fermez et rouvrez Moor, puis revenez ici.",
        scaleTitle: 'Taille',
    ...
    fieldDescriptions: defineFieldCopy({
      ...
      fileReadMaxChars: 'Nombre maximal de caractères que Moor peut lire dans une demande de fichier.',
      approvals: {
        mode: 'Comment Moor gère les commandes nécessitant une approbation explicite.',
      ...
      voice: {
        ...
        voiceChatMode:
          'chained : reconnaissance vocale → Moor → synthèse vocale avec les fournisseurs ci-dessous. gpt-live : un modèle vocal OpenAI full-duplex (gpt-live-1) écoute et parle, et confie chaque vraie demande à Moor — le modèle que vous avez sélectionné répond avec l’ensemble des outils. Nécessite une clé API OpenAI ; la couche vocale est facturée 0,05 $ par minute.',
        gptLive: {
          voice: 'Voix du mode GPT-Live. Les identifiants de voix personnalisés sont acceptés.',
          instructions:
            'Phrases supplémentaires pour la personnalité vocale en direct (ton, rythme, langue). Moor conserve son propre prompt système.'
        }
      },
      tts: {
        xai: {
      ...
      updates: {
        nonInteractiveLocalChanges:
          "Quand Moor se met à jour depuis l'application (sans invite de terminal), conserve les modifications locales (stash) ou les abandonne (discard). Les mises à jour via le terminal demandent toujours confirmation."
      }
    }),
    uninstallSection: {
      dangerZone: 'Zone dangereuse',
      checkingInstalled: 'Vérification des éléments installés…',
      uninstallMoor: 'Désinstaller Moor',
      chooseHowMuch:
      ...
      options: {
        gui: {
          ...
          description:
            'Supprime cette application de bureau. L’agent Moor, votre configuration et vos conversations sont conservés.',
        ...
        lite: {
          ...
          description:
            'Supprime l’application et l’agent Moor, mais conserve la configuration, les conversations et les secrets pour une future réinstallation.',
          consequence:
            'l’interface de chat et l’agent Moor (la configuration, les conversations et les secrets sont conservés)'
        },
        full: {
          ...
          consequence:
            'TOUT — l’interface de chat, l’agent Moor et l’ensemble de votre configuration, de vos conversations, secrets et journaux'
        }
      }
    },
    poolLimits: {
    ...
    config: {
      ...
      minimizeToTrayDesc:
        'Réduire les fenêtres ou fermer la fenêtre principale les masque dans la zone de notification (barre des menus sur macOS) et Moor continue de s’exécuter. Utilisez Quitter Moor dans le menu de la zone de notification ou Cmd+Q pour quitter. Désactivé par défaut ; s’applique uniquement à cet appareil.',
      ...
      loading: 'Chargement de la configuration Moor...',
    ...
    hudModifier: {
      ...
      permission:
        'Autorisez Moor dans Réglages Système → Confidentialité et sécurité → Surveillance de l’entrée, puis réessayez. Ce geste n’enregistre pas les frappes et ne capture pas votre écran.',
      unavailable:
        'L’assistant du geste HUD n’a pas pu démarrer ou s’est arrêté de manière inattendue. Réessayez ou redémarrez Moor. Le raccourci HUD existant fonctionne toujours dans Moor.',
      missingHelper:
        'Il manque l’assistant du geste HUD dans cette installation de Moor. Mettez à jour ou réinstallez Moor, puis réessayez.',
      unsupportedSession:
    ...
    screenshot: {
      ...
      enabledDesc:
        "Appuyez simultanément sur les deux touches Commande depuis n'importe quelle application pour capturer sa fenêtre au premier plan et la joindre au brouillon Moor actuel. Rien n'est envoyé automatiquement. Désactivé par défaut et limité à ce Mac. Le contenu peut être sensible : vérifiez la pièce jointe avant l'envoi.",
      ...
      inputPermission:
        "L'autorisation Surveillance de l'entrée permet à Moor de détecter les deux touches Commande lorsqu'une autre application est active. Autorisez Moor dans Réglages Système → Confidentialité et sécurité → Surveillance de l'entrée, puis réessayez.",
      screenPermission:
        "L'autorisation Enregistrement de l'écran permet à Moor de capturer la fenêtre au premier plan. Autorisez Moor dans Réglages Système → Confidentialité et sécurité → Enregistrement de l'écran, puis réessayez. Redémarrez Moor si macOS le demande.",
    ...
    quickEntry: {
      ...
      enabledDesc:
        "Faites apparaître un petit compositeur depuis n'importe où avec un raccourci global et envoyez une invite sans ouvrir Moor.",
    ...
    connections: {
      title: 'Connexions',
      intro:
        'Enregistrez tous les emplacements où vivent vos agents : cet appareil, les gateways distantes de votre réseau et les instances Moor Cloud. Ils sont tous conservés ici.',
      stagedNote:
      ...
      updateSkippedCloud: 'Gérée par Moor Cloud',
      kindLocal: 'Locale',
      kindRemote: 'Gateway distante',
      kindCloud: 'Moor Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: "L'environnement Moor géré par cette application.",
      kindRemoteDesc: 'Une gateway Moor accessible en HTTP(S), par le LAN, Tailscale ou Internet.',
      kindCloudDesc: 'Une instance hébergée découverte via votre compte Moor Cloud.',
      kindSshDesc: 'Une installation Moor accessible en SSH.',
      labelTitle: 'Nom',
      labelDesc:
      ...
      headersDesc:
        "Envoyés avec chaque requête HTTP et WebSocket vers ce gateway, notamment pour les proxys d'accès comme Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Les valeurs sont stockées chiffrées. Les en-têtes gérés par Moor (Authorization, Cookie, Host…) sont ignorés.",
      ...
      cloudAddHint:
        "Astuce : connectez-vous à Moor Cloud ci-dessus pour découvrir automatiquement vos agents — utilisez ce formulaire uniquement pour enregistrer manuellement l'URL d'une instance connue.",
    ...
    gateway: {
      ...
      intro:
        'Local par défaut. Utilisez distant quand cette application doit piloter un backend Moor ailleurs. Remplacements par profil ci-dessous.',
      envOverrideTitle: "Des variables d'environnement contrôlent cette session desktop.",
      envOverrideDesc:
        'Supprimez les variables MOOR_DESKTOP_REMOTE_URL et MOOR_DESKTOP_REMOTE_TOKEN pour utiliser le paramètre enregistré ci-dessous.',
      modeTitle: 'Mode de connexion',
      localTitle: 'Gateway local',
      localDesc:
        "Démarrer un backend Moor privé sur localhost. C'est la valeur par défaut et cela fonctionne hors ligne.",
      remoteTitle: 'Gateway distant',
      remoteDesc: 'Connecter ce shell desktop à un backend Moor distant.',
      remoteAuthHint:
      ...
      cloudDesc:
        "Connectez-vous une fois à Moor Cloud et choisissez parmi les agents de votre compte — pas d'URL à coller.",
      cloudSignInTitle: 'Moor Cloud',
      cloudSignIn: 'Se connecter à Moor Cloud',
      cloudSignedIn: 'Connecté à Moor Cloud',
      cloudNeedsSignIn: 'Connectez-vous à Moor Cloud pour découvrir les agents de votre compte.',
      cloudSignedInDesc:
      ...
      cloudDiscoverFailed: 'Impossible de charger vos agents Moor Cloud',
      cloudConnectFailed: 'Impossible de se connecter à cet agent',
      cloudSignInFailed: 'Échec de la connexion à Moor Cloud',
      cloudSignedOutTitle: 'Déconnecté de Moor Cloud',
      cloudSignedOutMessage: 'Session Moor Cloud effacée.',
      ...
      remoteUrlDesc:
        'URL de base du backend de tableau de bord distant. Les préfixes de chemin sont pris en charge, par exemple /moor.',
      ...
      restartingMessage: 'Moor Desktop va se reconnecter avec les paramètres enregistrés — le shell reste ouvert.',
      savedMessage: 'Enregistré pour le prochain redémarrage.',
      connectedTo: (baseUrl, version) => `Connecté à ${baseUrl}${version ? ` · Moor ${version}` : ''}`,
      ...
      sshDesc:
        "Moor est lancé sur la machine distante via SSH et acheminé vers cette application — rien à démarrer ou exposer soi-même. Nécessite un accès SSH par clé fonctionnel vers l'hôte.",
      sshTrustHint:
      ...
      sshMoorPathTitle: 'Chemin Moor (facultatif)',
      sshMoorPathDesc: 'Chemin complet vers le binaire moor distant. Vide = détection automatique.',
      sshMoorPathPlaceholder: 'détection automatique',
      ...
      sshReachable: (host, platform) => `Accessible : ${host} (${platform}) — Moor trouvé`,
      ...
      sshErrAuth:
        "Échec de l'authentification SSH. Chargez votre clé dans ssh-agent (ssh-add) ou définissez un IdentityFile dans ~/.ssh/config — Moor exécute ssh de manière non interactive.",
      sshErrHostKey:
      ...
      sshErrNotInstalled:
        "Moor n'est pas installé sur l'hôte distant. Installez-le là-bas (curl -fsSL https://hermes-agent.nousresearch.com/install.sh | sh) ou définissez le chemin Moor.",
      sshErrPlatform:
        'Plateforme distante non prise en charge. Le mode SSH de Moor Desktop supporte les hôtes distants Linux, macOS et Windows.',
      sshErrTimeout: "Expiration de la connexion SSH. L'hôte peut être inaccessible ou en veille.",
      sshErrUpdateRequired: "Mettez à jour Moor sur l'hôte distant avant de vous connecter avec Desktop SSH.",
    ...
    mcp: {
      ...
      deepLinkDescription:
        "Un lien demande d'ajouter ce serveur MCP à Moor. Vérifiez attentivement la configuration ci-dessous : elle provient du lien, pas de Moor.",
    ...
    localModels: {
      ...
      runtimeInstalledDetail: (tag, backend) =>
        `Build ${tag}, backend ${backend}. Moor démarre et gère le serveur pour vous.`,
      ...
      upToDateDetail: (tag, backend) =>
        `llama.cpp ${tag} (${backend}) est en cours d'exécution : il s'agit de la dernière build fournie par Moor.`,
      activeDetail:
    ...
    billing: {
      ...
      freeTier: {
        signIn: 'Se connecter',
        title: 'Vous utilisez l’offre gratuite Moor',
        message: 'Connectez-vous avec un compte Moor pour débloquer davantage de modèles et d’outils.',
        caption:
          'Fonctionne avec moor/welcome, connecteurs inclus. La connexion conserve vos connecteurs et ajoute les outils qui nécessitent un compte ainsi que tous les autres modèles.',
        name: 'Moor · offre gratuite',
        footnote:
          'L’offre gratuite n’a ni solde ni rien à payer. Le paiement et l’utilisation apparaissent une fois connecté avec un compte Moor.',
        plan: 'Offre gratuite',
        model: 'Modèle',
      ...
      state: {
        notice: {
          loggedOut: {
            title: 'Connectez votre compte Moor',
            message:
              'Connectez-vous avec votre compte Moor pour voir ici votre solde, votre offre et votre utilisation.',
            action: 'Se connecter'
          },
          openPortal: 'Ouvrir le portail ↗',
          noCard: {
      ...
      errors: {
        ...
        cliBillingDisabled: {
          ...
          message:
            'Les dépenses à distance sont désactivées pour ce compte — un administrateur de facturation peut les activer depuis la page Moor Agent du portail.'
        },
        roleRequired: {
    ...
    providers: {
      ...
      intro:
        "Connectez-vous avec un abonnement — pas de clé API à copier. Moor lance la connexion navigateur pour vous, directement dans l'application.",
      connected: 'Connecté',
      collapse: 'Réduire',
      ...
      localEndpoint: {
        ...
        description:
          "Pointez Moor vers n'importe quel point de terminaison compatible OpenAI (Zyphra, vLLM, llama.cpp, Ollama, etc)."
      },
    ...
    toolsets: {
      ...
      nousIncluded: 'Inclus avec un abonnement Moor — connectez-vous au portail Moor pour activer.',
      nousAuthNeededTitle: 'Se connecter au portail Moor',
      nousAuthNeededMessage: provider =>
        `${provider} est enregistré mais ne s'activera pas tant que vous ne vous serez pas connecté au portail Moor.`,
      nousAuthSignIn: 'Se connecter',
      nousAuthDoneTitle: 'Portail Moor connecté',
      nousAuthDoneMessage: "Vos backends d'abonnement sont maintenant actifs.",
      nousAuthFailed: "La connexion au portail Moor n'a pas été terminée",
      ...
      terminalBackend: {
        ...
        unavailableMessage: backend =>
          `Moor ne peut pas exécuter de commandes shell pour le moment : ${backend} n'est pas prêt. Passez en Local ou terminez la configuration de ${backend}, puis réessayez.`,
      ...
      browserRealProfile: {
        ...
        prompt: {
          ...
          body: "Autorisez Moor à naviguer avec un instantané de votre profil de navigateur par défaut afin que les sites s'ouvrent avec vos sessions déjà connectées.",
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restaurable via moor curator restore.',
    tabPlugins: 'Plugins',
    plugins: {
      ...
      defaultProfile: 'Moor (par défaut)',
      kindAgent: 'Agent',
      kindDesktop: 'Desktop',
      ...
      legacyBackend: 'Ce backend est trop ancien pour gérer les plugins depuis cet écran ; mettez Moor à jour.',
      ...
      catalogProvenance: (sha: string) =>
        `Installé depuis le catalogue Moor${sha ? ` au commit épinglé ${sha}` : ''}.`,
      ...
      deepLinkCatalogUnknown: (name: string) =>
        `\u00AB\u00A0${name}\u00A0\u00BB ne figure pas dans le catalogue de plugins Moor. Rien n’a été installé.`,
      deepLinkCatalogUnavailable:
        'Impossible de charger le catalogue de plugins Moor. Vérifiez votre connexion et rouvrez le lien.',
  ...
  starmap: {
    ...
    emptyDesc:
      'Au fur et à mesure que Moor construit des skills et des mémoires pour votre travail, ils apparaissent ici.',
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Redémarrez Moor pour utiliser les animaux — le backend précède cette fonctionnalité.',
    ...
    generatePet: {
      ...
      staleBackend: 'Mettez à jour Moor pour générer des animaux…',
      backgroundHint: "Vous pouvez fermer — Moor vous notifiera quand c'est terminé.",
    ...
    nav: {
      ...
      settings: {
        title: 'Paramètres',
        detail: 'Configurer Moor Desktop'
      },
      capabilities: {
        title: 'Capacités',
    ...
    moorActiveSessions: (version, count) => `Moor ${version} · Sessions actives ${count}`,
  ...
  messaging: {
    ...
    telegramQr: {
      ...
      subtitle:
        "Les deux méthodes connectent un bot que vous contrôlez et enregistrent ses identifiants uniquement dans cette installation d'Moor.",
      quickSetup: 'Configuration rapide',
      recommended: 'Recommandé',
      quickHelp:
        "Scannez un code QR et confirmez dans Telegram. Moor crée le bot et détecte automatiquement votre identifiant d'utilisateur Telegram.",
  ...
  profiles: {
    ...
    connectGateway: 'Connecter un autre gateway Moor…',
    fleet: {
      ...
      localDevice: 'Cet appareil (backend local — installe Moor s’il manque, sinon ouvre une nouvelle session)',
      ...
      installDeviceDesc:
        'Moor sera installé localement, puis une nouvelle session s’ouvrira sur cet ordinateur. Rien n’est installé tant que vous ne confirmez pas.',
    ...
    remoteOverride: {
      ...
      description:
        "Les sessions de ce profil s'exécuteront sur le système Moor distant indiqué, plutôt que sur cet ordinateur.",
      urlLabel: 'Adresse distante',
      urlPlaceholder: 'https://moor.exemple.fr',
    ...
    defaultDescription:
      "Utilisé à l'ouverture de Moor et pour les nouvelles conversations. Les sessions existantes restent dans leur profil.",
    ...
    deleting: 'Suppression...',
    createDesc: 'Les profils sont des environnements Moor indépendants : configuration, skills et SOUL.md séparés.',
    nameLabel: 'Nom',
  ...
  modelAssignment: {
    saveFailed: 'Moor n’a pas enregistré ce changement de modèle.',
  ...
  cron: {
    ...
    emptyDescNew:
      "Planifiez une invite à exécuter selon une expression cron. Moor l'exécutera et livrera les résultats vers la destination de votre choix.",
  ...
  sidebar: {
    ...
    storageCorrupt: {
      ...
      body: (profiles: string) =>
        `Moor ne peut pas lire tout l’historique des sessions de ${profiles}. Les conversations absentes de cette liste n’ont pas été supprimées ; le fichier qui les contient est endommagé.`,
      action: 'Quittez Moor sur ce profil, puis inspectez le fichier sans le modifier, ou restaurez un instantané :',
    ...
    projects: {
      ...
      staleBackend:
        'Mettez à jour le backend Moor pour créer des projets — votre backend est plus ancien que cette application de bureau (Paramètres → Mises à jour → Backend).',
      deleteConfirm:
        'Cela supprime le projet enregistré de Moor. Les fichiers, dépôts git et worktrees restent inchangés.',
      ...
      worktreeStaleBackend:
        'Mettez à jour le backend Moor pour créer des worktrees depuis Desktop — votre backend est plus ancien que cette application (Paramètres → Mises à jour → Backend).',
  ...
  composer: {
    ...
    placeholderStarting: 'Démarrage de Moor…',
    placeholderReconnecting: 'Reconnexion à Moor…',
    placeholderFollowUp: 'Envoyer un suivi',
    newSessionPlaceholders: [
      'Sur quoi travaillons-moor ?',
      'Donnez une tâche à Moor',
    ...
    voiceEngineChained: 'Reconnaissance vocale + voix Moor',
    voiceEngineLive: 'GPT-Live (duplex intégral, délègue à Moor)',
    ...
    commandDescs: {
      ...
      '/goal':
        'Définir un objectif permanent sur lequel Moor travaille au fil des tours jusqu’à ce qu’il soit atteint',
      ...
      '/plan': 'Écrire un plan d’implémentation markdown dans .moor/plans/ sans rien exécuter',
      ...
      '/profile': 'Changer de profil Moor actif',
      ...
      '/subscription': 'Voir votre forfait Moor et le modifier dans le navigateur',
      '/topup': 'Afficher votre solde Moor et gérer la facturation sur le portail',
      '/platform': 'Suspendre, reprendre ou lister une plateforme de gateway en échec',
      '/version': 'Afficher la version de Moor Agent',
    ...
    attachUrlDesc: "Moor récupérera la page et l'inclura comme contexte pour ce tour.",
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: "Demander à Moor d'ouvrir une PR",
  ...
  updates: {
    discontinuedTitle: "Cette version de Moor n'est plus prise en charge",
    discontinuedBody: "Cette version de Moor n'est plus prise en charge et risque de ne plus fonctionner — désinstallez-la. Vos données restent sur le disque.",
    ...
    availableBodyAppInstaller: "Une nouvelle version de Moor est prête. Moor va se fermer, Windows terminera la mise à jour, puis Moor rouvrira automatiquement.",
    applyingBodyAppInstaller: "Moor va se fermer et Windows terminera la mise à jour. Moor rouvrira ensuite automatiquement — vous n'avez rien à faire.",
    applyingCloseAppInstaller: 'Cette fenêtre va se fermer, Windows terminera la mise à jour et Moor rouvrira automatiquement.',
    checkUnknownTitleAppInstaller: 'Impossible de vérifier les mises à jour',
    checkUnknownBodyAppInstaller: "Windows n'a pas pu rechercher les mises à jour. Elles s'installent également automatiquement au redémarrage de Moor.",
    ...
    versionDetailsDistributionSourceInstallerDesktop: "Code source (script d'installation) + moor desktop",
    versionDetailsDistributionSource: 'Code source',
    versionDetailsDistributionSourceDesktop: 'Code source + moor desktop',
    ...
    stages: {
      ...
      pull: 'Presque prêt…',
      pydeps: 'Finalisation…',
      update: 'Mise à jour de Moor…',
      rebuild: "Reconstruction de l'application de bureau…",
      restart: 'Redémarrage de Moor…',
    ...
    unsupportedMessage: "Cette version de Moor ne peut pas se mettre à jour depuis l'application.",
    connectionRetry: 'Vérifiez votre connexion et réessayez.',
    gitUnusable: 'Moor n’a pas pu exécuter Git sur cet ordinateur et n’a donc pas pu rechercher de mises à jour.',
    connectionSettings: 'Paramètres de connexion',
    ...
    availableBody: 'Une nouvelle version de Moor est prête à être installée.',
    availableTitleBackend: 'Mise à jour du backend disponible',
    availableBodyBackend: 'Une version plus récente du backend Moor connecté est prête à être installée.',
    ...
    manualBody:
      "Vous avez installé Moor depuis la ligne de commande, les mises à jour s'y effectuent donc aussi. Collez ceci dans votre terminal :",
    manualPickedUp: 'Moor prendra en compte la nouvelle version au prochain lancement.',
    guiSkewTitle: "Mettre à jour l'application de bureau",
    guiSkewBody:
      "Le backend a été mis à jour, mais ce package d'application de bureau ne l'a pas été. Mettez à jour ou réinstallez l'application de bureau Moor (votre AppImage / .deb / .rpm) pour qu'elle corresponde.",
    copy: 'Copier',
    copied: 'Copié',
    done: 'Terminé',
    applyingBody:
      'Le programme de mise à jour de Moor prend le relais dans sa propre fenêtre et rouvre Moor automatiquement une fois terminé. Ne rouvrez pas Moor vous-même pendant la mise à jour.',
    applyingBodyBackend:
      'Le backend distant applique la mise à jour et va redémarrer. Moor se reconnecte automatiquement à son retour.',
    applyingClose: 'Cette fenêtre se fermera pendant la mise à jour, puis Moor se rouvre seul.',
    errorTitle: 'Mise à jour non terminée',
    errorBody: "Pas de souci — rien n'a été perdu. Vous pouvez réessayer maintenant.",
    blockerTitle: 'Fermer les aperçus locaux pour mettre à jour Moor ?',
    blockerBody:
      'Moor doit arrêter ces aperçus locaux avant la mise à jour. Aucun de vos fichiers ne sera modifié ni supprimé.',
    foreignBlockerTitle: 'Fermez les autres processus pour mettre à jour Moor',
    foreignBlockerBody:
      "Moor ne peut pas fermer automatiquement ces processus en toute sécurité. Fermez l'application, le terminal ou le service qui possède chacun d'eux, puis relancez la mise à jour.",
    mixedBlockerBody:
      'Moor peut fermer les aperçus locaux ci-dessous. Les autres processus doivent être fermés manuellement avant de poursuivre la mise à jour.',
  ...
  handoffTour: {
    ...
    stayTitle: "Moor reste à portée d'un clic",
    stayText:
      'Passez au profil de configuration et ouvrez Bienvenue dans Moor lorsque vous avez besoin d’aide. La conversation y reste disponible.'
  },
  guidedGreeting: {
    line: "Salut, entrez ! Je suis Moor. Donnez-moi deux minutes pour préparer les lieux à votre façon, puis moor moor attaquerons à quelque chose que vous voulez vraiment accomplir.\n\nMais d'abord, comment dois-je vous appeler ?",
  ...
  install: {
    ...
    oneTimeTitle: 'Moor nécessite une installation unique',
    ...
    setupChoiceTitle: 'Configurer Moor Desktop',
    setupChoiceDesc:
      'Connectez cette application à un gateway Moor que vous exécutez déjà, ou installez Moor localement sur cet ordinateur.',
    connectExistingTitle: 'Se connecter à un Moor existant',
    ...
    installLocalTitle: 'Installer Moor localement',
    installLocalDesc: 'Téléchargez Moor, créez son environnement Python et exécutez le backend sur cet ordinateur.',
    localStartUnavailable: "L'installation locale n'a pas pu démarrer. Redémarrez Moor Desktop et réessayez.",
    remoteSetupTitle: 'Se connecter à un Moor existant',
    remoteSetupDesc:
      "Entrez l'URL du gateway. Moor Desktop détectera s'il a besoin d'un jeton ou d'une connexion par navigateur.",
    remoteUrlTitle: 'URL du gateway',
    remoteUrlDesc: "Utilisez l'URL de base du gateway Moor, y compris https:// pour les connexions distantes.",
    remoteUrlPlaceholder: 'https://gateway.example.com/moor',
    probing: "Détection de l'authentification du gateway...",
    probeError: "Impossible d'atteindre ce gateway Moor.",
    ...
    settingUpTitle: 'Configuration de Moor Agent',
    finishingTitle: 'Finalisation',
    failedDesc:
      "L'une des étapes d'installation a échoué. Sous Windows, cela peut arriver si une autre instance Moor CLI ou desktop est en cours d'exécution. Arrêtez toutes les instances Moor en cours, puis réessayez. Consultez les détails ci-dessous ou le journal du bureau pour la transcription complète.",
    activeDesc:
      "Il s'agit d'une configuration unique. Le programme d'installation de Moor télécharge les dépendances et configure votre machine. Les lancements suivants ignoreront cette étape.",
  ...
  onboarding: {
    headerTitle: 'Configurons Moor Agent pour vous',
    headerDesc:
      'Connectez un fournisseur de modèles pour commencer à discuter. La plupart des options nécessitent un clic.',
    preparingInstall:
      "Moor finalise l'installation. Cela prend généralement moins d'une minute au premier lancement.",
    starting: 'Démarrage de Moor…',
    ...
    recommended: 'Recommandé',
    connected: 'Connecté',
    featuredPitch: 'Un abonnement, 300+ modèles de pointe — la méthode recommandée pour exécuter Moor',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'auto-hébergé',
        description:
          'Pointez Moor vers un point de terminaison local ou auto-hébergé compatible OpenAI (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Ouvre une page de vérification dans votre navigateur — Moor se connecte automatiquement',
    ...
    signInWith: provider => `Se connecter avec ${provider}`,
    openedBrowser: provider => `Moor avons ouvert ${provider} dans votre navigateur.`,
    authorizeThere: 'Autorisez Moor là-bas.',
    ...
    autoBrowser: provider =>
      `Moor avons ouvert ${provider} dans votre navigateur. Autorisez Moor là-bas et vous serez connecté automatiquement — rien à copier ou coller.`,
    ...
    deviceCodeOpened: provider => `Moor avons ouvert ${provider} dans votre navigateur. Entrez ce code là-bas :`,
  ...
  freeTier: {
    providerRowTitle: 'Moor · offre gratuite',
    providerRowPitch: 'Connectez-vous avec un compte Moor pour débloquer davantage de modèles et outils.',
    readyTitle: 'Moor est prêt.',
    readyCaption: 'Gratuit · connecteurs inclus',
    begin: 'Commencer',
    signInInstead: 'Se connecter plutôt avec un compte Moor',
    otherProviders: 'Autres fournisseurs',
    stripTitle: "L'inférence Moor gratuite et les connecteurs sont maintenant disponibles.",
    stripBody: 'Ouvrez le sélecteur de modèle pour les essayer ou connectez-vous avec un compte Moor.',
    openModelPicker: 'Ouvrir le sélecteur de modèle',
    dismiss: 'Fermer',
    providerName: 'Moor',
    statusLabel: model => `Moor · ${model}`,
    signIn: 'Se connecter',
    signInHeading: 'Connectez-vous avec un compte Moor pour débloquer davantage de modèles et outils.',
    ...
    busyBody: wait =>
      `Moor n'a pas pu terminer votre connexion car le service Moor est occupé. Réessayez dans ${wait}. Votre session reste disponible entre-temps.`,
    unreachableBody:
      "Moor n'a pas pu joindre le service Moor pour terminer votre connexion. Vérifiez votre connexion Internet et réessayez. Votre session reste disponible.",
    alreadySignedInHeading: 'Déjà connecté.',
    alreadySignedInBody: 'Cette installation Moor est déjà connectée à un compte Moor.',
    setupFailed: {
      gateClosed:
        'Cette version de Moor ne peut pas démarrer sans compte Moor. Connectez-vous ou créez-en un gratuitement en une minute.',
      paused:
        "L'utilisation de Moor sans connexion est momentanément suspendue. Moor continuera à vérifier. La connexion est gratuite et vous permet de continuer immédiatement.",
      rateLimited: wait =>
        `Beaucoup de personnes démarrent en ce moment ; Moor réessaiera dans ${wait}. La connexion est gratuite et évite l'attente.`,
      unreachable:
        "Moor n'a pas pu joindre le service Moor. Vérifiez votre connexion Internet, puis appuyez sur Réessayer. Vous pouvez aussi connecter un autre fournisseur.",
      serverError:
        'Le service Moor a rencontré un problème. Réessayez dans un instant ou connectez un autre fournisseur.',
      powRequired:
        "Le serveur Moor a demandé une preuve de travail qui n'est pas encore gérée par votre Agent. Connectez-vous ou créez un compte Moor gratuit pour continuer.",
      locked:
        'Cette session ne peut pas continuer sans connexion. Connectez-vous ou créez un compte Moor gratuit pour poursuivre.',
      generic:
        "Moor n'a pas pu configurer l'accès gratuit sans connexion. Connectez-vous gratuitement ou choisissez un autre fournisseur.",
      signInBelow: 'La connexion est gratuite. Choisissez Moor ci-dessous.',
      tryAgain: 'Réessayer',
      retrying: 'Nouvelle tentative…'
    }
  },
  modelPicker: {
    ...
    pro: 'Pro',
    proNeedsSubscription: 'Les modèles Pro nécessitent un abonnement payant Moor.',
    free: 'Gratuit',
    freeTier: 'Gratuit',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} fait ${size}. Moor n'affichera que les 512 Ko premiers.`,
    ...
    web: {
      ...
      tryAgain: 'Réessayer',
      restarting: 'Moor redémarre...',
      askRestart: 'Demander à Moor de redémarrer le serveur',
      lookingRestart: taskId => `Moor recherche un serveur d'aperçu à redémarrer (${taskId})`,
      restartingTitle: "Redémarrage du serveur d'aperçu",
      restartingMessage: "Moor travaille en arrière-plan. Surveillez la console d'aperçu pour suivre la progression.",
      ...
      blankPageBody: "Saisissez une adresse ci-dessus pour naviguer, ou demandez à Moor d'ouvrir une page.",
      finishedRestarting: message =>
        `Moor a terminé le redémarrage du serveur d'aperçu${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: "Moor n'a pas pu redémarrer le serveur.",
      stillWorking:
        "Moor travaille toujours, mais aucun résultat de redémarrage n'est arrivé. La commande du serveur peut être en cours d'exécution au premier plan.",
  ...
  interfaceMode: {
    ...
    hint: 'Modifie ce qui est affiché, pas ce que Moor peut faire.',
    sessionNote:
      'Défini par le mode Simple. Une modification ici dure le temps de cette session ; passez en mode Avancé pour la conserver.',
    simple: {
      label: 'Simple',
      description:
        'Pour discuter avec Moor. Barre latérale et conversation ; pas de panneaux terminal, fichiers ou diff.'
    },
    advanced: {
      label: 'Avancé',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Moor charge une réponse',
      ...
      errorLayerBodies: {
        ...
        disk: "Votre disque est plein ; Moor n'a pas pu enregistrer cette conversation. Libérez de l'espace, puis réessayez.",
        endpoint:
          "Moor ne parvient pas à joindre votre serveur de modèle personnalisé. Vérifiez qu'il fonctionne, puis renvoyez votre message.",
        gateway:
          'Moor a rencontré un problème interne au démarrage de cette réponse. Renvoyez votre message ; si cela persiste, envoyez les diagnostics.',
        generic:
          "Une erreur s'est produite pendant la réponse de Moor. Réessayez ou copiez les détails si cela persiste.",
        provider:
      ...
      errorCodes: {
        ...
        ssl_cert_verification: {
          ...
          body: provider =>
            `Moor n'a pas pu vérifier la connexion sécurisée à ${provider}. Vérifiez votre réseau ou votre proxy, ou changez de fournisseur.`
        },
        context_overflow: {
        ...
        invalid_response: {
          ...
          body: provider => `${provider} a renvoyé une réponse que Moor n'a pas pu lire. Réessayez dans un instant.`
        },
        empty_response: {
        ...
        loop_error: {
          title: 'Moor est resté bloqué dans une boucle',
          body: 'La réponse répétait les mêmes étapes ; Moor l’a donc arrêtée. Réessayez ou démarrez une nouvelle conversation.'
        },
        SESSION_NOT_OWNED: {
          title: 'Cette conversation est ouverte ailleurs',
          body: 'Cette conversation est déjà ouverte dans une autre fenêtre Moor ou un terminal. Fermez-la là-bas puis réessayez, ou démarrez-en une nouvelle ici.'
        },
        disk_full: {
          title: 'Disque plein',
          body: "Votre disque est plein ; Moor n'a pas pu enregistrer cette conversation. Libérez de l'espace puis réessayez."
        },
        free_tier_disabled: {
          title: "L'utilisation de Moor sans connexion est désactivée pour le moment",
          body: 'Connectez-vous avec un compte Moor gratuit pour continuer.'
        },
        free_tier_rate_limited: {
          title: 'Vous avez épuisé le quota sans connexion',
          body: 'Il sera bientôt renouvelé. Connectez-vous avec un compte Moor gratuit pour obtenir un quota plus élevé.'
        },
        ...
        free_tier_model_not_free: {
          ...
          body: 'Moor utilise le modèle gratuit pour le moment. Connectez-vous avec un compte Moor gratuit pour accéder à plus de modèles.'
        },
        free_tier_route: {
          title: "Moor n'a pas pu joindre le modèle gratuit par cette route",
          body: 'Connectez-vous avec un compte Moor gratuit ou vérifiez le paramètre MOOR_INFERENCE_BASE_URL.'
        },
        free_tier_outage: {
        ...
        free_tier_refused: {
          title: "Moor n'a pas pu envoyer ce message sans connexion",
          body: 'La connexion avec un compte Moor est gratuite.'
        }
      },
      errorAuthKinds: {
        api_key: {
      ...
      errorToastTitle: "Moor n'a pas pu terminer la réponse",
      ...
      errorOpenMoorFolder: 'Ouvrir le dossier Moor',
      errorOpenMoorFolderFailed: "Impossible d'ouvrir le dossier Moor",
      errorUpdateApiKey: 'Mettre à jour la clé API',
      errorSignInAgain: provider => `Se reconnecter à ${provider}`,
      errorSignInFreeTier: 'Se connecter avec un compte Moor',
    ...
    approval: {
      gatewayDisconnected: "La Gateway Moor n'est pas connectée",
      sendFailed: "Impossible d'envoyer la réponse d'approbation",
      reconnect: 'Se reconnecter',
      timedOutSystemLine:
        "Le délai d'approbation a expiré — la commande n'a pas été exécutée. Demandez à Moor de réessayer ou augmentez la limite dans Paramètres → Sécurité → Délai d'approbation.",
      ...
      alwaysDescription: pattern =>
        `Cela ajoute le motif « ${pattern} » à votre liste d'autorisation permanente (~/.moor/config.yaml). Moor ne redemandera plus pour ce type de commande — que ce soit dans cette session ou dans une session future.`,
  ...
  prompts: {
    ...
    sudoDesc:
      "Moor a besoin de votre mot de passe sudo pour exécuter une commande privilégiée. Il n'est envoyé qu'à votre agent local.",
    ...
    sudoInstallDesc:
      'Moor a besoin de votre mot de passe sudo pour installer les paquets de Bot Screen (TigerVNC + Xfce) sur l’hôte du gateway. Il n’est envoyé qu’à cet hôte.',
    sudoPlaceholder: 'mot de passe sudo',
    secretTitle: 'Secret requis',
    secretDesc: "Moor a besoin d'un identifiant pour continuer.",
    ...
    vaultSaveDesc: origin =>
      `Moor a atteint une page de connexion sur ${origin} et ne possède aucun identifiant pour celle-ci. Saisissez-le une fois ici : il sera chiffré sur cet ordinateur et rempli dans la page sans que le modèle voie le mot de passe.`,
    ...
    vaultCodeDesc: site =>
      `${site} demande un code à usage unique reçu par SMS, e-mail ou application d'authentification. Saisissez-le ici : Moor le remplira dans la page sans que le modèle le voie.`,
    vaultCodeLabel: 'Code',
    vaultCodeFootnote:
      "Astuce : enregistrez la clé d'authentification avec cet identifiant dans Paramètres → Mots de passe et identifiants ; Moor saisira alors les codes pour vous.",
  ...
  desktop: {
    ...
    restartToUseSaveImage: "Redémarrez Moor Desktop pour utiliser Enregistrer l'image.",
    restartToSaveImages: 'Redémarrez Moor Desktop pour enregistrer les images',
    ...
    handoff: {
      ...
      timedOut: "Délai d'expiration en attendant la Gateway. `moor gateway` est-il en cours d'exécution ?",
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        ...
        text: "Les compétences sont des dossiers d'instructions que Moor charge lorsque le travail le nécessite."
      },
      messaging: {
        title: 'Moor loin de votre bureau',
        text: 'Connectez Telegram, Discord, Slack et plus encore : même agent, même mémoire.'
      },
      artifacts: {
        title: 'Tout ce que Moor a créé',
      ...
      profiles: {
        ...
        text: 'Chacun possède son propre Moor, avec ses clés, sa mémoire et ses sessions.'
      },
      'composer-mentions': {
