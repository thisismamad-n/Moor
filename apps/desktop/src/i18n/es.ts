...
export const esOverrides = {
  ...
  connectors: {
    ...
    disclaimer: 'Conectar es opcional. Autoriza solo las apps que quieras que use Moor.',
  ...
  connectorsPage: {
    ...
    card: {
      ...
      inCatalog: 'En el catálogo de Moor',
    ...
    page: {
      ...
      noMatchBody: 'No hay coincidencias. Indica a Moor tu propio servidor MCP para añadirlo.',
      ...
      signInLine: 'Inicia sesión en Moor para usar las apps administradas.',
      ...
      disconnectNoAccount:
        'Moor no tiene ninguna cuenta que desconectar aquí. Actualiza la página e inténtalo de nuevo.',
      disconnectRefused:
        'Moor no pudo quitar este inicio de sesión ahora. Desactiva la app con el interruptor o inténtalo más tarde.'
    },
    add: {
    ...
    dialog: {
      ...
      disconnectBody: 'Moor deja de actuar con esta cuenta. Puedes volver a conectarla cuando quieras.',
      ...
      appSwitch: (name: string) => `Moor puede usar ${name}`,
      ...
      bothOn: (name: string) => `Ambos están activados, así que Moor ve cada herramienta de ${name} dos veces.`,
      ...
      nousLine: 'Las apps de Moor siguen a tu cuenta, no al perfil.',
      rulesReadOnly: 'Las reglas no se pueden cambiar ahora.',
      rulesAppOff: (name: string) => `Activa ${name} para cambiar sus herramientas.`,
      rulesSignIn: 'Inicia sesión para cambiar lo que Moor puede hacer aquí.',
    ...
    tools: {
      ...
      summaryTitle: (name: string) => `Lo que Moor puede hacer con ${name}`,
      summaryPreviewTitle: (name: string) => `Lo que Moor podría hacer con ${name} cuando lo conectes`,
      ...
      goneBody: 'Moor ya no puede llamarlo. La fila se queda hasta que la quites, así que nada desaparece.',
      remove: 'Quitar',
      ...
      signedOutTitle: 'Inicia sesión en Moor para leer la lista de herramientas.',
  ...
  sessionImport: {
    ...
    subtitle: 'Trae una conversación a Moor y retómala donde la dejaste.',
    ...
    chooseHelp: 'Elige una sesión para leer su historial antes de traerla a Moor.',
    ...
    you: 'Tú',
    snapshot: 'Esta conversación ya está en Moor. Abre tu copia existente para continuar.',
    copyNotice:
  ...
  boot: {
    ...
    steps: {
      ...
      loadingSettings: 'Cargando la configuración de Moor',
      loadingSessions: 'Cargando sesiones recientes',
      retryingRemoteBackend: 'Reconectando al backend remoto de Moor…',
      startingDesktopConnection: 'Iniciando la conexión de escritorio',
      startingMoorDesktop: 'Iniciando Moor Desktop…'
    },
    errors: {
      backgroundExited:
      ...
      backgroundExitedDuringStartup: 'Moor se detuvo justo después de iniciarse.',
      backendStopped: 'Moor dejó de funcionar en segundo plano',
      restartMoor: 'Reiniciar Moor',
      openLogs: 'Abrir registros',
      desktopBootFailed: 'Moor no pudo iniciarse',
      gatewayConnectionLost: 'Moor perdió la conexión',
      ...
      gatewaySignInRequired: 'Tu Moor remoto cerró tu sesión',
      ...
      ipcBridgeUnavailable: 'Moor Desktop no pudo comunicarse con su propia capa en segundo plano. Reinicia la app.'
    },
    causes: {
      exitedEarly: 'El servicio en segundo plano de Moor se detuvo justo después de iniciarse.',
      timedOut: 'El servicio en segundo plano de Moor no respondió a tiempo.',
      permission: 'Moor no pudo escribir en su carpeta de datos (problema de permisos).',
      diskFull: 'El disco está lleno, así que Moor no pudo iniciarse.',
      portInUse: 'Otro programa está usando el puerto de red que necesita Moor.',
      installMissing: 'Falta parte de la instalación de Moor. Elige Reparar instalación para restaurarla.'
    },
    failure: {
      title: 'Moor no pudo iniciarse',
      description:
        'El servicio en segundo plano de Moor no arrancó. Prueba uno de los pasos de recuperación de abajo. Nada de esto elimina tus chats ni tus ajustes.',
      details: 'Detalles',
      ...
      cloudDownTitle: 'El agente de Moor Cloud no está disponible',
      cloudDownDescription:
        'El agente en la nube administrado por Moor al que se conecta este gateway devuelve un error de servidor. No se puede reiniciar desde aquí: revisa su estado, cambia al gateway local o pide ayuda.',
      cloudDownHint:
        'Los botones de abajo abren el Moor Portal (estado y controles de la instancia) y nuestro Discord para obtener ayuda.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Tu backend de Moor es más antiguo que esta compilación de escritorio y puede no funcionar correctamente. Actualízalo para alinearlos.',
    installMethodUnsupportedTitle: 'Método de instalación no compatible',
    updateMoor: 'Actualizar Moor',
    ...
    errors: {
      ...
      storageFailure: 'Moor no pudo guardar en su carpeta de datos. Abre Mantenimiento para comprobarla y repararla.',
      gatewayAuthFailed:
        'Este Moor ya no acepta tu inicio de sesión guardado. Abre Gateways y vuelve a iniciar sesión (o pega un nuevo token de acceso) e inténtalo otra vez.',
      methodNotAllowed:
        'El servicio en segundo plano de Moor no está sincronizado con la app, probablemente tras una actualización. Reinícialo para solucionarlo.',
      ...
      codeSkewRestartRequired:
        'Moor se actualizó, pero sigue ejecutando la versión anterior. Reinícialo para terminar la actualización.',
      rpcOutOfSync: 'La app y el backend están en versiones distintas. Actualiza ambos.',
      restartMoorFailed: 'No se pudo reiniciar Moor'
    },
    actions: {
      restartMoor: 'Reiniciar Moor',
    ...
    voice: {
      ...
      liveDelegationFailed: 'No se pudo pasar la solicitud a Moor',
    ...
    native: {
      ...
      inputBody: 'Moor espera tu respuesta.',
      turnDoneTitle: 'Moor terminó',
      turnDoneBody: '',
  ...
  billingBlock: {
    titleMoor: 'Sin créditos de Moor',
  ...
  sendDiagnostics: {
    ...
    failedHint:
      'También puedes ejecutar `moor debug share --moor` desde una terminal, o `moor debug share --local` para mostrar el informe sin subirlo.',
    handoffLead: 'Continúa la conversación en:',
    links: {
      github: 'Issues de GitHub',
      portal: 'Soporte de Moor Portal',
      discord: 'Discord'
    }
  },
  titlebar: {
  ...
  settings: {
    ...
    resetConfirm: '¿Restablecer toda la configuración a los valores predeterminados de Moor?',
    ...
    plugins: {
      ...
      installModal: {
        ...
        catalogPinned: (name, sha) =>
          `Entrada del catálogo de Moor “${name}”: el componente del agente se instala en la versión fijada revisada${sha ? ` ${sha}` : ''}, no en la punta de la rama.`,
        ...
        installUncertain:
          'Moor dejó de esperar el resultado de la instalación, pero es posible que el plugin siga instalándose. Cierra este cuadro y actualiza la lista de plugins antes de volver a instalarlo.',
    ...
    vault: {
      ...
      otpHint:
        'La “clave de configuración” que muestra el sitio al activar la 2FA. Si la guardas, Moor genera los códigos por sí mismo.',
      ...
      sources: {
        ...
        notInstalled: name =>
          `No detectado. Instala la herramienta de línea de comandos de ${name} e inicia sesión en ella; Moor la detectará automáticamente.`,
        disabledDesc: 'Detectado, pero desactivado para Moor.',
        lockedDesc:
          'Detectado. El agente te pedirá desbloquearlo cuando necesite un inicio de sesión, o puedes desbloquearlo ahora.',
        unlockedDesc:
          'Desbloqueado para esta sesión. Se bloquea automáticamente tras 30 minutos de inactividad o al cerrar Moor.',
    ...
    notifications: {
      ...
      focusedHint: 'Los avisos de finalización solo se activan cuando Moor está en segundo plano.',
      kinds: {
        approval: {
        ...
        input: {
          ...
          description: 'Moor hizo una pregunta o necesita una contraseña o un secreto.'
        },
        turnDone: {
          label: 'Respuesta lista',
          description: 'Terminó un turno mientras Moor estaba en segundo plano.'
        },
        turnError: {
        ...
        plugin: {
          ...
          description: 'Un complemento de escritorio envió una notificación mientras Moor estaba en segundo plano.'
        }
      },
    ...
    appearance: {
      ...
      colorModeDesc: 'Elige un modo fijo o deja que Moor siga la configuración del sistema.',
      ...
      reactionsDesc:
        'Reacciones emoji estilo iMessage — reacciona a los mensajes, y Moor puede reaccionar a los tuyos.',
      tipsTitle: 'Consejos en la app',
      tipsDesc:
        'Sugerencias ocasionales de la app y de Moor. Cada consejo aparece una vez. Se desactiva automáticamente tras tus primeros 30 días; puedes volver a activarlo.',
      tipsReset: (count: number) => `Volver a mostrar ${count} ${count === 1 ? 'consejo' : 'consejos'}`,
      toursTitle: 'Recorridos guiados',
      toursDesc:
        'Deja que Moor resalte cada paso mientras te guía por la app. Se desactiva automáticamente tras tus primeros 30 días; puedes volver a activarlo.',
      ...
      pet: {
        title: 'Mascota',
        intro:
          'Adopta una mascota animada de petdex que flota sobre la app y reacciona a lo que hace Moor: corre mientras se ejecutan herramientas, celebra los éxitos y se entristece con los errores.',
        restartHint:
          'Las mascotas necesitan un reinicio rápido: la aplicación en ejecución se inició antes de que se añadiera esta función. Cierra y vuelve a abrir Moor y luego vuelve aquí.',
        scaleTitle: 'Tamaño',
    ...
    fieldDescriptions: defineFieldCopy({
      ...
      fileReadMaxChars: 'Máximo de caracteres que Moor puede leer en una solicitud de archivo.',
      approvals: {
        mode: 'Cómo maneja Moor los comandos que necesitan aprobación explícita.',
      ...
      voice: {
        ...
        voiceChatMode:
          'chained: voz a texto → Moor → texto a voz con los proveedores de abajo. gpt-live: un modelo de voz full-duplex de OpenAI (gpt-live-1) escucha y habla, y pasa cada solicitud real a Moor; el modelo que hayas seleccionado responde con todas las herramientas. Requiere una clave API de OpenAI; la capa de voz cuesta 0,05 US$ por minuto.',
        gptLive: {
          voice: 'Voz del modo GPT-Live. Se aceptan ID de voz personalizados.',
          instructions:
            'Frases adicionales para la personalidad de voz en vivo (tono, ritmo, idioma). Moor mantiene su propio prompt de sistema.'
        }
      },
      tts: {
        xai: {
      ...
      updates: {
        nonInteractiveLocalChanges:
          'Cuando Moor se actualiza desde la app sin prompt de terminal, conserva los cambios locales de código fuente (stash) o descártalos. Las actualizaciones desde terminal siempre preguntan.'
      }
    }),
    uninstallSection: {
      dangerZone: 'Zona de peligro',
      checkingInstalled: 'Comprobando lo que está instalado…',
      uninstallMoor: 'Desinstalar Moor',
      chooseHowMuch:
      ...
      options: {
        gui: {
          ...
          description: 'Quita esta app de escritorio. El agente de Moor, tu configuración y tus chats se conservan.',
        ...
        lite: {
          ...
          description:
            'Quita la app y el agente de Moor, pero conserva la configuración, los chats y los secretos para una futura reinstalación.',
          consequence:
            'la interfaz de chat y el agente de Moor (se conservan la configuración, los chats y los secretos)'
        },
        full: {
          ...
          consequence:
            'TODO: la interfaz de chat, el agente de Moor y toda tu configuración, chats, secretos y registros'
        }
      }
    },
    poolLimits: {
    ...
    config: {
      ...
      minimizeToTrayDesc:
        'Al minimizar las ventanas o cerrar la ventana principal, se ocultan en la bandeja del sistema (barra de menús en macOS) y Moor sigue ejecutándose. Usa Salir de Moor en el menú de la bandeja o Cmd+Q para salir. Desactivado por defecto; se aplica solo a este dispositivo.',
      ...
      loading: 'Cargando configuración de Moor...',
    ...
    hudModifier: {
      ...
      permission:
        'Permite Moor en Ajustes del Sistema → Privacidad y seguridad → Monitorización de entrada y vuelve a intentarlo. Este gesto no registra pulsaciones de teclas ni captura tu pantalla.',
      unavailable:
        'El asistente del gesto del HUD no pudo iniciarse o se detuvo de forma inesperada. Reinténtalo o reinicia Moor. El atajo del HUD existente sigue funcionando dentro de Moor.',
      missingHelper:
        'A esta instalación de Moor le falta el asistente del gesto del HUD. Actualiza o reinstala Moor y vuelve a intentarlo.',
      unsupportedSession:
    ...
    screenshot: {
      ...
      enabledDesc:
        'Pulsa las dos teclas Comando a la vez desde cualquier app para capturar su ventana frontal y adjuntarla a tu borrador actual de Moor. Nunca se envía automáticamente. Desactivado por defecto; se aplica solo a este Mac. El contenido de la ventana puede ser confidencial: revisa el adjunto antes de enviarlo.',
      ...
      inputPermission:
        'El permiso de Monitorización de entrada permite a Moor detectar las dos teclas Comando mientras otra app está activa. Permite Moor en Ajustes del Sistema → Privacidad y seguridad → Monitorización de entrada, vuelve aquí y reinténtalo.',
      screenPermission:
        'El permiso de Grabación de pantalla permite a Moor capturar la ventana frontal cuando usas este atajo. Permite Moor en Ajustes del Sistema → Privacidad y seguridad → Grabación de pantalla, vuelve aquí y reinténtalo. Reinicia Moor si macOS te lo pide.',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Invoca un pequeño compositor desde cualquier lugar con un atajo global y envía un prompt sin abrir Moor.',
    ...
    connections: {
      ...
      intro:
        'Gestiona este dispositivo y cada gateway de Moor al que puede llegar mediante conexiones remotas, SSH o Cloud.',
      stagedNote:
      ...
      updateSkippedCloud: 'Administrado por Moor Cloud',
      kindLocal: 'Local',
      kindRemote: 'Gateway remoto',
      kindCloud: 'Moor Cloud',
      kindSsh: 'SSH',
      kindLocalDesc: 'El entorno de ejecución de Moor administrado por esta app.',
      kindRemoteDesc: 'Un gateway de Moor accesible por HTTP(S): LAN, Tailscale o internet.',
      kindCloudDesc: 'Una instancia alojada detectada a través de tu cuenta de Moor Cloud.',
      kindSshDesc: 'Una instalación de Moor accesible por SSH.',
      labelTitle: 'Nombre',
      labelDesc:
      ...
      headersDesc:
        'Se envían con cada solicitud HTTP y WebSocket a este gateway, para proxies de acceso como Cloudflare Access (CF-Access-Client-Id / CF-Access-Client-Secret). Los valores se guardan cifrados. Se ignoran los encabezados que gestiona Moor (Authorization, Cookie, Host…).',
      ...
      cloudAddHint:
        'Consejo: al iniciar sesión en Moor Cloud arriba, tus agentes se detectan automáticamente; usa este formulario solo para registrar a mano la URL de una instancia conocida.',
    ...
    gateway: {
      ...
      unavailableDesc:
        'Los ajustes de conexión solo se pueden cambiar desde la app Moor Desktop en el equipo que la ejecuta.',
      title: 'Conexión del gateway',
      envOverride: 'anulación de entorno',
      intro:
        'Local por predeterminado. Usa remoto cuando esta app deba controlar un backend de Moor en otro lugar. Anulaciones por perfil a continuación.',
      envOverrideTitle: 'Esta conexión quedó fijada por la forma en que se inició Moor.',
      envOverrideDesc:
        'Un ajuste de inicio externo a la app eligió esta conexión, así que las opciones de abajo son de solo lectura. Reinicia Moor sin ese ajuste (o pregunta a quien lo configuró) para cambiarla aquí.',
      modeTitle: 'Modo de conexión',
      localTitle: 'Gateway local',
      localDesc:
        'Inicia un backend privado de Moor en localhost. Es el valor predeterminado y funciona sin conexión.',
      remoteTitle: 'Gateway remoto',
      remoteDesc: 'Conecta esta shell de escritorio a un backend remoto de Moor.',
      remoteAuthHint:
      ...
      cloudDesc:
        'Inicia sesión una vez en Moor Cloud y elige uno de los agentes de tu cuenta; no tienes que pegar ninguna URL.',
      cloudSignInTitle: 'Moor Cloud',
      cloudSignIn: 'Iniciar sesión en Moor Cloud',
      cloudSignedIn: 'Sesión iniciada en Moor Cloud',
      cloudNeedsSignIn: 'Inicia sesión en Moor Cloud para descubrir los agentes de tu cuenta.',
      ...
      cloudDiscoverFailed: 'No se pudieron cargar tus agentes de Moor Cloud',
      cloudConnectFailed: 'No se pudo conectar con ese agente',
      cloudSignInFailed: 'Falló el inicio de sesión en Moor Cloud',
      cloudSignedOutTitle: 'Sesión cerrada en Moor Cloud',
      cloudSignedOutMessage: 'Se borró la sesión de Moor Cloud.',
      ...
      remoteUrlDesc: 'URL base del backend del dashboard remoto. Se admiten prefijos de ruta, por ejemplo /moor.',
      probing: 'Comprobando cómo se autentica este gateway…',
      probeError:
        'Moor no puede llegar a esa dirección. Comprueba la URL y que el otro equipo esté ejecutando Moor; las opciones de inicio de sesión aparecen cuando responde.',
      ...
      restartingMessage: 'Moor Desktop se reconectará con los ajustes guardados.',
      savedMessage: 'Guardado para el próximo reinicio.',
      connectedTo: (baseUrl, version) => `Conectado a ${baseUrl}${version ? ` · Moor ${version}` : ''}`,
      ...
      sshDesc:
        'Moor se inicia en el equipo remoto mediante SSH y se conecta a esta app a través de un túnel; no tienes que iniciar ni exponer nada por tu cuenta. Requiere acceso SSH mediante claves que ya funcione con el host.',
      sshTrustHint:
      ...
      sshMoorPathTitle: 'Ruta de Moor (opcional)',
      sshMoorPathDesc: 'Ruta completa al binario remoto de Moor. En blanco = detección automática.',
      sshMoorPathPlaceholder: 'detección automática',
      sshTestConnection: 'Probar SSH',
      sshConnect: 'Conectar',
      sshButtonsHint: 'Guardar se aplica en el próximo inicio. Conectar vuelve a conectar ahora.',
      sshReachable: (host, platform) => `Accesible: ${host} (${platform}) — se encontró Moor`,
      ...
      sshErrAuth:
        'Falló la autenticación SSH. Carga tu clave en ssh-agent (ssh-add) o configura un IdentityFile en ~/.ssh/config; Moor ejecuta SSH de forma no interactiva.',
      sshErrHostKey:
      ...
      sshErrNotInstalled:
        'Moor no está instalado en el host remoto. Instálalo allí (curl -fsSL https://hermes-agent.nousresearch.com/install.sh | sh) o indica la ruta de Moor.',
      sshErrPlatform:
        'Plataforma remota no compatible. El modo SSH de Moor Desktop admite hosts remotos Linux, macOS y Windows.',
      sshErrTimeout: 'La conexión SSH agotó el tiempo de espera. Es posible que el host no responda o esté en reposo.',
      sshErrUpdateRequired: 'Actualiza Moor en el host remoto antes de conectarte con Desktop SSH.',
    ...
    mcp: {
      ...
      deepLinkDescription:
        'Un enlace pidió añadir este servidor MCP a Moor. Revisa la configuración exacta de abajo: viene del enlace, no de Moor.',
    ...
    localModels: {
      ...
      runtimeInstalledDetail: (tag, backend) =>
        `Compilación ${tag}, backend ${backend}. Moor inicia y gestiona el servidor por ti.`,
    ...
    billing: {
      ...
      freeTier: {
        signIn: 'Iniciar sesión',
        title: 'Estás en el plan gratuito de Moor',
        message: 'Inicia sesión con una cuenta de Moor para desbloquear más modelos y herramientas.',
        caption:
          'Funciona con moor/welcome, con conectores incluidos. Al iniciar sesión conservas tus conectores y se añaden las herramientas que requieren cuenta y todos los demás modelos.',
        name: 'Moor · plan gratuito',
        footnote:
          'El plan gratuito no tiene saldo ni nada que pagar. El pago y el uso aparecen al iniciar sesión con una cuenta de Moor.',
        plan: 'Plan gratuito',
        model: 'Modelo',
      ...
      state: {
        notice: {
          loggedOut: {
            title: 'Conecta tu cuenta de Moor',
            message: 'Inicia sesión con tu cuenta de Moor para ver aquí tu saldo, plan y uso.',
      ...
      errors: {
        ...
        cliBillingDisabled: {
          ...
          message:
            'El gasto remoto está desactivado para esta cuenta; un administrador de facturación puede activarlo desde la página de Moor Agent del portal.'
        },
        roleRequired: {
    ...
    providers: {
      ...
      intro:
        'Inicia sesión con una suscripción, sin copiar claves API. Moor ejecuta el inicio de sesión del navegador por ti, aquí mismo en la app.',
      connected: 'Conectado',
      collapse: 'Contraer',
      ...
      localEndpoint: {
        ...
        description:
          'Conecta Moor con cualquier endpoint compatible con OpenAI (Zyphra, vLLM, llama.cpp, Ollama, etc.).'
      },
    ...
    toolsets: {
      ...
      nousIncluded: 'Incluido con una suscripción de Moor: inicia sesión con tu cuenta de Moor para activarlo.',
      nousAuthNeededTitle: 'Inicia sesión con tu cuenta de Moor',
      nousAuthNeededMessage: (provider: string) =>
        `${provider} está guardado, pero solo funcionará cuando inicies sesión con tu cuenta de Moor.`,
      nousAuthSignIn: 'Iniciar sesión',
      nousAuthDoneTitle: 'Cuenta de Moor conectada',
      nousAuthDoneMessage: 'Los backends de tu suscripción ya están activos.',
      nousAuthFailed: 'No se completó el inicio de sesión en Moor',
      ...
      terminalBackend: {
        ...
        unavailableMessage: (backend: string) =>
          `Moor no puede ejecutar comandos de shell ahora mismo: ${backend} no está listo. Cambia a Local o termina de configurar ${backend} y vuelve a intentarlo.`,
      ...
      browserRealProfile: {
        ...
        prompt: {
          ...
          body: 'Deja que Moor navegue con una instantánea de tu perfil predeterminado del navegador, para que los sitios se abran con la sesión ya iniciada.',
  ...
  skills: {
    ...
    skillArchivedMessage: 'Puedes restaurarlo con moor curator restore.',
    tabPlugins: 'Plugins',
    plugins: {
      ...
      defaultProfile: 'Moor (predeterminado)',
      kindAgent: 'Agente',
      ...
      legacyBackend:
        'Este backend es anterior a los interruptores de plugins por clave: actualiza Moor para gestionarlo aquí.',
      ...
      catalogProvenance: (sha: string) =>
        `Instalado desde el catálogo de Moor${sha ? ` en el commit fijado ${sha}` : ''}.`,
      ...
      deepLinkCatalogUnknown: (name: string) =>
        `\u201C${name}\u201D no está en el catálogo de plugins de Moor. No se instaló nada.`,
      deepLinkCatalogUnavailable:
        'No se pudo cargar el catálogo de plugins de Moor. Comprueba tu conexión y vuelve a abrir el enlace.',
  ...
  starmap: {
    ...
    emptyDesc: 'A medida que Moor crea skills y memorias para tu trabajo, aparecerán aquí.',
  ...
  commandCenter: {
    ...
    pets: {
      ...
      staleBackend: 'Reinicia Moor para usar mascotas; el backend es anterior a esta función.',
    ...
    generatePet: {
      ...
      staleBackend: 'Actualiza Moor para generar mascotas.',
      backgroundHint: 'Puedes cerrar esto; Moor te avisará cuando termine.',
    ...
    moorActiveSessions: (version, count) => `Moor ${version} · Sesiones activas ${count}`,
  ...
  messaging: {
    ...
    restartFailedManual: 'Moor no pudo reiniciarse para aplicar tu configuración de mensajería',
    ...
    telegramQr: {
      ...
      subtitle:
        'Ambas opciones conectan un bot que controlas y guardan sus credenciales solo en esta instalación de Moor.',
      quickSetup: 'Configuración rápida',
      recommended: 'Recomendado',
      quickHelp:
        'Escanea un código QR y confirma en Telegram. Moor crea el bot y detecta tu ID de usuario de Telegram automáticamente.',
  ...
  profiles: {
    ...
    fleet: {
      ...
      localDevice: 'Este dispositivo (backend local: instala Moor si falta; si no, abre una sesión nueva)',
      ...
      installDeviceDesc:
        'Esto instalará Moor localmente y luego abrirá una sesión nueva en este equipo. No se instala nada hasta que confirmes.',
    ...
    remoteOverride: {
      ...
      description:
        'Las sesiones de este perfil se ejecutarán en el Moor remoto que indiques, en lugar de en este equipo.',
    ...
    defaultDescription:
      'Se usa al abrir Moor y para los chats nuevos. Las sesiones existentes se quedan en sus perfiles.',
    ...
    deleting: 'Eliminando...',
    createDesc: 'Los perfiles son entornos independientes de Moor: configuración, skills y SOUL.md separados.',
    nameLabel: 'Nombre',
  ...
  modelAssignment: {
    saveFailed: 'Moor no guardó ese cambio de modelo.',
  ...
  cron: {
    ...
    emptyDescNew:
      'Programa un prompt para ejecutarlo con una expresión cron. Moor lo ejecutará y entregará los resultados al destino que elijas.',
  ...
  sidebar: {
    ...
    storageCorrupt: {
      ...
      body: (profiles: string) =>
        `Moor no puede leer todo el historial de sesiones de ${profiles}. Los chats que faltan en esta lista no se eliminaron; el archivo donde se guardan está dañado.`,
      action:
        'Sal de Moor en este perfil y luego inspecciona el archivo sin modificarlo, o restaura una instantánea:',
    ...
    projects: {
      ...
      staleBackend:
        'Actualiza el backend de Moor para crear proyectos: tu backend es más antiguo que esta aplicación de escritorio (Configuración → Actualizaciones → Backend).',
      deleteConfirm:
        'Esto elimina el proyecto guardado de Moor. Los archivos, los repositorios de git y los árboles de trabajo permanecen intactos.',
      ...
      worktreeStaleBackend:
        'Actualiza el backend de Moor para crear worktrees por esta conexión remota: es anterior a la API de git worktree.',
  ...
  composer: {
    ...
    placeholderStarting: 'Iniciando Moor...',
    placeholderReconnecting: 'Reconectando con Moor…',
    placeholderFollowUp: 'Enviar seguimiento',
    newSessionPlaceholders: [
      '¿Qué vamos a construir?',
      'Dale una tarea a Moor',
      '¿Qué tienes en mente?',
    ...
    voiceEngineChained: 'Voz a texto + voz de Moor',
    voiceEngineLive: 'GPT-Live (full-duplex, delega en Moor)',
    ...
    commandDescs: {
      ...
      '/goal': 'Fijar un objetivo permanente en el que Moor trabaja durante varios turnos hasta cumplirlo',
      ...
      '/plan': 'Escribir un plan de implementación en markdown en .moor/plans/ sin ejecutar nada',
      ...
      '/profile': 'Cambiar el perfil activo de Moor',
      ...
      '/subscription': 'Ver tu plan de Moor y cambiarlo en el navegador',
      '/topup': 'Mostrar tu saldo de Moor y gestionar la facturación en el portal',
      '/platform': 'Pausar, reanudar o listar una plataforma del gateway que falla',
      '/version': 'Mostrar la versión de Moor Agent',
    ...
    attachUrlDesc: 'Moor obtendrá la página y la incluirá como contexto para este turno.',
  ...
  statusStack: {
    ...
    coding: {
      ...
      agentShip: 'Pedir a Moor que abra un PR',
  ...
  updates: {
    discontinuedTitle: 'Esta versión de Moor ya no tiene soporte',
    discontinuedBody: 'Esta versión de Moor ya no tiene soporte y podría dejar de funcionar; desinstálala. Tus datos permanecen en el disco.',
    ...
    availableBodyAppInstaller: 'Hay una nueva versión de Moor. Moor se cerrará, Windows terminará la actualización y Moor volverá a abrirse automáticamente.',
    applyingBodyAppInstaller: 'Moor se cerrará y Windows terminará la actualización. Moor volverá a abrirse al finalizar; no tienes que hacer nada.',
    applyingCloseAppInstaller: 'Esta ventana se cerrará; Windows terminará la actualización y Moor volverá a abrirse automáticamente.',
    checkUnknownTitleAppInstaller: 'No se pudieron buscar actualizaciones',
    checkUnknownBodyAppInstaller: 'Windows no pudo buscar actualizaciones ahora. También se instalan automáticamente al reiniciar Moor.',
    ...
    versionDetailsDistributionSourceInstallerDesktop: 'Código fuente (script de instalación) + moor desktop',
    versionDetailsDistributionSource: 'Código fuente',
    versionDetailsDistributionSourceDesktop: 'Código fuente + moor desktop',
    ...
    bundleOutOfSyncDesc:
        'El entorno de ejecución de Moor se actualizó, pero la app de escritorio sigue siendo una compilación anterior: faltarán funciones nuevas de la interfaz (como el modo Bot) hasta que se actualice. Ejecuta la actualización de abajo para recompilar la app. Si eso no elimina este aviso, reinstala desde el instalador de escritorio más reciente.',
    bundleOutOfSyncAction: 'Obtener el instalador',
    bundleSwapPending: 'Reinicia para terminar la actualización',
    bundleSwapPendingDesc:
        'La app actualizada ya está instalada; Moor solo necesita reiniciarse para cargarla. Los chats y los ajustes no se tocan.',
    bundleSwapPendingAction: 'Reiniciar Moor',
    ...
    unsupportedMessage: 'Esta versión de Moor no puede actualizarse desde la app.',
    connectionRetry:
      'Moor no pudo llegar al servidor de actualizaciones. Comprueba tu conexión a internet y vuelve a intentarlo. Si usas un Moor remoto, asegúrate de que esté en línea.',
    gitUnusable: 'Moor no pudo ejecutar Git en este equipo, así que no pudo buscar actualizaciones.',
    connectionSettings: 'Configuración de conexión',
    ...
    availableBody: 'Hay una nueva versión de Moor lista para instalar.',
    availableTitleBackend: 'Actualización del backend disponible',
    availableBodyBackend:
      'Hay una versión más reciente del backend de Moor al que estás conectado lista para instalar.',
    ...
    manualBody:
      'Instalaste Moor desde la línea de comandos, así que las actualizaciones también se ejecutan ahí. Pega esto en tu terminal:',
    manualPickedUp: 'Moor usará la nueva versión la próxima vez que lo abras.',
    guiSkewTitle: 'Actualiza la aplicación de escritorio',
    guiSkewBody:
      'El backend se actualizó, pero el paquete de esta aplicación de escritorio no cambió. Actualiza o reinstala la aplicación de escritorio de Moor (tu AppImage / .deb / .rpm) para que coincidan.',
    copy: 'Copiar',
    copied: 'Copiado',
    done: 'Listo',
    applyingBody:
      'El actualizador de Moor tomará el control en su propia ventana y volverá a abrir Moor al terminar.',
    applyingBodyBackend:
      'El backend remoto está aplicando la actualización y se reiniciará. Moor se reconectará automáticamente cuando vuelva a estar disponible.',
    applyingClose: 'Moor se cerrará para aplicar la actualización.',
    errorTitle: 'La actualización no terminó',
    errorBody: 'No pasa nada: no se perdió nada. Puedes intentarlo de nuevo ahora.',
    blockerTitle: '¿Cerrar las vistas previas locales para actualizar Moor?',
    blockerBody:
      'Moor necesita detener estas vistas previas locales antes de actualizar. Esto no modifica ni elimina tus archivos.',
    foreignBlockerTitle: 'Cierra otros procesos para actualizar Moor',
    foreignBlockerBody:
      'Moor no puede cerrar estos procesos automáticamente de forma segura. Cierra la app, el terminal o el servicio al que pertenece cada uno y vuelve a intentar la actualización.',
    mixedBlockerBody:
      'Moor puede cerrar las vistas previas locales que se indican abajo. Los demás procesos deben cerrarse manualmente antes de continuar con la actualización.',
  ...
  handoffTour: {
    ...
    stayTitle: 'Moor está a un clic',
    stayText: 'Cambia al perfil de configuración y abre Bienvenida a Moor siempre que necesites ayuda. Se queda ahí.'
  },
  guidedGreeting: {
    line: 'Hola, pasa. Soy Moor. Dame dos minutos para prepararlo todo a tu medida y luego me pondremos a trabajar en algo que de verdad quieras hacer.\n\nPero antes, ¿cómo quieres que te llame?',
  ...
  install: {
    ...
    oneTimeTitle: 'Moor necesita una instalación única',
    ...
    setupChoiceTitle: 'Configurar Moor Desktop',
    setupChoiceDesc:
      'Conecta esta app con un gateway de Moor que ya esté en ejecución o instala Moor localmente en este equipo.',
    connectExistingTitle: 'Conectar con un Moor existente',
    ...
    installLocalTitle: 'Instalar Moor localmente',
    installLocalDesc: 'Descarga Moor, crea su entorno de Python y ejecuta el backend en este equipo.',
    localStartUnavailable: 'No se pudo iniciar la instalación local. Reinicia Moor Desktop e inténtalo de nuevo.',
    remoteSetupTitle: 'Conectar con un Moor existente',
    remoteSetupDesc:
      'Introduce la URL de tu gateway. Moor Desktop detectará si necesita un token o iniciar sesión en el navegador.',
    remoteUrlTitle: 'URL del gateway',
    remoteUrlDesc: 'Usa la URL base del gateway de Moor e incluye https:// si es remoto.',
    ...
    settingUpTitle: 'Configurando Moor Agent',
    finishingTitle: 'Terminando',
    failedDesc:
      'Uno de los pasos de configuración no terminó. Puede ocurrir si hay otra copia de Moor en ejecución, se cortó la conexión a internet o un antivirus bloqueó el instalador. Cierra las demás ventanas de Moor y elige Recargar y reintentar. Si vuelve a fallar, abre los registros y envíalos al soporte.',
    activeDesc:
      'Esta configuración se realiza una sola vez. El instalador de Moor está descargando dependencias y configurando tu máquina. Los siguientes inicios omitirán este paso.',
  ...
  onboarding: {
    headerTitle: 'Vamos a configurar Moor Agent',
    headerDesc: 'Conecta un proveedor de modelo para empezar a chatear. La mayoría de opciones requieren un clic.',
    preparingInstall: 'Moor está terminando la instalación. En el primer inicio suele tardar menos de un minuto.',
    starting: 'Iniciando Moor…',
    ...
    recommended: 'Recomendado',
    connected: 'Conectado',
    featuredPitch: 'Una suscripción, más de 300 modelos frontier: la forma recomendada de usar Moor',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'autohospedado',
        description:
          'Apunta Moor a un endpoint local o autohospedado compatible con OpenAI (vLLM, llama.cpp, Ollama, etc.).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Abre una página de verificación en tu navegador; Moor se conecta automáticamente',
    ...
    authorizeThere: 'Autoriza Moor allí.',
    ...
    autoBrowser: provider =>
      `Abrimos ${provider} en tu navegador. Autoriza Moor allí y te conectarás automáticamente; no hay nada que copiar o pegar.`,
  ...
  freeTier: {
    providerRowTitle: 'Moor · plan gratuito',
    providerRowPitch: 'Inicia sesión con una cuenta de Moor para desbloquear más modelos y herramientas.',
    readyTitle: 'Moor está listo.',
    readyCaption: 'Gratis · conectores incluidos',
    begin: 'Empezar',
    signInInstead: 'Iniciar sesión con una cuenta de Moor',
    otherProviders: 'Otros proveedores',
    stripTitle: 'Ya están disponibles la inferencia y los conectores gratuitos de Moor.',
    stripBody: 'Abre el selector de modelos para probarlos o inicia sesión con una cuenta de Moor.',
    openModelPicker: 'Abrir selector de modelos',
    dismiss: 'Descartar',
    providerName: 'Moor',
    statusLabel: (model: string) => `Moor · ${model}`,
    signIn: 'Iniciar sesión',
    signInHeading: 'Inicia sesión con una cuenta de Moor para desbloquear más modelos y herramientas.',
    ...
    rejectedBody: 'No pasa nada, sigues en el servicio gratuito de Moor. Inicia sesión cuando quieras.',
    supersededBody:
    ...
    timedOutBody: 'Empieza de nuevo cuando quieras. Sigues en el servicio gratuito de Moor.',
    retiredBody:
      'Tu sesión terminó antes de completar el inicio de sesión. Moor iniciará una nueva; luego vuelve a iniciar sesión cuando quieras.',
    ...
    busyBody: (wait: string) =>
      `Moor no pudo terminar de iniciar tu sesión porque el servicio de Moor está ocupado. Vuelve a intentarlo en ${wait}. Mientras tanto, tu sesión sigue aquí.`,
    unreachableBody:
      'Moor no pudo llegar al servicio de Moor para terminar de iniciar tu sesión. Comprueba tu conexión a internet y vuelve a intentarlo. Tu sesión sigue aquí.',
    alreadySignedInHeading: 'Ya has iniciado sesión.',
    alreadySignedInBody: 'Este Moor ya tiene la sesión iniciada en una cuenta de Moor.',
    setupFailed: {
      gateClosed:
        'Esta versión de Moor no puede iniciarse sin una cuenta de Moor. Inicia sesión o crea una: es gratis y solo lleva un minuto.',
      paused:
        'El uso de Moor sin iniciar sesión está en pausa por un momento. Moor seguirá comprobándolo. Iniciar sesión es gratis y te permite empezar ahora mismo.',
      rateLimited: (wait: string) =>
        `Mucha gente está empezando ahora mismo, así que Moor volverá a intentarlo en ${wait}. Iniciar sesión es gratis y te ahorra la espera.`,
      unreachable:
        'Moor no pudo llegar al servicio de Moor. Comprueba tu conexión a internet y pulsa Reintentar. O conecta otro proveedor por ahora.',
      serverError:
        'El servicio de Moor tuvo un fallo. Pulsa Reintentar en un momento o conecta otro proveedor por ahora.',
      powRequired:
        'El servidor de Moor pidió una prueba de trabajo, pero tu agente todavía no la implementa. Inicia sesión o crea una cuenta gratuita de Moor para continuar.',
      locked:
        'Esta sesión no puede continuar sin iniciar sesión. Inicia sesión o crea una cuenta gratuita de Moor para seguir.',
      generic:
        'Moor no pudo configurar el acceso gratuito sin iniciar sesión. Iniciar sesión es gratis; también puedes conectar otro proveedor.',
      signInBelow: 'Iniciar sesión es gratis. Elige Moor abajo.',
      tryAgain: 'Reintentar',
      retrying: 'Reintentando…'
    }
  },
  modelPicker: {
    ...
    pro: 'Pro',
    proNeedsSubscription: 'Los modelos Pro necesitan una suscripción de Moor de pago.',
    free: 'Gratis',
    freeTier: 'Nivel gratis',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} pesa ${size}. Moor solo mostrará los primeros 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Intentar de nuevo',
      restarting: 'Moor se está reiniciando...',
      askRestart: 'Pedir a Moor que reinicie el servidor',
      lookingRestart: taskId => `Moor está buscando un servidor de vista previa para reiniciar (${taskId})`,
      restartingTitle: 'Reiniciando servidor de vista previa',
      restartingMessage:
        'Moor está trabajando en segundo plano. Mira la consola de vista previa para ver el progreso.',
      ...
      blankPageBody: 'Escribe una dirección arriba para navegar o pide a Moor que abra una página.',
      finishedRestarting: message =>
        `Moor terminó de reiniciar el servidor de vista previa${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Moor no pudo reiniciar el servidor.',
      stillWorking:
        'Moor sigue trabajando, pero aún no llegó ningún resultado de reinicio. Puede que el comando del servidor siga en primer plano.',
  ...
  interfaceMode: {
    ...
    hint: 'Cambia lo que se muestra, no lo que Moor puede hacer.',
    sessionNote:
      'Definido por el modo Simple. Un cambio aquí dura esta sesión; cambia a Avanzado para que sea permanente.',
    simple: {
      label: 'Simple',
      description: 'Para hablar con Moor. Barra lateral y chat; sin paneles de terminal, archivos ni diferencias.'
    },
    advanced: {
      label: 'Avanzado',
      description:
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Moor está cargando una respuesta',
      ...
      errorLayers: {
        ...
        gateway: 'Moor tuvo un problema',
        generic: 'Moor no pudo terminar esta respuesta',
        provider: 'El servicio de IA devolvió un error',
        runtime: 'Moor tuvo un problema',
      ...
      errorLayerBodies: {
        ...
        disk: 'Tu disco está lleno, así que Moor no pudo guardar esta conversación. Libera espacio y reinténtalo.',
        endpoint:
          'Moor no puede conectar con tu servidor de modelos personalizado. Comprueba que esté en ejecución y vuelve a enviar el mensaje.',
        gateway:
          'Moor tuvo un problema interno al iniciar esta respuesta. Vuelve a enviar el mensaje; si sigue ocurriendo, envía un diagnóstico.',
        generic: 'Algo salió mal mientras Moor respondía. Reinténtalo o copia los detalles si sigue ocurriendo.',
        provider:
      ...
      errorCodes: {
        ...
        ssl_cert_verification: {
          ...
          body: (provider: string) =>
            `Moor no pudo verificar la conexión segura con ${provider}. Revisa la configuración de red o del proxy, o cambia de proveedor, y vuelve a enviar el mensaje.`
        },
        context_overflow: {
        ...
        invalid_response: {
          ...
          body: (provider: string) => `${provider} devolvió algo que Moor no pudo leer. Reinténtalo en un momento.`
        },
        empty_response: {
        ...
        loop_error: {
          title: 'Moor se quedó atascado en un bucle',
          body: 'La respuesta repetía los mismos pasos, así que Moor la detuvo. Reinténtalo o empieza un chat nuevo si vuelve a ocurrir.'
        },
        SESSION_NOT_OWNED: {
          title: 'Este chat está abierto en otro sitio',
          body: 'Este chat está abierto en otra ventana de Moor o en un terminal. Ciérralo allí y vuelve a enviar el mensaje, o empieza un chat nuevo aquí.'
        },
        disk_full: {
          title: 'Disco lleno',
          body: 'Tu disco está lleno, así que Moor no pudo guardar esta conversación. Libera espacio y reinténtalo.'
        },
        free_tier_disabled: {
          title: 'El uso de Moor sin iniciar sesión está desactivado ahora mismo',
          body: 'Inicia sesión con una cuenta de Moor para seguir chateando; es gratis.'
        },
        free_tier_rate_limited: {
          title: 'Agotaste el cupo para chatear sin iniciar sesión',
          body: 'Se renueva en breve. Inicia sesión con una cuenta de Moor para tener un cupo mayor; es gratis.'
        },
        ...
        free_tier_model_not_free: {
          ...
          body: 'Por ahora Moor usa el modelo gratuito. Inicia sesión con una cuenta de Moor para tener más modelos; es gratis.'
        },
        free_tier_route: {
          title: 'Moor no pudo llegar al modelo gratuito por esta ruta',
          body: 'Inicia sesión con una cuenta de Moor (es gratis) o revisa el ajuste MOOR_INFERENCE_BASE_URL.'
        },
        free_tier_outage: {
        ...
        free_tier_refused: {
          title: 'Moor no pudo enviarlo sin iniciar sesión',
          body: 'Iniciar sesión con una cuenta de Moor es gratis.'
        }
      },
      errorAuthKinds: {
        api_key: {
      ...
      errorToastTitle: 'Moor no pudo terminar la respuesta',
      ...
      errorOpenMoorFolder: 'Abrir la carpeta de Moor',
      errorOpenMoorFolderFailed: 'No se pudo abrir la carpeta de Moor',
      errorUpdateApiKey: 'Actualizar clave API',
      errorSignInAgain: (provider: string) => `Volver a iniciar sesión en ${provider}`,
      errorSignInFreeTier: 'Iniciar sesión con una cuenta de Moor',
    ...
    approval: {
      gatewayDisconnected:
        'Moor está sin conexión ahora mismo. El comando sigue esperando tu respuesta (hasta que se agote el tiempo de aprobación). Reconéctate y vuelve a enviarla.',
      sendFailed: 'No se pudo enviar tu respuesta',
      reconnect: 'Reconectar',
      timedOutSystemLine:
        'Se agotó el tiempo de aprobación: el comando no se ejecutó. Pide a Moor que lo intente de nuevo o sube el límite en Configuración → Seguridad → Tiempo de aprobación.',
      ...
      alwaysDescription: pattern =>
        `Esto añade el patrón “${pattern}” a tu allowlist permanente (~/.moor/config.yaml). Moor no volverá a preguntar por comandos como este, ni en esta sesión ni en futuras.`,
      alwaysAllow: 'Permitir siempre'
    },
    clarify: {
      notReady: 'La solicitud de aclaración aún no está lista',
      gatewayDisconnected: 'Moor está sin conexión ahora mismo. Reconéctate y vuelve a enviarlo.',
  ...
  prompts: {
    ...
    sudoInstallDesc:
      'Moor necesita tu contraseña de sudo para instalar los paquetes de Bot Screen (TigerVNC + Xfce) en el host del gateway. Solo se envía a ese host.',
    sudoPlaceholder: 'contraseña sudo',
    secretTitle: 'Se requiere un secreto',
    secretDesc: 'Moor necesita una credencial para continuar.',
    ...
    vaultSaveDesc: (origin: string) =>
      `Moor llegó a una página de inicio de sesión en ${origin} y no tiene un acceso para ella. Introdúcelo una vez aquí; se cifra en este equipo y se rellena en la página sin que el modelo vea nunca la contraseña.`,
    ...
    vaultCodeDesc: (site: string) =>
      `${site} pide un código de un solo uso (SMS, correo o app de autenticación). Introdúcelo aquí y Moor lo escribe en la página; el modelo nunca lo ve.`,
    vaultCodeLabel: 'Código',
    vaultCodeFootnote:
      'Consejo: guarda la clave del autenticador con este acceso en Configuración → Contraseñas e inicios de sesión y Moor introducirá los códigos por ti.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Reinicia Moor Desktop para usar Guardar imagen.',
    restartToSaveImages: 'Reinicia Moor Desktop para guardar imágenes',
    ...
    handoff: {
      ...
      timedOut:
        'Moor no pudo llegar a tu conexión de mensajería. Iníciala desde Configuración → Mensajería y vuelve a intentar el traspaso.',
  ...
  tips: {
    ...
    items: {
      ...
      skills: {
        ...
        text: 'Las skills son carpetas de instrucciones que Moor carga cuando el trabajo las necesita.'
      },
      messaging: {
        title: 'Moor lejos de tu escritorio',
        text: 'Conecta Telegram, Discord, Slack y más: el mismo agente, la misma memoria.'
      },
      artifacts: {
        title: 'Todo lo que ha creado Moor',
      ...
      profiles: {
        ...
        text: 'Cada uno es su propio Moor: sus propias claves, su propia memoria, sus propias sesiones.'
      },
      'composer-mentions': {
