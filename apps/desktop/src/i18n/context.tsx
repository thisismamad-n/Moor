...
export interface I18nConfigClient {
  getConfig: () => Promise<MoorConfigRecord>
  saveConfig: (config: MoorConfigRecord) => Promise<{ ok: boolean }>
}
...
export function withConfigDisplayLanguage(config: MoorConfigRecord, locale: Locale): MoorConfigRecord {
