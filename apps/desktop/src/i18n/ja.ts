...
export const ja = defineLocale({
  ...
  settings: {
    ...
    fieldDescriptions: defineFieldCopy({
      ...
      timezone: 'Moor がローカル時刻のコンテキストを必要とするときに使用します。空欄ならシステムのタイムゾーンを使います。',
      agent: {
    ...
    gateway: {
      ...
      localDesc: 'ローカルホストでプライベートな Moor バックエンドを起動します。これがデフォルトで、オフラインでも動作します。',
  ...
  updates: {
    ...
    applyingBody: 'Moor アップデーターが独自のウィンドウで引き継ぎ、完了後に Moor を再度開きます。',
    applyingBodyBackend: 'リモートバックエンドが更新を適用して再起動します。復帰すると Moor が自動的に再接続します。',
    applyingClose: 'Moor は更新を適用するために閉じます。',
