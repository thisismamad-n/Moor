...
export const ja = defineLocale({
  ...
  settings: {
    ...
    gateway: {
      ...
      sshErrNotInstalled:
        'リモートホストに Moor がインストールされていません。リモートでインストールする（curl -fsSL https://raw.githubusercontent.com/thisismamad-n/Moor/master/scripts/install.sh | bash）か、Moor パスを設定してください。',
      sshErrPlatform:
