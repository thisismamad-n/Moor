...
export const ru = defineLocale({
  ...
  settings: {
    ...
    plugins: {
      ...
      agent: {
        ...
        blurb:
          'Плагины, установленные в бэкенд Moor — инструменты, навыки, MCP-серверы, хуки и slash-команды. Переносимые — пакеты Agent Plugins (навыки + MCP-бандлы, работающие и в других агентах). Переключатели действуют для новых сеансов.',
        ...
        updateBackendToManage: 'Обновите бэкенд Moor, чтобы управлять этим плагином из приложения.',
        sources: {
          bundled: 'встроенный',
      ...
      installModal: {
        ...
        agentTargetLocal: profile => `Устанавливается в локальный бэкенд ${profile} (~/.moor/plugins/)`,
    ...
    about: {
      ...
      automaticUpdatesDesc: 'Moor автоматически проверяет обновления в фоне и сообщает, когда они готовы.',
    ...
    gateway: {
      ...
      sshErrNotInstalled:
        'Moor не установлен на удалённой машине. Установите его там (curl -fsSL https://hermes-agent.nousresearch.com/install.sh | sh) или задайте путь к Moor.',
      sshErrPlatform:
  ...
  assistant: {
    ...
    mcpSetup: {
      ...
      catalogSource: 'Из каталога, одобренного Moor',
  ...
  prompts: {
    ...
    sudoDesc:
      'Moor нужен ваш пароль sudo, чтобы выполнить команду с повышенными правами. Он отправляется только вашему локальному агенту.',
