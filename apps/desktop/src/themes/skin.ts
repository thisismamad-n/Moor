/**
 * Moor skin → DesktopTheme converter.
 *
 * A "skin" is the CLI/TUI theme unit: a YAML file in `$MOOR_HOME/skins/` (or a
 * built-in) resolved by `moor_cli/skin_engine.py` and pushed to every surface
 ...
 * skin Moor authors from a prompt lights up all three surfaces from one file.
 *
 ...
 */
export function skinToDesktopTheme(skin: MoorSkin): DesktopTheme | null {
