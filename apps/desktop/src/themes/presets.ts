...
const nousTint = (pct: number) => `color-mix(in srgb, ${MOOR_BLUE} ${pct}%, #FFFFFF)`
const nousTintTransparent = (pct: number) => `color-mix(in srgb, ${MOOR_BLUE} ${pct}%, transparent)`

/**
 * Moor — canonical Moor desktop identity. The palette keeps the current
...
export const nousTheme: DesktopTheme = {
  name: 'moor',
  label: 'Moor',
  description: 'Glass neutrals with Moor blue accents',
  colors: {
    background: '#F8FAFF',
    foreground: '#17171A',
    card: '#FFFFFF',
