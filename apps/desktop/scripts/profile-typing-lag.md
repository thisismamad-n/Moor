...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/moor-typing
# → /tmp/moor-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/moor-typing.before.heapsnapshot
# → /tmp/moor-typing.after.heapsnapshot
```
