 ...
 *
 * A skin is authored once as YAML in `$MOOR_HOME/skins/<name>.yaml` (or a
 * built-in), resolved by the Python skin engine (`moor_cli/skin_engine.py`),
 ...
 *   • CLI     → `moor_cli/skin_engine` → prompt_toolkit / Rich styles (Python)
 *
