 ...
 *   <moor home>/desktop-plugins/<id>/plugin.js   (folder name == id)
 * where <moor home> is ~/.moor by default, or ~/.moor/profiles/<name>
 * when running a named profile (`moor -p <name>`). Run `moor doctor` (or
 ...
 * Only these imports resolve: @moor/plugin-sdk, react, react/jsx-runtime.
 */

import { cn, haptic, host, Tip, usePluginI18n, useValue } from '@moor/plugin-sdk'
