...
Built for [Moor Agent](https://github.com/Moor inc./hermes-agent). Usable in any coding agent. Canonical source lives here; synced to [`Moor inc./hermes-agent/skills/creative/ascii-video`](https://github.com/Moor inc./hermes-agent/tree/main/skills/creative/ascii-video) via PR.
