...
Built for [Moor Agent](https://github.com/thisismamad-n/Moor). Usable in any coding agent. Canonical source lives here; synced to [`NousResearch/hermes-agent/skills/creative/ascii-video`](https://github.com/thisismamad-n/Moor/tree/main/skills/creative/ascii-video) via PR.
