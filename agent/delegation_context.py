...
A Moor process may itself be a Kanban dispatcher worker with MOOR_KANBAN_* in
...
_DELEGATED_CHILD_CONTEXT: ContextVar[bool] = ContextVar("moor_delegated_child_context", default=False)
...
_NON_DISPATCHER_OWNED_CONTEXT: ContextVar[bool] = ContextVar("moor_non_dispatcher_owned_context", default=False)

DELEGATED_CHILD_ENV_MARKER = "MOOR_DELEGATED_CHILD_CONTEXT"

KANBAN_ENV_KEYS: tuple[str, ...] = (
    "MOOR_KANBAN_TASK", "MOOR_KANBAN_RUN_ID", "MOOR_KANBAN_WORKSPACE", "MOOR_KANBAN_WORKSPACES_ROOT",
    "MOOR_KANBAN_CLAIM_LOCK", "MOOR_KANBAN_BOARD", "MOOR_KANBAN_DB",
)
