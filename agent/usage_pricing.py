...
_OFFICIAL_DOCS_PRICING: Dict[tuple[str, str], PricingEntry] = {
    ...
    # Fireworks AI — serverless pricing for the models moor typically routes
...
# onto the base entries so the snapshot stays single-source. The moor-side
...
def resolve_billing_route(
    ...
    if provider_name == "moor" or base_url_host_matches(base_url or "", "inference-api.nousresearch.com"):
        return BillingRoute(provider="moor", model=model, base_url=base_url or _MOOR_DEFAULT_BASE_URL, billing_mode="official_models_api")
