...
_SESSION_CWD: ContextVar = ContextVar("MOOR_SESSION_CWD", default=_UNSET)
...
def resolve_context_cwd() -> Path | None:
    ...
    launch dir). An existing configured path is honored verbatim — including the Moor source tree, a
    legitimate workspace when developing Moor; fallback-directory policy lives in the caller."""
