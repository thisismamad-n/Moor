        ...
        with httpx.Client(timeout=timeout) as client:
            resp = client.post(
                ...
                headers={
                    ...
                    "X-Goog-Api-Client": f"moor-agent/{_MOOR_VERSION}",
                },
            )
...
_STANDARD_KEY_GUIDANCE = (
    ...
    "GOOGLE_API_KEY in ~/.moor/.env and restart your session. "
...
class GeminiNativeClient:
        ...
        **_: Any,
        ...
        if not (api_key or "").strip():
            raise RuntimeError(
                ...
                "Set GOOGLE_API_KEY or GEMINI_API_KEY in your environment / ~/.moor/.env "
                "(get one at https://aistudio.google.com/app/apikey), or run `moor setup` "
    ...
    def _headers(self) -> Dict[str, str]:
        headers = {
            ...
            "User-Agent": f"moor-agent/{_MOOR_VERSION} (gemini-native)",
            "X-Goog-Api-Client": f"moor-agent/{_MOOR_VERSION}",
        }
