...
class StatusOutputMixin:
    ...
    def _vprint(self, *args, force: bool = False, **kwargs):
        ...
        the main response; ``force=True`` bypasses both. ``suppress_status_output`` (``moor chat -q``) wins."""
    ...
    def _should_emit_quiet_tool_messages(self) -> bool:
        ...
        ``suppress_status_output`` (the strict machine-readable mode used by ``moor chat -Q``) always
