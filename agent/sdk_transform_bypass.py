...
Moor assembles these payloads from JSON round-trips, so they are already wire
...
ESCAPE_HATCH_ENV = "MOOR_CODEX_SDK_TRANSFORM"
...
def bypass_chat_sdk_request_transform(request_kwargs: dict, client: Any) -> dict:
    ...
    afterwards. Moor also drives chat-shaped facades that are NOT the SDK (the
