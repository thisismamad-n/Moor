...
# Parameters Moor sends on SOME routes only → hosts where that is deliberate.
...
# 404: Moor API surfaces credit depletion as a paid model vanishing from the
...
def _classify_400(c: _Ctx) -> Verdict:
    ...
    # Reasoning-mandatory route rejecting a disable (GLM-5.3 on Moor Portal / OpenRouter). Deterministic
