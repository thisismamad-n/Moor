...
os.environ.setdefault("MOOR_HOME", os.path.expanduser("~/.moor"))  # LIVE: real auxiliary judge calls (cents)
from moor_cli import goals
goal = ("Simplify the moor-agent codebase by >=30% LOC with zero behavior change, decomposing every god file, "
