...
from moor_cli import cli_commands_mixin, goals
...
server._moor_home = Path(home.name)
...
with patch('moor_cli.goals.draft_contract', return_value=None), contextlib.redirect_stdout(io.StringIO()):
