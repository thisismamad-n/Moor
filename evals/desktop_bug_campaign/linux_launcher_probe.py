...
def main():
    ...
    rows["venv_import"] = run([str(python), "-I", "-c", "import yaml,moor_cli.main; print(yaml.__version__)"], env, "/")
    rows["base_import_negative"] = run([str(python.resolve()), "-I", "-c", "import yaml,moor_cli.main"], env, "/")
