...
Backends:
    moor-cloud   - Moor Portal-provisioned Browser Use cloud browser
...
Usage:
    BUBENCH_BASE_TREE=... BUBENCH_PR_TREE=... \
        python3 orchestrate_cloud.py --backend moor-cloud [--reps 2]
...
parser.add_argument("--backend", required=True, choices=["moor-cloud", "browserbase"])
...
provider = MoorCloud() if args.backend == "moor-cloud" else Browserbase()
