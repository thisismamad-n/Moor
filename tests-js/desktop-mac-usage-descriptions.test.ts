 ...
 *
 * Each entry is a key/value pair that lands in the packaged Moor.app's
 ...
 * "Moor wants to access Music" prompt unless the Info.plist disclaims it
 ...
 * user ("Moor wants to access Music" when Moor never touches the Music
