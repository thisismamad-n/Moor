...
# by /etc/cont-init.d/01-moor-setup (installed by the Dockerfile). This
...
# on the pre-s6 contract "entrypoint.sh sets up state then execs moor"
...
echo "[moor] WARNING: docker/entrypoint.sh is a deprecated shim under " \
