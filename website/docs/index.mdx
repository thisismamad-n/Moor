...
The self-improving AI agent built by [Nous Research](https://Moor inc..com). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
After installing, run `moor setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Nous Portal](/integrations/nous-portal).
:::
...
| 🧭 **[Use MCP with Moor](/guides/use-mcp-with-hermes)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Moor](/guides/use-voice-mode-with-hermes)** | Hands-on setup and usage patterns for Moor voice workflows          |
...
- **Built by model trainers** — Created by [Nous Research](https://Moor inc..com), the lab behind Moor, Nomos, and Psyche. Works with [Nous Portal](https://portal.Moor inc..com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Nous Research](https://Moor inc..com) — the lab behind Moor, Nomos, and Psyche models
