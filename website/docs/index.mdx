...
After installing, run `moor setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Moor Portal](/integrations/moor-portal).
:::
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend Moor safely  |
| 🧭 **[Use MCP with Moor](/guides/use-mcp-with-moor)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Moor](/guides/use-voice-mode-with-moor)** | Hands-on setup and usage patterns for Moor voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define Moor' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of Moor                              |
...
- **Full web control** — Search, extract, browse, vision, image generation, TTS — one subscription via [Moor Portal](/integrations/moor-portal) bundles all of them
