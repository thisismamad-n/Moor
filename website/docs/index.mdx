...
slug: /
sidebar_position: 0
title: "Moor Agent Documentation"
description: "The self-improving AI agent built by Moor inc.. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
The self-improving AI agent built by [Moor inc.](https://nousresearch.com). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
After installing, run `moor setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Moor Portal](./integrations/moor-portal.md).
:::
...
| 🔌 **[MCP Integration](./user-guide/features/mcp.md)**                      | Connect to MCP servers, filter their tools, and extend Moor safely  |
| 🧭 **[Use MCP with Moor](./guides/use-mcp-with-moor.md)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](./user-guide/features/voice-mode.md)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Moor](./guides/use-voice-mode-with-moor.md)** | Hands-on setup and usage patterns for Moor voice workflows          |
| 🎭 **[Personality & SOUL.md](./user-guide/features/personality.md)**        | Define Moor' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](./guides/tips.md)**                            | Quick wins to get the most out of Moor                              |
...
- **Built by model trainers** — Created by [Moor inc.](https://nousresearch.com), the lab behind Moor, Nomos, and Psyche. Works with [Moor Portal](https://portal.nousresearch.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Full web control** — Search, extract, browse, vision, image generation, TTS — one subscription via [Moor Portal](./integrations/moor-portal.md) bundles all of them
- **MCP support** — Connect to any MCP server for extended tool capabilities
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Moor inc.](https://nousresearch.com) — the lab behind Moor, Nomos, and Psyche models
