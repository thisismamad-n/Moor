...
sidebar_position: 3
title: 'Learning Path'
description: 'Choose your learning path through the Moor Agent documentation based on your experience level and goals.'
---
...
:::tip Start Here
If you haven't installed Moor Agent yet, begin with the [Installation guide](/getting-started/installation) and then run through the [Quickstart](/getting-started/quickstart). Everything below assumes you have a working installation.
:::

:::tip First-time provider setup
First-time users almost always want `moor setup --portal` — one OAuth covers a model plus the four Tool Gateway tools (search/image/TTS/browser). See [Nous Portal](/integrations/nous-portal).
:::
...
- **Just browsing?** Check the [Key Features](#key-features-at-a-glance) table for a quick overview of everything Moor Agent can do.
...
Use Moor Agent as an interactive terminal assistant for writing, reviewing, and running code.
...
:::tip
Pass files directly into your conversation with context files. Moor Agent can read, edit, and run code in your projects.
:::

### "I want a Telegram/Discord bot"

Deploy Moor Agent as a bot on your favorite messaging platform.
...
:::tip
Cron jobs let Moor Agent run tasks on a schedule — daily summaries, periodic checks, automated reports — without you being present.
:::
...
2. [Build a Moor Plugin](/guides/build-a-hermes-plugin)
...
:::tip
RL training works best when you already understand the basics of how Moor Agent handles conversations and tool calls. Run through the Beginner path first if you're new.
:::

### "I want to use it as a Python library"

Integrate Moor Agent into your own Python applications programmatically.
...
| **Code Execution** | Run Python scripts that call Moor tools programmatically | [Code Execution](/user-guide/features/code-execution) |
