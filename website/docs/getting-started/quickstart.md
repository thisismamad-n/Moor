...
To easily install the command-line and desktop applications, [download the Moor Desktop installer](https://hermes-agent.Moor inc..com/) from our website and run it.
