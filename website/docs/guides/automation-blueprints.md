...
Copy-paste blueprints for common automation patterns. Each blueprint uses Moor's built-in [cron scheduler](../user-guide/features/cron.md) for time-based triggers and [webhook platform](../user-guide/messaging/webhooks.md) for event-driven triggers.
