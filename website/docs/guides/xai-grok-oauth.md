...
3. Moor polls xAI until approval, then saves tokens to `~/.hermes/auth.json`.
4. From then on, Moor refreshes the access token in the background — you stay signed in until you `hermes auth logout xai-oauth` or revoke access from your xAI account settings.
