...
Skill names are case-sensitive and must match the installed skill's folder name. If your job specifies `ai-funding-daily-report` but the skill folder is `ai-funding-daily-report`, confirm the exact name from `moor skills list`.
...
moor cron edit <job_id> --script ~/.hermes/scripts/your-script.py
```
...
3. Open an issue at [github.com/Moor inc./hermes-agent](https://github.com/Moor inc./hermes-agent) with:
