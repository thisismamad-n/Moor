...
| OS cron + `curl` to a [webhook subscription](/user-guide/messaging/webhooks) | Your script on the OS schedule | When Moor might be unhealthy (the thing you're monitoring) |
