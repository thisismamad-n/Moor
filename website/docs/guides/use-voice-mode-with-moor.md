---
sidebar_position: 8
title: "Use Voice Mode with Moor"
description: "A practical guide to setting up and using Moor voice mode across CLI, Telegram, Discord, and Discord voice channels"
---

# Use Voice Mode with Moor
...
:::tip
[Moor Portal](/integrations/moor-portal) bundles both the LLM and TTS through one OAuth — voice mode works end-to-end with no extra credentials.
:::
...
- you want Moor sitting in a Discord voice channel for live conversation
...
There are really three different voice experiences in Moor.
...
## Step 1: make sure normal Moor works first
...
Moor supports both local and cloud speech stacks.
...
4. Moor transcribes and responds
...
- asking Moor to structure your thoughts in real time

#### Accessibility / low-typing sessions

If typing is inconvenient, voice mode is one of the fastest ways to stay in the full Moor loop.

## Tuning CLI behavior

### Silence threshold

If Moor starts/stops too aggressively, tune:
...
Moor stays a normal chat bot, but can speak replies.
...
- you want Moor to function like a portable research or ops assistant
...
Moor joins a Discord VC, listens to user speech, transcribes it, runs the normal agent pipeline, and speaks replies back into the channel.
...
- Moor detects speech boundaries
- transcripts are posted in the associated text channel
- Moor responds in text and audio
...
2. run `moor setup tts` to enable voice support
