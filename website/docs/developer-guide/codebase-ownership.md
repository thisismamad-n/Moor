...
| Model providers & transports | `agent/transports/`, `plugins/model-providers/`, `moor_cli/models.py` | [Adding Providers](adding-providers.md), [Model Provider Plugins](model-provider-plugin.md), [Provider Runtime](provider-runtime.md) |
...
| CLI | `moor_cli/` | [Extending the CLI](extending-the-cli.md) |
