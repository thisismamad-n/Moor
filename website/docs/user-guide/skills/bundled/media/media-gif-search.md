...
Set your Tenor API key in your environment (add to `${MOOR_HOME:-~/.moor}/.env`):
...
- GIF URLs can be used directly in markdown: `![alt](https://github.com/thisismamad-n/Moor/blob/main/skills/media/gif-search/url)`
