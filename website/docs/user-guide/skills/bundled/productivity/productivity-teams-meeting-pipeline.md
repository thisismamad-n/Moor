...
description: "Operate the Teams meeting summary pipeline via Moor CLI — summarize meetings, inspect pipeline status, replay jobs, manage Microsoft Graph subscriptions"
---
...
Operate the Teams meeting summary pipeline via Moor CLI — summarize meetings, inspect pipeline status, replay jobs, manage Microsoft Graph subscriptions.
