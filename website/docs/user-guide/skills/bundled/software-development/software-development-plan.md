---
title: "Plan — Write a markdown plan to .moor/plans/; no execution"
sidebar_label: "Plan"
description: "Write a markdown plan to .moor/plans/; no execution"
---
...
Write a markdown plan to .moor/plans/; no execution.
...
| Version | `2.0.0` |
| Author | Moor Agent (writing-craft adapted from obra/superpowers) |
| License | MIT |
...
- Your deliverable is a markdown plan saved inside the active workspace under `.moor/plans/`.
...
- `.moor/plans/YYYY-MM-DD_HHMMSS-<slug>.md`

Treat that as relative to the active working directory / backend workspace. Moor file tools are backend-aware, so using this relative path keeps the plan with the workspace on local, docker, ssh, modal, and daytona backends.

If the runtime provides a specific target path, use that exact path.
If not, create a sensible timestamped filename yourself under `.moor/plans/`.
...
> **For Moor:** Use subagent-driven-development skill to implement this plan task-by-task.
...
Use Moor tools to understand the project:
