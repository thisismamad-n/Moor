...
| | |
|---|---|
| Source | Optional — install with `moor skills install official/creative/audiocraft-audio-generation` |
...
- **[Advanced Usage](https://github.com/thisismamad-n/Moor/blob/main/optional-skills/creative/audiocraft-audio-generation/references/advanced-usage.md)** - Training, fine-tuning, deployment
- **[Troubleshooting](https://github.com/thisismamad-n/Moor/blob/main/optional-skills/creative/audiocraft-audio-generation/references/troubleshooting.md)** - Common issues and solutions
