<<<<<<< HEAD:website/docs/user-guide/skills/bundled/mlops/mlops-models-audiocraft.md
---
...
- **[Advanced Usage](https://github.com/Moor inc./hermes-agent/blob/main/skills/mlops/models/audiocraft/references/advanced-usage.md)** - Training, fine-tuning, deployment
- **[Troubleshooting](https://github.com/Moor inc./hermes-agent/blob/main/skills/mlops/models/audiocraft/references/troubleshooting.md)** - Common issues and solutions
...
- **HuggingFace**: https://huggingface.co/facebook/musicgen-small
- **Demo**: https://huggingface.co/spaces/facebook/MusicGen
>>>>>>> upstream/main:website/docs/user-guide/skills/optional/creative/creative-audiocraft-audio-generation.md
