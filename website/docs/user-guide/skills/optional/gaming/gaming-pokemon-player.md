...
| | |
|---|---|
| Source | Optional — install with `moor skills install official/gaming/pokemon-player` |
...
GET /screenshot and save to ~/.moor/cache/scratch/pokemon.png, then use vision_analyze.
