<<<<<<< HEAD:website/docs/user-guide/skills/bundled/research/research-polymarket.md
---
...
- Some new markets may have empty price history
- Geographic restrictions apply to trading but read-only data is globally accessible
>>>>>>> upstream/main:website/docs/user-guide/skills/optional/finance/finance-polymarket.md
