<<<<<<< HEAD:website/docs/user-guide/skills/bundled/data-science/data-science-jupyter-live-kernel.md
---
...
operations, pass `--timeout 120`. Use generous timeouts (60+) for initial
setup or heavy computation.
>>>>>>> upstream/main:website/docs/user-guide/skills/optional/data-science/data-science-jupyter-notebook.md
