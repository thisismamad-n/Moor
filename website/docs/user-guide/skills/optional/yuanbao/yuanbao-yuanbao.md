<<<<<<< HEAD:website/docs/user-guide/skills/bundled/yuanbao/yuanbao-yuanbao.md
---
...
- Groups are called "派 (Pai)" in the Yuanbao app
- Member roles: `user`, `yuanbao_ai`, `bot`
>>>>>>> upstream/main:website/docs/user-guide/skills/optional/yuanbao/yuanbao-yuanbao.md
