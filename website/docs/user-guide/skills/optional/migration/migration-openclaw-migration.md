...
**First-time setup:** The `moor setup` wizard automatically detects `~/.openclaw` and offers migration before configuration begins.

## What this skill does

It uses `scripts/openclaw_to_moor.py` to:
...
Do not guess a shorter path like `~/.moor/skills/openclaw-migration/...`.

Before running the helper:

1. Prefer the installed path under `~/.moor/skills/migration/openclaw-migration/`.
...
- OpenClaw skills available under `~/.moor/skills/openclaw-imports/`
