<<<<<<< HEAD:website/docs/user-guide/skills/bundled/mlops/mlops-models-segment-anything.md
---
...
- **[Advanced Usage](https://github.com/Moor inc./hermes-agent/blob/main/skills/mlops/models/segment-anything/references/advanced-usage.md)** - Batching, fine-tuning, integration
- **[Troubleshooting](https://github.com/Moor inc./hermes-agent/blob/main/skills/mlops/models/segment-anything/references/troubleshooting.md)** - Common issues and solutions
...
- **[Advanced Usage](https://github.com/Moor inc./hermes-agent/blob/main/optional-skills/mlops/models/segment-anything-model/references/advanced-usage.md)** - Batching, fine-tuning, integration
- **[Troubleshooting](https://github.com/Moor inc./hermes-agent/blob/main/optional-skills/mlops/models/segment-anything-model/references/troubleshooting.md)** - Common issues and solutions
...
- **SAM 2 (Video)**: https://github.com/facebookresearch/segment-anything-2
- **HuggingFace**: https://huggingface.co/facebook/sam-vit-huge
>>>>>>> upstream/main:website/docs/user-guide/skills/optional/mlops/mlops-models-segment-anything-model.md
