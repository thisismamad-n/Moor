...
| | |
|---|---|
| Source | Optional — install with `moor skills install official/productivity/property-listings` |
...
Present researched properties as browsable cards in the Moor desktop transcript.
...
- A Moor desktop conversation for native cards; the backend may be local or remote.
...
```text
moor skills install official/productivity/property-listings
```
