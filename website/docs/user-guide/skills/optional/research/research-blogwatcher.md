...
| | |
|---|---|
| Source | Optional — install with `moor skills install official/research/blogwatcher` |
...
## Working with Moor tools (read this first)

`blogwatcher-cli` is the feed database; Moor tools do the automation around it:
