<<<<<<< HEAD:website/docs/user-guide/skills/optional/devops/devops-cli.md
---
...
- `references/running-apps.md` — Running apps, input formats, output handling
- `references/cli-reference.md` — Complete CLI command reference
>>>>>>> upstream/main:website/docs/user-guide/skills/optional/devops/devops-inference-sh-cli.md
