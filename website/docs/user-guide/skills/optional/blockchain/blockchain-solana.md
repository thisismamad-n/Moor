...
python ~/.moor/skills/blockchain/solana/scripts/solana_client.py stats
```
...
```bash
python ~/.moor/skills/blockchain/solana/scripts/solana_client.py \
...
```bash
python ~/.moor/skills/blockchain/solana/scripts/solana_client.py price BONK
python ~/.moor/skills/blockchain/solana/scripts/solana_client.py price JUP
python ~/.moor/skills/blockchain/solana/scripts/solana_client.py price SOL
python ~/.moor/skills/blockchain/solana/scripts/solana_client.py price DezXAZ8z7PnrnRJjz3wXBoRgixCa6xjnB7YaB1pPB263
```
