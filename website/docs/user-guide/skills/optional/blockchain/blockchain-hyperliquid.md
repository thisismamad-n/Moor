...
```bash
python ~/.moor/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
```bash
python ~/.moor/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python ~/.moor/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
