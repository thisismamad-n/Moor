...
- Your Moor install (`~/.hermes/`) — Linux side. The installer already does this.
...
home directory, and launches Moor. If `hermes` is not on PATH yet, open WSL
...
- **[MCP guide → WSL → Windows Chrome](/guides/use-mcp-with-hermes#wsl2-bridge-hermes-in-wsl-to-windows-chrome)** — controlling your signed-in Windows Chrome from Moor in WSL.
