...
description: "Connect Moor Agent to WeCom via the AI Bot WebSocket gateway"
---
...
Select **WeCom** and scan the QR code with your WeCom mobile app. Moor will automatically create a bot application with the correct permissions and save the credentials.
...
5. Run `moor gateway setup`, select **WeCom**, and enter the credentials when prompted
