...
If you want Moor + Open WebUI wired together locally with a reusable launcher, run:
...
- restarts the Moor gateway so the API server comes up
...
- Moor API: `http://127.0.0.1:8642/v1`
- Open WebUI: `http://127.0.0.1:8080`
- model name advertised to Open WebUI: `Moor Agent`

Useful overrides:

```bash
OPEN_WEBUI_NAME='My Moor UI' \
OPEN_WEBUI_ENABLE_SIGNUP=true \
HERMES_API_MODEL_NAME='My Moor Agent' \
bash scripts/setup_open_webui.sh
```
