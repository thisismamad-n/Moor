...
- **You just want to back up a profile on your own machine.** Use [`moor profile export` / `import`](../reference/profile-commands.md#hermes-profile-export) — that's what those are for.
...
# Anyone
moor profile install github.com/you/hermes-polymarket-trader --alias
```
...
moor profile install ~/.hermes/profiles/research-bot --name research-bot-test --alias

# Tweak, delete, re-install until it's right
moor profile delete research-bot-test --yes
moor profile install ~/.hermes/profiles/research-bot --name research-bot-test
```
...
- [`moor profile export` / `import`](../reference/profile-commands.md#hermes-profile-export) — local backup / restore (not distribution)
- [Using SOUL with Moor](../guides/use-soul-with-hermes.md) — authoring personalities
