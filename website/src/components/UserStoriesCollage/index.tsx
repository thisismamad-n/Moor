  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Moor Agent community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Moor &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        ...
        <a
          href="https://github.com/Moor inc./hermes-agent/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a href="https://discord.gg/Moor inc." target="_blank" rel="noopener noreferrer">
