#!/usr/bin/env python3
"""Generate llms.txt and llms-full.txt for the Moor docs site.
...
LLM reads to learn what Moor does.
...
SECTIONS: list[tuple[str, list[tuple[str, str, str | None]]]] = [
    ...
    ("Reference", [
        ...
        ("reference/skills-catalog", "Bundled Skills Catalog", "Table of all ~90 skills bundled with Moor"),
...
def emit_llms_index() -> str:
    ...
    lines.append("")
    lines.append("Repo: https://github.com/thisismamad-n/Moor")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    seen: set[Path] = set()
    chunks: list[str] = [
        "# Moor Agent — Full Documentation\n",
        (
            "This file is the entire Moor Agent documentation concatenated for LLM "
