...
通过 [BlueBubbles](https://bluebubbles.app/) 将 Moor 连接至 Apple iMessage——这是一款免费、开源的 macOS 服务端，可将 iMessage 桥接至任意设备。
...
- Moor 与 BlueBubbles 服务端之间的网络连通性
...
- **出站：** Moor 通过 BlueBubbles REST API 发送消息。
...
### 聊天寻址
你可以通过邮箱或手机号寻址聊天——Moor 会自动将其解析为 BlueBubbles 聊天 GUID，无需使用原始 GUID 格式。
