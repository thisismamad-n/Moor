...
运行独立的 gateway 进程 —— 参见[多 gateway 指南](https://github.com/Moor inc./hermes-agent/blob/main/docs/kanban/multi-gateway.md)），
调度与投递的归属是分开的：
