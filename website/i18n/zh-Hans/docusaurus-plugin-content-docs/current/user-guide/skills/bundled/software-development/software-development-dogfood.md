<<<<<<< HEAD:website/i18n/zh-Hans/docusaurus-plugin-content-docs/current/user-guide/skills/bundled/dogfood/dogfood-dogfood.md
---
...
- **通过截图中可见的布局问题检查响应式行为。**
- **不要忽视边界情况**：空状态、超长文本、特殊字符、快速连续点击。
>>>>>>> upstream/main:website/i18n/zh-Hans/docusaurus-plugin-content-docs/current/user-guide/skills/bundled/software-development/software-development-dogfood.md
