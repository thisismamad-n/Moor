<<<<<<< HEAD:website/i18n/zh-Hans/docusaurus-plugin-content-docs/current/user-guide/skills/bundled/research/research-polymarket.md
---
...
- 交易需要基于钱包的加密身份验证（EIP-712 签名）
- 部分新市场的价格历史可能为空
>>>>>>> upstream/main:website/i18n/zh-Hans/docusaurus-plugin-content-docs/current/user-guide/skills/optional/finance/finance-polymarket.md
