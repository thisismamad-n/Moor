<<<<<<< HEAD:website/i18n/zh-Hans/docusaurus-plugin-content-docs/current/user-guide/skills/bundled/yuanbao/yuanbao-yuanbao.md
---
...
- `group_code` 来自 chat_id：`group:328306697` → `328306697`
- 在 Yuanbao 应用中，群组称为"派（Pai）"
>>>>>>> upstream/main:website/i18n/zh-Hans/docusaurus-plugin-content-docs/current/user-guide/skills/optional/yuanbao/yuanbao-yuanbao.md
