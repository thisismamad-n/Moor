<<<<<<< HEAD:website/i18n/zh-Hans/docusaurus-plugin-content-docs/current/user-guide/skills/bundled/mlops/mlops-models-audiocraft.md
---
...
- **[高级用法](https://github.com/Moor inc./hermes-agent/blob/main/skills/mlops/models/audiocraft/references/advanced-usage.md)** - 训练、微调、部署
- **[故障排查](https://github.com/Moor inc./hermes-agent/blob/main/skills/mlops/models/audiocraft/references/troubleshooting.md)** - 常见问题与解决方案
...
- **论文（AudioGen）**：https://arxiv.org/abs/2209.15352
- **HuggingFace**：https://huggingface.co/facebook/musicgen-small
>>>>>>> upstream/main:website/i18n/zh-Hans/docusaurus-plugin-content-docs/current/user-guide/skills/optional/creative/creative-audiocraft-audio-generation.md
