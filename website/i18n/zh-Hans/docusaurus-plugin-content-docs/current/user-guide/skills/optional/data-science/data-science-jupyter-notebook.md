<<<<<<< HEAD:website/i18n/zh-Hans/docusaurus-plugin-content-docs/current/user-guide/skills/bundled/data-science/data-science-jupyter-live-kernel.md
---
...
| `execute_code` | 需要访问 Moor 工具（web_search、文件操作）的一次性脚本。无状态。 |
...
>>>>>>> upstream/main:website/i18n/zh-Hans/docusaurus-plugin-content-docs/current/user-guide/skills/optional/data-science/data-science-jupyter-notebook.md
