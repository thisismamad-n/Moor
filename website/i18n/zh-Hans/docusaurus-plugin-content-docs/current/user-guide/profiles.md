...
将当前 profile 的 `config.yaml`、`.env`、`SOUL.md` 和 skills 复制到新 profile。API 密钥、模型和能力相同，但会话和记忆是全新的。编辑 `~/.moor/profiles/work/.env` 可使用不同的 API 密钥，编辑 `~/.moor/profiles/work/SOUL.md` 可设置不同的人格。
