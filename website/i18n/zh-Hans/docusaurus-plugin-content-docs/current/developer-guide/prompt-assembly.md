...
| 优先级 | 文件 | 搜索范围 | 说明 |
|--------|------|----------|------|
| 1 | `.hermes.md`、`MOOR.md` | 从 CWD 向上至 git 根目录 | Moor 原生项目配置 |
...
1. `.hermes.md` / `MOOR.md`（向上遍历至 git 根目录）
...
- 项目上下文文件，如 `.hermes.md`、`MOOR.md`、`AGENTS.md`、`CLAUDE.md` 或 `.cursorrules` — 注入仓库特定的工作规则。
