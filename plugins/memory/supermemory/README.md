...
- The `supermemory` SDK, prepared through PM by `moor memory setup` when you select Supermemory. Restart Moor after preparation; do not install into its selected environment with pip.
