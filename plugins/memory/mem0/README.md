...
- The `mem0ai` SDK, prepared through PM by `moor memory setup` when you select Mem0. Restart Moor after preparation; do not install into its selected environment with pip.
