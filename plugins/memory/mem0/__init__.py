...
Configuration
-------------
Secret (lives in $MOOR_HOME/.env or the environment):
...
Behavioral settings (live in $MOOR_HOME/mem0.json, set via `moor memory
setup`):
  ...
  agent_id           — Agent identifier (default: moor)
...
def _load_config() -> dict:
    """Load config from env vars, with $MOOR_HOME/mem0.json overrides.
    ...
    config = {
        ...
        "agent_id": os.environ.get("MEM0_AGENT_ID", "moor"),
        "oss": {},
    }
    ...
    config_path = get_moor_home() / "mem0.json"
...
class Mem0MemoryProvider(MemoryProvider):
    ...
    def save_config(self, values, moor_home):
        """Write config to $MOOR_HOME/mem0.json."""
        import json
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        #   1. Operator-configured MEM0_USER_ID (env or $MOOR_HOME/mem0.json) —
        ...
        self._agent_id = self._config.get("agent_id", "moor")
