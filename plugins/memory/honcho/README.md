...
- The `honcho-ai` SDK, prepared through PM by `moor memory setup` when you select Honcho. Restart Moor after preparation; do not install into its selected environment with pip.
