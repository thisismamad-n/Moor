...
class _Client:
    ...
    def _headers(self, path: str, json_body: bool = True) -> dict:
        ...
        return {"Authorization": f"Bearer {token}", "x-sdk-runtime": "moor-plugin",
...
class RetainDBMemoryProvider(MemoryProvider):
    ...
    def __init__(self):
        ...
        self._user_id, self._session_id, self._agent_id = "default", "", "moor"
    ...
    def initialize(self, session_id: str, **kwargs) -> None:
        ...
        if not project:
            profile_name = os.path.basename(str(kwargs.get("moor_home", "")))
            project = f"moor-{profile_name}" if profile_name not in {"", ".moor"} else "default"
