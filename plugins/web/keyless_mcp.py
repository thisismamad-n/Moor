...
two endpoints so a fresh Moor install with **zero web credentials** still
...
def provider_tier(name: str) -> str:
    ...
    ``moor tools`` picker's Free/Paid rows). ``free`` forces the keyless
    ...
    try:
        ...
        return {
            ...
            "error": (
                ...
                "backend via `moor tools` for reliable service."
            ),
        }
    ...
    try:
        ...
        return {
            ...
            "error": (
                ...
                "via `moor tools` for reliable service."
            ),
        }
