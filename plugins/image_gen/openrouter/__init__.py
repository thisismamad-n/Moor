...
via :func:`moor_cli.runtime_provider.resolve_runtime_provider`. OpenRouter alone also
...
class OpenRouterCompatImageProvider(ImageGenProvider):
    """One instance per backend (OpenRouter, Moor Portal); they differ only in the runtime
    ...
    def list_models(self) -> List[Dict[str, Any]]:
        ...
        releases selectable); Moor Portal = chat-completions only. Offline: default chain + snapshot."""
