...
Config: ~/.moor/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.moor/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_moor_home()`` helper (MOOR_HOME-aware and
