...
class SmsAdapter(BasePlatformAdapter):
    """
    Twilio SMS <-> Moor gateway adapter.

    Each inbound phone number gets its own Moor session (multi-tenant).
...
# static dict in moor_cli/gateway.py, and the _send_sms dispatch in
