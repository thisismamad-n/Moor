...
def interactive_setup() -> None:
    ...
    from moor_cli.setup import prompt, prompt_yes_no, save_env_value, get_env_value, print_header, print_info, print_warning
    print_header("A2A (Agent-to-Agent)")
    print_info("Expose Moor as an A2A-discoverable agent and call other A2A agents.")
