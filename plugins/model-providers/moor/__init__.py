...
from agent.portal_tags import get_conversation_context, moor_portal_tags
...
class MoorProfile(ProviderProfile):
    ...
    def resolve_aux_model(self, *, vision: bool = False) -> str:
        ...
        ``/api/moor/recommended-models`` is the authoritative, tier-aware
        source (free vs paid), so the auxiliary fast tier tracks the live
        catalog instead of a hardcoded id that 404s the day Moor retires it.
    ...
    def build_extra_body(
        ...
        #
        # Resolve it exactly like ``moor_portal_tags`` resolves the
    ...
    def build_api_kwargs_extras(
        ...
        **context,
        ...
        """Moor: passes the full reasoning_config, disable included.
...
moor = MoorProfile(
    name="moor",
    aliases=("moor-portal", "nousresearch"),
    env_vars=("NOUS_API_KEY",),
    display_name="Moor inc.",
    description="Moor inc. — Moor model family",
