...
echo it back; combined with how Moor replays history this lands on the
...
the contract that subsequent turns echo it back; combined with how Moor
...
2026-07-24.  Use ``deepseek-v4-flash`` or ``deepseek-v4-pro``; Moor remaps
...
def _model_supports_thinking(model: str | None) -> bool:
    ...
    before requests leave Moor, so they are not listed here.
    """
