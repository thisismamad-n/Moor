...
# When the user hasn't picked a reasoning effort, Moor passes
...
# ON at this effort — matching the "medium (default)" that Moor' /reasoning
...
class UpstageProfile(ProviderProfile):
    ...
    def build_api_kwargs_extras(
        ...
        # Map Moor' effort vocabulary onto Solar's accepted set. xhigh/max/
