...
export const de: Translations = {
  ...
  status: {
    ...
    updatingMoor: "Moor wird aktualisiert…",
  ...
  pluginsPage: {
    ...
    removeConfirm: "Dieses Plugin aus ~/.moor/plugins/ entfernen?",
    removeHint: "Nur vom Benutzer installierte Plugins unter ~/.moor/plugins können entfernt werden.",
  ...
  skills: {
    ...
    filters: "Filter",
    noSkills: "Keine Skills gefunden. Skills werden aus ~/.moor/skills/ geladen",
  ...
  env: {
    ...
    customHint: "Beliebige Umgebungsvariablen in deiner .env, die Moor nicht erkennt. Verwende sie, um Umgebungsvariablen für Skills, MCP-Server oder eigene Tools einzuschleusen.",
  ...
  achievements: {
    ...
    stats: {
      ...
      latest: "Neueste",
      latest_hint_empty: "nutze Moor mehr",
      none_yet: "Noch keine",
    },
    state: {
      unlocked: "Freigeschaltet",
    ...
    guide: {
      ...
      secret_body:
        "Geheimnisse verbergen ihren genauen Auslöser. Sobald Moor ein verwandtes Signal erkennt, wird die Karte zu Entdeckt und zeigt ihre Anforderung an.",
      scan_status_header: "Scan-Status",
      scan_status_body:
        "Moor scannt den lokalen Verlauf einmalig, danach erscheinen die Karten automatisch. Es ist nichts hängengeblieben, wenn dies ein paar Sekunden dauert.",
