...
export const en: Translations = {
  ...
  status: {
    ...
    updateMoorConfirmMessage:
      "This runs moor update and restarts the gateway when it finishes. Active sessions keep their prompt cache until then.",
    updateMoorConfirmNow: "Update now",
    updateMoorConfirmTitle: "Update Moor?",
    updatingMoor: "Updating Moor…",
  ...
  pluginsPage: {
    ...
    headline:
      "Discover, install, enable, and update Moor plugins (`moor plugins` parity).",
    ...
    removeConfirm: "Remove this plugin from ~/.moor/plugins/?",
    removeHint: "Only user-installed plugins under ~/.moor/plugins can be removed.",
    ...
    catalogHint:
      "Curated, Moor-reviewed plugins pinned to exact commits. Install from here for supply-chain-safe versions.",
    catalogSearchPlaceholder: "Search catalog...",
    catalogEmpty: "No catalog entries match.",
    catalogEmptyDocsLink: "Learn about Moor plugins",
  ...
  skills: {
    ...
    filters: "Filters",
    noSkills: "No skills installed yet. Browse the skills hub or create one here; from a terminal you can also run `moor skills search <topic>`.",
  ...
  env: {
    ...
    customHint: "Arbitrary environment variables stored in your .env that Moor doesn't recognise. Use these to inject env vars for skills, MCP servers, or your own tooling.",
  ...
  achievements: {
    hero: {
      ...
      subtitle:
        "Collectible Moor badges earned from real session history. Known unfinished achievements are shown as Discovered; Secret achievements stay hidden until the first matching behavior appears.",
      scan_subtitle:
        "Scanning Moor session history. First scan can take 5–10 seconds on large histories.",
    },
    actions: {
      rescan: "Rescan",
    },
    stats: {
      ...
      latest: "Latest",
      latest_hint_empty: "run Moor more",
      none_yet: "None yet",
    },
    state: {
      unlocked: "Unlocked",
    ...
    guide: {
      ...
      secret_body:
        "Secrets hide their exact trigger. Once Moor sees a related signal, the card becomes Discovered and shows its requirement.",
      scan_status_header: "Scan status",
      scan_status_body:
        "Moor is scanning local history once, then cards will appear automatically. Nothing is stuck if this takes a few seconds.",
    ...
    share: {
      ...
      tweet_text: "Just unlocked {tier_part}\"{name}\" in Moor Agent ☤",
    },
  },
