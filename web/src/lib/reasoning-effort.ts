 ...
 *
 * Values mirror moor_constants.VALID_REASONING_EFFORTS plus `none`
 * (thinking-off). An empty/unset config value means the Moor default,
 * which is `medium`.
 */
 ...
 *  option. Empty/unknown → `medium` (Moor' default when unset). */
