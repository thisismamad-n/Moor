 ...
 * `window.__MOOR_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Moor brand in the top bar
 ...
 *  `window.__MOOR_PLUGINS__.registerSlot(...)`.
 *
