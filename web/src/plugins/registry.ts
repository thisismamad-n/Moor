 ...
 *
 * Plugins call window.__MOOR_PLUGINS__.register(name, Component)
...
import { Card, CardHeader, CardTitle, CardContent } from "@moor-research/ui/ui/components/card";
import { Input } from "@moor-research/ui/ui/components/input";
import { Label } from "@moor-research/ui/ui/components/label";
import { Separator } from "@moor-research/ui/ui/components/separator";
import { Tabs, TabsList, TabsTrigger } from "@moor-research/ui/ui/components/tabs";
 ...
 * Exposed at runtime as ``window.__MOOR_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__MOOR_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__MOOR_PLUGIN_SDK__ = {
    ...
    // window.__MOOR_SESSION_TOKEN__ directly.
    authedFetch,
    ...
    // UI components — Moor DS where available, shadcn/ui primitives elsewhere.
    components: {
      Card,
      CardHeader,
      CardTitle,
