...
const STORAGE_KEY = "moor-dashboard-theme";
...
const FONT_STORAGE_KEY = "moor-dashboard-font";
...
const THEME_NAME_ALIASES: Record<string, string> = {
  // Renamed during the LENS_5I port + Moor-blue rebrand.
  "lens-5i": "moor-blue",
};
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `moor_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "moor-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-moor-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-moor-theme-font", "true");
...
function applyTheme(theme: DashboardTheme) {
  ...
  // (e.g. Moor Blue) doesn't leave its values behind when the user
