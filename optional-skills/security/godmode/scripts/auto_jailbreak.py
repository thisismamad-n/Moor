...
Usage in execute_code:
    exec(open(os.path.expanduser(
        os.path.join(os.environ.get("MOOR_HOME", os.path.expanduser("~/.moor")), "skills/security/godmode/scripts/auto_jailbreak.py")
    )).read())
...
try:
    ...
    _SKILL_DIR = Path(os.getenv("MOOR_HOME", Path.home() / ".moor")) / "skills" / "security" / "godmode"
