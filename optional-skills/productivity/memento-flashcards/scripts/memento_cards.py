...
Data file: $MOOR_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_MOOR_HOME = Path(os.environ.get("MOOR_HOME", Path.home() / ".moor"))
DATA_DIR = _MOOR_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
