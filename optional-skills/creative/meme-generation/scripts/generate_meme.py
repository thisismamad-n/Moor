...
Example:
    python generate_meme.py drake ~/.moor/cache/scratch/meme.png "Writing tests" "Shipping to prod and hoping"
    python generate_meme.py "Disaster Girl" ~/.moor/cache/scratch/meme.png "Top text" "Bottom text"
