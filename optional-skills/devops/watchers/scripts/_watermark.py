...
def _state_dir() -> Path:
    ...
    # Default: $MOOR_HOME/watcher-state/, falling back to ~/.moor/watcher-state/.
    moor_home = os.environ.get("MOOR_HOME") or str(Path.home() / ".moor")
    return Path(moor_home) / "watcher-state"
