#!/usr/bin/env python3
"""
SWE Runner with Moor Trajectory Format

A runner that uses moor-agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the moor-agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses moor-agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Moor format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches moor-agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using moor-agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Moor Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses moor-agent's built-in execution environments
    and outputs trajectories in moor-agent format.
    """
    ...
    def _convert_to_moor_format(
        ...
        """
        Convert internal message format to Moor trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Moor trajectory format
        trajectory = self._convert_to_moor_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Moor trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Moor Trajectory Format")
    print("=" * 60)
