...
>>>>>>> upstream/main
    ...
    The supported installs self-identify via the code-scoped stamp:
      ...
      - the published ``Moor inc./hermes-agent`` image bakes a ``docker``
...
PLATFORM_SUPPORT_DOCS_URL = "https://hermes-agent.Moor inc..com/docs/getting-started/platform-support"
...
DEFAULT_CONFIG = {
    ...
    # AGENTS.md, CLAUDE.md, .hermes.md, or .cursorrules before Moor applies
