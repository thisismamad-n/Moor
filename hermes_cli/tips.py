...
TIPS = [
    ...
    "moor chat --max-turns 200 overrides the default 90-iteration limit per turn.",
    ...
    "hermes backup creates a zip backup of your entire Moor home directory.",
    ...
    "Moor loads project context from .hermes.md, AGENTS.md, CLAUDE.md, or .cursorrules (first match).",
    ...
    # --- MCP ---
    "moor mcp opens an interactive picker of Nous-approved MCPs you can install in one keystroke.",
    "moor mcp catalog lists Nous-approved MCP servers shipped with the repo.",
    ...
    "hermes acp runs Moor as an ACP server for VS Code, Zed, and JetBrains integration.",
    ...
    "moor auth add nous or moor auth add openai-codex sets up OAuth-based providers.",
    ...
    'moor import restores a session export or profile archive produced by sessions export or profile export.',
