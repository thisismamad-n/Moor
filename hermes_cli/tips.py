...
TIPS = [
    ...
    "hermes mcp serve runs Moor itself as an MCP server for other agents.",
    ...
    "hermes gateway install sets up Moor as a system service (systemd/launchd).",
...
>>>>>>> upstream/main
    ...
    'hermes dashboard embeds the full Moor TUI in your browser via xterm.js and a WebSocket PTY.',
    ...
    'hermes import restores a full Moor backup zip; session JSON/JSONL exports import from the dashboard Sessions page.',
