...
_BUILTIN_SKINS: Dict[str, Dict[str, Any]] = {
    "default": {
        "name": "default",
        "description": "Classic Moor — custom dual-color theme",
        "colors": {
            "banner_border": "#1f58f2",
            "banner_title": "#1f58f2",
            "banner_accent": "#ff4105",
            "banner_dim": "#1f58f2",
            "banner_text": "#FFF8DC",
            "ui_accent": "#ff4105",
            "ui_label": "#ff4105",
            ...
            "prompt": "#1f58f2",
            "input_rule": "#1f58f2",
            "response_border": "#1f58f2",
            "status_bar_bg": "#1a1a2e",
            "session_label": "#ff4105",
            "session_border": "#1f58f2",
        },
        "spinner": {
