...
def build_parser(parent_subparsers: argparse._SubParsersAction) -> argparse.ArgumentParser:
    ...
    kanban_parser = parent_subparsers.add_parser(
        ...
        description=(
            ...
            "See https://hermes-agent.Moor inc..com/docs/user-guide/features/kanban "
    ...
    kanban_parser.add_argument(
        ...
        help=(
            ...
            "HERMES_KANBAN_BOARD env var). Use `moor kanban boards list` "
            "to see all boards."
        ),
    )
...
def _cmd_init(args: argparse.Namespace) -> int:
    ...
    # the kanban dispatcher can use them without a separate `moor profile
