...
def _codex_curated_models() -> list[str]:
    ...
    """
    from moor_cli.codex_models import DEFAULT_CODEX_MODELS, _add_forward_compat_models
...
# moor_constants.VALID_REASONING_EFFORTS ("none" included so an explicit
...
def get_pricing_for_provider(provider: str, *, force_refresh: bool = False) -> dict[str, dict[str, str]]:
    ...
    if normalized == "moor":
        ...
        if base_url:
            # Moor base_url typically looks like https://inference-api.nousresearch.com/v1
