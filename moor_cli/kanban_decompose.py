...
Invoked by ``moor kanban decompose [task_id | --all]`` and the
...
* Mirrors the shape of ``moor_cli/kanban_specify.py``: lazy aux
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Moor Agent board.
...
def _profile_author() -> str:
    """Mirror of ``moor_cli.kanban._profile_author``."""
    return (
