...
Mixin split out of ``cli.py``; bound onto ``MoorCLI`` via the MRO. cli.py-internal symbols are
...
class CLIInfoMixin:
    ...
    def show_banner(self):
        ...
        # `moor skills trust`. Never raises.
        try:
            ...
            if _proj_dirs:
                ...
                if _untrusted is not None:
                    ...
                    self._console_print(
                        ...
                        f"loaded — run `moor skills trust` to enable them.[/]")
        except Exception:
    ...
    def show_help(self, arg: str = ""):
        ...
        from moor_cli.commands import COMMANDS_BY_CATEGORY, HELP_SESSION_SUBGROUPS
    ...
    def handle_bang_shell(self, text: str) -> bool:
        ...
        (tests/moor_cli/test_bang_shell_mode.py). Returns False when the text is not a bang command or
    ...
    def _show_usage(self):
        ...
        The Moor credits block is agent-independent (portal fetch), so it runs even with no live
    ...
    def _reload_skills(self) -> None:
        """Reload skills: rescan ~/.moor/skills/ and queue a note for the next user turn.
