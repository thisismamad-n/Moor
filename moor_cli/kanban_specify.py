...
Used by ``moor kanban specify [task_id | --all]``. Takes a task that
...
* This module intentionally mirrors ``moor_cli/goals.py`` — same aux
...
MOOR_KANBAN_SPECIFY_MAX_TOKENS = max(
    1500,
    env_int("MOOR_KANBAN_SPECIFY_MAX_TOKENS", 6000),
)
    ...
    *,
    ...
    try:
        ...
        resp = call_llm(
            ...
            temperature=0.3,
            max_tokens=MOOR_KANBAN_SPECIFY_MAX_TOKENS,
