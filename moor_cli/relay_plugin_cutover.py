"""Shared migration guards for Moor' native NeMo Relay ownership."""
...
RELAY_PLUGINS_CONFIG_ENV = "MOOR_NEMO_RELAY_PLUGINS_TOML"

LEGACY_RELAY_PLUGIN_KEYS = frozenset({"nemo_relay", "observability/nemo_relay"})

LEGACY_RELAY_EXPORT_ENV_VARS = frozenset({
    "MOOR_NEMO_RELAY_ATOF_ENABLED",
    "MOOR_NEMO_RELAY_ATOF_OUTPUT_DIRECTORY",
    "MOOR_NEMO_RELAY_ATOF_FILENAME",
    "MOOR_NEMO_RELAY_ATOF_MODE",
    "MOOR_NEMO_RELAY_ATIF_ENABLED",
    "MOOR_NEMO_RELAY_ATIF_OUTPUT_DIRECTORY",
    "MOOR_NEMO_RELAY_ATIF_FILENAME_TEMPLATE",
    "MOOR_NEMO_RELAY_ATIF_AGENT_NAME",
    "MOOR_NEMO_RELAY_ATIF_AGENT_VERSION",
    "MOOR_NEMO_RELAY_ATIF_EXPORT_TIMEOUT_S",
    "MOOR_NEMO_RELAY_ATIF_MODEL_NAME",
    "MOOR_NEMO_RELAY_ATIF_SUBAGENT_EXPORT_MODE",
})
