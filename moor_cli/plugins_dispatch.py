...
Mixed into :class:`moor_cli.plugins.PluginManager`. ``_resolve_hook_callback_timeout`` stays on
...
from moor_cli.middleware import OBSERVER_SCHEMA_VERSION
...
class PluginDispatchMixin:
    ...
    def _ensure_event_worker_locked(self) -> None:
        ...
        worker = threading.Thread(
            target=self._event_worker_loop, args=(self._event_queue,), name="moor-plugin-events",
            daemon=True,
        )
