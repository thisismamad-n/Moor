...
Examples:
    ...
    moor debug share --expire 30  Keep dpaste.com fallback pastes for 30 days
...
""")
    ...
    share_parser.add_argument(
        "--moor", action="store_true",
        help="Upload the debug bundle to Moor-internal storage (AWS S3) instead "
    ...
    delete_parser = debug_sub.add_parser(
        "delete", help="Delete a paste uploaded by 'moor debug share'")
