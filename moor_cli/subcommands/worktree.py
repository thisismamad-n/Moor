"""``moor worktree`` subcommand parser."""
...
def build_worktree_parser(subparsers) -> None:
    ...
    worktree_parser = subparsers.add_parser(
        ...
        description="Attended reclaim for the .worktrees/ directory moor -w sessions "
            ...
            "https://github.com/thisismamad-n/Moor/tree/master/website/docs/user-guide/cli#worktree-cleanup")
