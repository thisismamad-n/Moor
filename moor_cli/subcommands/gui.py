...
def build_gui_parser(subparsers, *, cmd_gui: Callable) -> None:
    ...
    gui_parser = subparsers.add_parser(
        ...
        description="Launch the Moor Electron desktop app. By default this installs "
    ...
    gui_parser.add_argument(
        ...
        help="Force Desktop to ignore any moor CLI already on PATH during backend resolution")
    gui_parser.add_argument(
        "--moor-root",
        help="Override the Moor source root used by Desktop (sets MOOR_DESKTOP_MOOR_ROOT)")
    gui_parser.add_argument(
        "--cwd",
        help="Initial project directory for Desktop chat sessions (sets MOOR_DESKTOP_CWD)")
    gui_parser.add_argument(
    ...
    gui_parser.add_argument(
        "--identity", default="Moor Local Signing",
        help="Certificate name to create/use for --setup-tcc-identity (default: Moor Local Signing)",
    )
