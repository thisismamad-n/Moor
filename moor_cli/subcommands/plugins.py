...
Extracted from ``moor_cli/main.py:main()`` (god-file Phase 2 follow-up).
...
def build_plugins_parser(subparsers, *, cmd_plugins: Callable) -> None:
    ...
    plugins_parser = subparsers.add_parser(
        ...
        description=(
            "Install, update, remove, list, or validate native Moor plugins "
    ...
    plugins_install.add_argument(
        "identifier",
        help=(
            "Git URL, owner/repo shorthand (e.g. anpicasso/moor-plugin-chrome-profiles), "
    ...
    plugins_pack = plugins_subparsers.add_parser(
        "pack",
        help="Declarative, shareable plugin sets (moor-pack.yaml)",
        description=(
    ...
    pack_install.add_argument(
        "source", help="Path to a moor-pack.yaml file, or an https:// URL"
    )
    pack_install.add_argument(
        "--force",
        "-f",
