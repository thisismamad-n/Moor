"""``moor import-agent`` subcommand parser (logic lives in ``moor_cli/agent_import.py``)."""

from __future__ import annotations

from typing import Callable

from moor_cli.subcommands._shared import add_yes_flag
...
def build_import_agent_parser(subparsers, *, cmd_import_agent: Callable) -> None:
    ...
    parser = subparsers.add_parser(
        "import-agent", help="Import a Claude Code or Codex CLI setup into Moor",
        description="One-command import of another coding agent's setup into Moor. "
