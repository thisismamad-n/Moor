...
def _scan_gateway_pids(
    ...
    def _matches_current_profile(command: str) -> bool:
        ...
        # Default profile: accept unless argv advertises another profile. MOOR_HOME may come via
        # env (invisible to wmic/CIM), so only a non-matching explicit MOOR_HOME= disqualifies.
...
def _profile_suffix() -> str:
    """Service-name suffix for MOOR_HOME: "" for the default root, the profile name for
