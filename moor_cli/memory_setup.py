...
def _provider_pip_dependencies(provider_name: str, declared: list) -> list:
    ...
    ``moor memory setup`` — if the update-time refresh only reinstalled
...
# ---------------------------------------------------------------------------
# Curses-based interactive picker (same pattern as moor tools)
# ---------------------------------------------------------------------------
...
def _install_dependencies(provider_name: str, *, force: bool = False) -> None:
    ...
    ranges. This is how ``moor update`` heals the active memory provider
    ...
    # data volume (MOOR_LAZY_INSTALL_TARGET). install_specs handles the
...
def cmd_setup_provider(provider_name: str) -> None:
    ...
    if hasattr(provider, "post_setup"):
        ...
        provider.post_setup(moor_home, config)
        return
...
def cmd_status(args) -> None:
    ...
    # canonical resolver (handles composite toolsets like moor-cli).
            ...
            if provider.is_available():
                ...
                if required_fields:
                    ...
                    for f in required_fields:
                        ...
                        print(line)
                print(
                    "  Note: systemd/gateway services do not inherit ~/.moor/.env —"
                )
                print(
