...
Visual styling mirrors the Moor inc. design system (the
``@moor-research/ui`` package the React dashboard uses): the same
...
``tests/moor_cli/test_dashboard_auth_401_reauth.py``.
"""
...
<style>
  /* Brand fonts shipped by @moor-research/ui — same files the SPA loads. */
  @font-face {{
...
<body>
<main>
  <div class="brand">Moor<span class="dot"></span>Research</div>
  <div class="card">
    <h1>Sign in</h1>
...
<p>Install <code>plugins/dashboard-auth-moor</code> (default) or another
