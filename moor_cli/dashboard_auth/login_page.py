...
``@moor-research/ui`` design system; fonts load from the SPA's ``/fonts/``
...
See the <a href="https://github.com/thisismamad-n/Moor/tree/master/website/docs/user-guide/features/web-dashboard#authentication-gated-mode">dashboard
