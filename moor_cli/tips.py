...
TIPS = [
    ...
    "/plan writes a markdown implementation plan to .moor/plans/ without executing anything.",
    # --- Cron & Scheduling ---
...
# Task-oriented example prompts for the empty composer. Kept generic — Moor is
