"""Default SOUL.md template seeded into MOOR_HOME on first run."""
...
DEFAULT_SOUL_MD = (
    "You are Moor Agent, built by Moor inc.. Be direct: match the length of your reply to the weight of "
...
_LEGACY_TEMPLATE_SOULS = (
    ...
    (
        "You are Moor Agent, an intelligent AI assistant created by Moor inc.. You are helpful, "
