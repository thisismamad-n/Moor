...
def run_whatsapp_cloud_setup() -> int:
    ...
    _lines(
        ...
        "This wizard configures Moor to talk to WhatsApp via Meta's",
    ...
    _lines(
        "", "  Moor needs a public HTTPS URL to receive WhatsApp messages.",
        ...
        "    3. Start the Moor gateway in another terminal:",
        "         moor gateway", "",
    ...
    _lines(
        ...
        "  Docs: https://github.com/thisismamad-n/Moor/tree/master/website/docs/user-guide/",
