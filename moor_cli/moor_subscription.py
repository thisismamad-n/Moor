...
def get_moor_subscription_features(
    ...
    *,
    ...
    # Tool Gateway via `moor model`, so direct credentials should NOT
    ...
    features = {
        ...
        "image_gen": MoorFeatureState(
            ...
            current_provider="FAL" if direct_fal else ("Moor Subscription" if image_managed else ""),
        ...
        "video_gen": MoorFeatureState(
            ...
            current_provider="FAL" if direct_fal_video else ("Moor Subscription" if video_managed else ""),
