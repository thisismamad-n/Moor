"""Provider-specific runtime builders for :mod:`moor_cli.runtime_provider`: Azure Foundry, the
...
``moor_cli.runtime_provider.*`` (``_get_model_config``, ``load_config``, ``has_usable_secret``,
