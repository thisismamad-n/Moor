...
from moor_cli.web_models import AudioTranscriptionRequest, TTSSpeakRequest, TTSLeaseRequest
    ...
    try:
        with http_failure("Desktop voice transcription failed", 500, "Transcription failed"):
            with tempfile.NamedTemporaryFile(
                prefix="moor-desktop-voice-", suffix=_audio_extension_for_mime(mime_type),
                delete=False,
            ) as tmp:
