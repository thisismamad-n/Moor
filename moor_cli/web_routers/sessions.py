...
from moor_cli.web_routers._common import log as _log, http_failure
from moor_state import is_malformed_db_error
from moor_state_errors import is_transient_sqlite_error
...
async def get_session_stats(profile: Optional[str] = None):
    """Session-store statistics (mirrors `moor sessions stats`)."""
    def _stats(db):
        out = {
