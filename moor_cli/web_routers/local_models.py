...
def _assign_default(job: Dict[str, Any], model_id: str) -> None:
    ...
    web_deps.late("_apply_model_assignment_sync", "moor_cli.web_server_config")("main", "llamacpp", model_id, "", "", "")
...
async def local_models_sideload(body: SideloadBody):
    ...
    impossible) and bounce the router. The original stays put; delete-from-Moor removes only our link."""
    src = Path(body.path)
