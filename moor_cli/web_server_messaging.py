...
from moor_cli.config import OPTIONAL_ENV_VARS, write_platform_config_field
...
_DOCS_TREE_BASE = "https://github.com/thisismamad-n/Moor/tree/master/website/docs"
...
_PLATFORM_OVERRIDES: dict[str, dict[str, Any]] = {
    "telegram": {
        "name": "Telegram", "description": "Run Moor from Telegram DMs, groups, and topics.",
        "docs_url": "https://core.telegram.org/bots/features#botfather",
        "env_vars": ("TELEGRAM_BOT_TOKEN", "TELEGRAM_ALLOWED_USERS", "TELEGRAM_PROXY"),
        "required_env": ("TELEGRAM_BOT_TOKEN",),
    },
    "discord": {
        "name": "Discord", "description": "Connect Moor to Discord DMs, channels, and threads.",
    ...
    "matrix": {
        "name": "Matrix", "description": "Use Moor in Matrix rooms and direct messages.",
    ...
    "email": {
        "name": "Email", "description": "Talk to Moor through an IMAP/SMTP mailbox.",
        "docs_url": f"{_DOCS_TREE_BASE}/user-guide/messaging/",
    ...
    "dingtalk": {
        "name": "DingTalk", "description": "Connect Moor to DingTalk groups (钉钉).",
        "docs_url": "https://open.dingtalk.com/document/orgapp/the-robot-development-process",
        "env_vars": ("DINGTALK_CLIENT_ID", "DINGTALK_CLIENT_SECRET"),
        "required_env": ("DINGTALK_CLIENT_ID", "DINGTALK_CLIENT_SECRET"),
    },
    "feishu": {
        "name": "Feishu / Lark", "description": "Use Moor inside Feishu / Lark.",
    ...
    "google_chat": {
        "name": "Google Chat", "description": "Connect Moor to Google Chat via Cloud Pub/Sub.",
        "docs_url": f"{_DOCS_TREE_BASE}/user-guide/messaging/google_chat",
    },
    "wecom": {
    ...
    "weixin": {
        ...
        "docs_url": f"{_DOCS_TREE_BASE}/user-guide/messaging/weixin/",
    ...
    "qqbot": {
        "name": "QQ Bot", "description": "Connect Moor to a QQ Bot from the QQ Open Platform.",
    ...
    "teams": {
        ...
        "docs_url": f"{_DOCS_TREE_BASE}/user-guide/messaging/teams",
    },
    ...
    "irc": {
        ...
        "docs_url": f"{_DOCS_TREE_BASE}/user-guide/messaging/irc",
    },
    "line": {
        "description": "Use Moor from LINE via the LINE Messaging API webhook.",
        "docs_url": f"{_DOCS_TREE_BASE}/user-guide/messaging/line",
    },
    "ntfy": {
        "description": "Chat with Moor over ntfy push topics (ntfy.sh or self-hosted).",
        "docs_url": f"{_DOCS_TREE_BASE}/user-guide/messaging/ntfy",
    },
    "photon": {
        "description": "Use Moor through iMessage via Photon's managed Spectrum platform.",
        "docs_url": f"{_DOCS_TREE_BASE}/user-guide/messaging/photon",
    },
    "raft": {
        "description": "Join a Raft workspace as an external agent.",
        "docs_url": f"{_DOCS_TREE_BASE}/user-guide/messaging/raft",
    },
    "simplex": {
        "description": "Talk to Moor over SimpleX Chat via a local simplex-chat daemon.",
        "docs_url": f"{_DOCS_TREE_BASE}/user-guide/messaging/simplex",
    },
    "yuanbao": {
        "name": "Yuanbao (元宝)", "description": "Connect Moor to Tencent Yuanbao.", "docs_url": "",
        "required_env": (),
    },
    "api_server": {
        "name": "API server",
    ...
    "webhook": {
        ...
        "docs_url": f"{_DOCS_TREE_BASE}/user-guide/messaging/webhooks/",
    ...
    "msgraph_webhook": {
        ...
        "docs_url": f"{_DOCS_TREE_BASE}/user-guide/messaging/msgraph-webhook",
        "required_env": (),
    },
    "whatsapp_cloud": {
        "name": "WhatsApp Cloud API",
        "description": "Use Moor via Meta's hosted WhatsApp Cloud API (no local bridge).",
        "docs_url": f"{_DOCS_TREE_BASE}/user-guide/messaging/whatsapp-cloud",
    },
    "relay": {
...
_TELEGRAM_ONBOARDING_USER_AGENT = f"MoorDashboard/{get_version_info().base_version}"
