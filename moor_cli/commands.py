"""Slash command registry for the Moor CLI and gateway.
...
class CommandDef:
    ...
    # Key in ``moor_cli.slash_exec.EXECUTORS`` (a string, not a callable: keeps this module
...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("plan", "Write a markdown implementation plan to .moor/plans/ without executing anything", "Session",
               args_hint="[task]"),
    ...
    CommandDef("busy", "Control how messages behave while Moor is working", "Configuration",
    ...
    CommandDef("login", "Sign in with a Moor account (keeps your connectors)", "Info",
...
_PLUGIN_COMPAT_LAZY = {
    ...
    'discord_skill_commands_by_category': ('moor_cli.commands_platforms', 'discord_skill_commands_by_category'),
    'slack_app_manifest': ('moor_cli.commands_platforms', 'slack_app_manifest'),
    'slack_native_slashes': ('moor_cli.commands_platforms', 'slack_native_slashes'),
    'slack_subcommand_map': ('moor_cli.commands_platforms', 'slack_subcommand_map'),
    'telegram_bot_commands': ('moor_cli.commands_platforms', 'telegram_bot_commands'),
    'telegram_menu_commands': ('moor_cli.commands_platforms', 'telegram_menu_commands'),
    'telegram_menu_max_commands': ('moor_cli.commands_platforms', 'telegram_menu_max_commands'),
}
