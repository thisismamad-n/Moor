...
manual BotFather token copy-paste. Moor talks only to the Moor onboarding
...
# Default pairing API base URL (Moor-hosted Cloudflare Worker).
...
# The Moor-hosted manager bot username (without @). The backend returns the
...
def auto_setup_telegram_bot_result(
    ...
    print()
    print(f"  Contacting Moor Telegram onboarding service: {resolved_api_url}")
    sys.stdout.flush()
