"""Relay subscriber for the persisted Moor shared-metrics slice."""
...
class SharedMetricsSubscriber:
    """Persist validated Moor counters from Relay lifecycle events."""
    ...
    def __call__(self, event: Any) -> None:
        ...
        with self._lock:
            ...
            try:
                ...
                logger.warning(
                    "Unable to persist the Moor shared metric: %s", metric_name, exc_info=True
                )
