...
reload / targeted unload unwind registries in reverse order. Mixed into :class:`moor_cli.plugins.PluginManager`.
"""
...
from moor_cli.plugins_loader import _plugin_home_scope
from moor_cli.plugins_manifest import PluginManifest, manifest_key
...
class PluginLedgerMixin:
    ...
    def _dispose_registrations(self, registrations: List[PluginRegistration]) -> None:
        ...
        from moor_cli.plugins import _PLUGINS_DEBUG
