...
def format_managed_message(action: str = "modify this Moor installation") -> str:
    ...
    raw = os.getenv("MOOR_MANAGED", "").strip().lower()

    if managed_system == "NixOS":
        env_hint = "true" if raw in _MANAGED_TRUE_VALUES else raw or "true"
        return (
            f"Cannot {action}: this Moor installation is managed by NixOS "
            f"(MOOR_MANAGED={env_hint}).\n"
            "Edit services.moor-agent.settings in your configuration.nix and run:\n"
