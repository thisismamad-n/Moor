"""Plugin-owned durable state and namespaced settings helpers (split out of moor_cli.plugins)."""
...
from moor_cli.plugins_manifest import _portable_skill_namespace
