      ...
      let
        ...
        excludedDirs =
          ...
          jsWorkspaceTopDirs ++ [
            ...
            "nix"
            # Skills are shipped via MOOR_BUNDLED_SKILLS /
            # MOOR_OPTIONAL_SKILLS (see moor-agent.nix), not via the
            ...
            # __init__.py) shipped via symlinks + MOOR_BUNDLED_LOCALES
            # / MOOR_OPTIONAL_MCPS, not via the wheel. Excluding them
