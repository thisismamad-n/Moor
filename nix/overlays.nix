# nix/overlays.nix — Expose pkgs.moor-agent for external NixOS configs
#
...
# `pkgs.moor-agent`, `nix build .#default`, and the NixOS module's
...
{ inputs, ... }:
{
  flake.overlays.default = final: _: {
    moor-agent = inputs.self.packages.${final.stdenv.hostPlatform.system}.default;
  };
}
