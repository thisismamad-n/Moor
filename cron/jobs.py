...
def _normalize_reasoning_effort(value: Any) -> Optional[str]:
    ...
    every other effort surface uses (``moor_constants.parse_reasoning_effort``)
...
def create_job(
    ...
    Args:
        ...
        reasoning_effort: Optional per-job reasoning effort pin. One of the
                canonical Moor levels (none|minimal|low|medium|high|xhigh|
