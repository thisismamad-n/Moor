...
`icon.ico` / `icon.icns` / `icon.png` (desktop), `filler-bg0.jpg` (desktop chat
backdrop), `favicon.ico` (dashboard + website), `logo.png`, `banner.png` (website),
`mascot.jpg` (replaces the old mascot in the desktop app + bootstrap installer).
