...
def main() -> None:
    ...
    moor_home = Path(tempfile.mkdtemp(prefix="moor-otel-smoke-"))
    ...
    config = {
        "monitoring": {
            ...
            "gateway_health_export": {
                ...
                "resource_attributes": {
                    "service.name": "moor-gateway-smoke",
    ...
    print(json.dumps({"moor_home": str(moor_home), "requests": len(rows), "paths": sorted(paths)}, indent=2))
