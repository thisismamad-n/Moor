 ...
 * across theme x background scenes to <tmpdir>/moor-tui-visual/tui-visual.html,
...
import { Box, renderSync, Text } from '@moor/ink'
...
// The regenerated slate light_colors block from moor_cli/skin_engine.py
// (relight recipe: vivid hue-preserved accents, airy capped-saturation text,
// darker calm dims).

const info: SessionInfo = {
  cwd: '/Users/brooklyn/www/moor-agent',
...
const setup = (bgHex: string) => {
  process.env.MOOR_TUI_BACKGROUND = bgHex
  resetOverlayState()
  resetUiState()
}
