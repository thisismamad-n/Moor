import { Box, type ScrollBoxHandle, stringWidth, Text } from '@moor/ink'
...
export function StatusRule({
  ...
  // Dev-only readout (MOOR_DEV_CREDITS). The server omits the key entirely unless the
  ...
  // Dev-gated readout (MOOR_DEV_CREDITS), lowest priority,
