import type { BillingBlock, UsageModelData } from '@moor/shared/billing'
import type { MoorSkin } from '@moor/shared/skin'

import type { SessionInfo, SlashCategory, SubagentStatus, Usage } from './types.js'

/** The cross-surface skin contract (canonical shape in `@moor/shared`).
 *  Includes the paired light_colors/dark_colors overlays from #20379. */
export type GatewaySkin = MoorSkin
...
// Wire shapes now live in @moor/shared for reuse by TypeScript clients.
export type {
  BillingAutoReload,
  BillingBlock,
  BillingCardInfo,
