...
def _default_registry_path() -> Path:
    return get_moor_home() / "state" / _REGISTRY_NAME
...
class HostSupervisor:
    ...
    def __init__(
        ...
        *,
        ...
        expected_moor_home: str | None = None,
        autostart: bool = True,
    ) -> None:
        ...
        self.expected_moor_home = expected_moor_home if expected_moor_home is not None else str(get_moor_home())
    ...
    def _validate_hello(self) -> None:
        ...
        if got_home and got_home != self.expected_moor_home:
            raise RuntimeError(f"compute host MOOR_HOME mismatch: {got_home} != {self.expected_moor_home}")
