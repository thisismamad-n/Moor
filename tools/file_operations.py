...
MISSING_SENTINEL = "__moor_missing__"

_READ_SENTINEL_PREFIX = "__MOOR_RF_"
_WRITE_SENTINEL_PREFIX = "__MOOR_WF_"
...
class ShellFileOperations(LintMixin, SearchMixin, FileOperations):
    ...
    def _escape_native_tool_arg(self, arg: str) -> str:
        ...
        understand the MSYS ``/c/...`` form and Moor disables MSYS argument
    ...
    def _native_read_enabled(self) -> bool:
        ...
        file_operations holds Git-Bash-style paths there). ``MOOR_NATIVE_FILE_READ=0``
        turns the fast path off."""
        flag = os.environ.get("MOOR_NATIVE_FILE_READ", "1").strip().lower()
