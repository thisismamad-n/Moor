...
def _in_delegated_child_context() -> bool:
    ...
    threads and inherit process-wide ``MOOR_INTERACTIVE=1``, which does NOT mean they can reach
...
def _transform_sudo_command(command: str | None) -> tuple[str | None, str | None]:
    ...
    should_prompt_for_sudo = (
        env_var_enabled("MOOR_INTERACTIVE") or _get_sudo_password_callback() is not None
