...
_skills_dir = _path_resolver("SKILLS_DIR", "MOOR_HOME", "skills")
...
_DYNAMIC_PATH_RESOLVERS = {"MOOR_HOME": _moor_home, **{
...
_PLUGIN_COMPAT_LAZY = {
    ...
    'MOOR_INDEX_TTL': ('tools.skills_hub_search', 'MOOR_INDEX_TTL'),
    'MOOR_INDEX_URL': ('tools.skills_hub_search', 'MOOR_INDEX_URL'),
    'MoorIndexSource': ('tools.skills_hub_official', 'MoorIndexSource'),
