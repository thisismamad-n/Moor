...
is ALWAYS host-side ``$MOOR_HOME/cache/spillover/{id}.txt`` (works for sessions that never
...
STORAGE_DIR = os.path.join(tempfile.gettempdir(), "moor-results")
...
def _resolve_storage_dir(env) -> str:
    ...
    return f"{temp_dir.rstrip('/') or '/'}/moor-results" if temp_dir else STORAGE_DIR
