...
def iter_sync_files(container_base: str = "/root/.moor") -> list[tuple[str, str]]:
    ...
    the hardcoded /root/.moor to *container_base* because the remote
...
class FileSyncManager:
    ...
    def sync(self, *, force: bool = False) -> None:
        ...
        or ``MOOR_FORCE_FILE_SYNC=1`` is set.
    ...
    def sync_back(self, moor_home: Path | None = None) -> None:
        ...
        Downloads the remote ``.moor/`` directory as a tar archive,
    ...
    def _sync_back_transaction(self, moor_home: Path | None = None) -> None:
        ...
        # against an uninitialized remote .moor/ directory.
    ...
    def _infer_host_path(self, remote_path: str,
        ...
        For example, if the mapping has ``/root/.moor/skills/a.md`` →
        ``~/.moor/skills/a.md``, a new remote file at
        ``/root/.moor/skills/b.md`` maps to ``~/.moor/skills/b.md``.
        """
        mapping = file_mapping if file_mapping is not None else []
