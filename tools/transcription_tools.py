...
def _is_local_stt_provider(provider: str, stt_config: Dict[str, Any]) -> bool:
    """Return whether *provider* is exempt from Moor's remote upload cap."""
...
def _get_provider(stt_config: dict) -> str:
    ...
    # The managed "Moor Subscription" selection (stt.provider: moor) is
...
def _dispatch_stt_provider(
    ...
    # unavailable). Surface it — with its `moor tools` remediation —
