...
# containing `cat ~/.moor/.env` or `rm -rf /`; there it is a smoking gun, not prose.
...
# `moor-agent-dev` skill contains a security postmortem mentioning `cat ~/.moor/.env`, which tripped
