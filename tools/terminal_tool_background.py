...
_HOMEBREW_CI_POLLER_HINT = (
    ...
    'and/or `gh pr checks | jq`. That shape has burned us repeatedly in moor-agent dev work '
    ...
    "skill_view(name='github/moor-agent-dev', file_path='references/green-ci-policy.md') for "
...
_ASYNC_UNSUPPORTED_NOTE = (
    ...
    'an async completion after the turn ends (a one-shot runner such as `moor -z`, a cron '
...
# proc_session attribute -> MOOR_SESSION_* env var carrying it.
_ROUTING_FIELDS = (
    ("watcher_chat_id", "MOOR_SESSION_CHAT_ID"),
    ("watcher_user_id", "MOOR_SESSION_USER_ID"),
    ("watcher_user_name", "MOOR_SESSION_USER_NAME"),
    ("watcher_thread_id", "MOOR_SESSION_THREAD_ID"),
    ("watcher_message_id", "MOOR_SESSION_MESSAGE_ID"),
    ...
    ("parent_session_id", "MOOR_SESSION_ID"),
)
