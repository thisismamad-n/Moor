...
tool_search / tool_describe / tool_call. Invariants: core tools (``toolsets._MOOR_CORE_TOOLS``)
...
def _config_from_loader(loader_name: str) -> ToolSearchConfig:
    """Tool-search config via ``moor_cli.config.<loader_name>`` (defaults on any failure)."""
    try:
