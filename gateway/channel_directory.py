...
~/.moor/channel_directory.json.  The send_message tool reads this file for
...
DIRECTORY_PATH = get_moor_home() / "channel_directory.json"
...
CHANNEL_ALIASES_PATH = get_moor_home() / "channel_aliases.json"
...
def format_directory_for_display(platforms: Optional[Dict[str, Any]] = None) -> str:
    ...
    ``moor send --list`` to merge in configured-but-undiscovered
