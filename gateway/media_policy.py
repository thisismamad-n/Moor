...
from environment variables:
  ...
  - ``MOOR_MEDIA_DELIVERY_STRICT``    <- gateway.strict
  - ``MOOR_MEDIA_ALLOW_DIRS``         <- gateway.media_delivery_allow_dirs
  - ``MOOR_MEDIA_TRUST_RECENT_FILES`` <- gateway.trust_recent_files
...
gateway — a manual ``moor cron run`` in the CLI, ``moor send``, a
...
_STRICT_ENV = "MOOR_MEDIA_DELIVERY_STRICT"
_ALLOW_DIRS_ENV = "MOOR_MEDIA_ALLOW_DIRS"
_TRUST_RECENT_ENV = "MOOR_MEDIA_TRUST_RECENT_FILES"
