...
# of truth for gateway/run.py and moor_cli/web_server.py validation).
...
class GatewayConfig:
    ...
    # route); MOOR_ROOM_LINK_URL overrides.
    ...
    def from_dict(cls, data: Dict[str, Any]) -> "GatewayConfig":
        ...
        return cls(
            ...
            sessions_dir=Path(data["sessions_dir"]) if "sessions_dir" in data else get_moor_home() / "sessions",
...
def load_gateway_config() -> GatewayConfig:
    """Load gateway configuration. Priority: env > ~/.moor/config.yaml > legacy gateway.json > defaults."""
