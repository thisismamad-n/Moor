...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        {"name": "reset", "description": "Reset your Moor session"},
        {
            "name": "model",
        ...
        {"name": "status", "description": "Show Moor session status"},
        {"name": "sethome", "description": "Set this chat as the home channel"},
        {"name": "stop", "description": "Stop the running Moor agent"},
        {
            "name": "steer",
        ...
        {"name": "update", "description": "Update Moor Agent to the latest version"},
        {"name": "restart", "description": "Gracefully restart the Moor gateway"},
        {
            "name": "approve",
        ...
        {
            "name": "thread",
            "description": "Create a new thread and start a Moor session in it",
