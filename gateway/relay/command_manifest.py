...
def build_relay_command_manifest() -> List[Dict[str, Any]]:
    ...
    return [
        ...
        _cmd("reset", "Reset your Moor session"),
        ...
        _cmd("status", "Show Moor session status"),
        _cmd("sethome", "Set this chat as the home channel"),
        _cmd("stop", "Stop the running Moor agent"),
        ...
        _cmd("update", "Update Moor Agent to the latest version"),
        _cmd("restart", "Gracefully restart the Moor gateway"),
        ...
        _cmd("thread", "Create a new thread and start a Moor session in it",
