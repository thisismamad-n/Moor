...
# `require_mention: true` without custom aliases uses Moor wake words.
DEFAULT_MENTION_PATTERNS = [r"(?<![\w@])@?moor\s+agent\b[,:\-]?", r"(?<![\w@])@?moor\b[,:\-]?"]
...
class BlueBubblesAdapter(BasePlatformAdapter):
    ...
    def _compile_mention_patterns(raw: Any) -> List[re.Pattern]:
        ...
        comma/newline-separated), or None (Moor defaults)."""
